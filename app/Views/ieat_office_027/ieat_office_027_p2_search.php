...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>เปลี่ยนตัวผู้ควบคุมงาน</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-207-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-207-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>เปลี่ยนตัวผู้ควบคุมงาน</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row row-form">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                <tr>
                                    <td align="left">
                                        วันที่มีผลการเปลี่ยนตัววิศวกร <input type="text" size="15" id="datepicker-th-1" name="date_change" value="31/08/2564" readonly="readonly" />
                                    </td>
                                </tr>
                            </table>
                            <br />
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" id='t01'>
                                <tr>
                                    <th width="28%" align="left">รายการที่ผู้ประกอบการต้องชำระ</th>
                                    <th width="31%" align="left">จำนวนเงิน</th>
                                    <th width="41%" align="left">หน่วย</th>
                                </tr>
                                <tr>
                                    <td><span class="head_detail">ค่าบริการในการใช้ระบบ e-PP <font color='red'>(ไม่รวม VAT)</font></span></td>
                                    <td align="left"><span class="detail"><input type="text" name="d011" id="d011" value="200" onkeyup="sum_building();"></span></td>
                                    <td align="left"><span class="detail">บาท</span></td>
                                </tr>
                                <tr>
                                    <td><span class="head_detail">รวมค่าใช้จ่ายที่ผู้ประกอบการต้องชำระ (ไม่รวม VAT)</span></td>
                                    <td align="left"><span class="detail"><input type="text" name="d014" id="d014" value="200.00"></span></td>
                                    <td align="left"><span class="detail">บาท</span></td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="row row-form">
                                ...
                                <div class="col-lg-6">
                                    <span class="font_header_detail"><b>กรณีการเปลี่ยนตัววิศวกร :</b></span>
                                    <span class="font_header_detail">ผู้ได้รับใบอนุญาตเป็นผู้บอกเลิกผู้ควบคุมงาน</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id="datatable02" class="table">
                                ...
                                <tr>
                                    <td colspan="9"><span class="font_header_detail">วิศวกรผู้ควบคุมงานก่อสร้างเดิม</b></span></td>
                                </tr>
                                <tr>
                                    <td align="center"><span class="detail">นาย</span></td>
                                    <td align="center"><span class="detail">ก่อสร้าง</span></td>
                                    <td align="center"><span class="detail">อาคาร01</span></td>
                                    <td align="center"><span class="detail">วิศวกรผู้ควบคุมงานก่อสร้าง</span></td>
                                    <td align="center"><span class="detail">วุฒิ</span></td>
                                    <td align="center"><span class="detail">โยธา</span></td>
                                    <td align="center"><span class="detail">99999</span></td>
                                    <td align="center"><span class="detail">27/11/2026</span></td>
                                    <td align="center"><span class="detail">5 ปี</span></td>
                                </tr>
                                <tr>
                                    <td colspan="9"><span class="font_header_detail">เปลี่ยนวิศวกรผู้ควบคุมงานก่อสร้างเป็น</b></span></td>
                                </tr>
                                <tr>
                                    <td align="center"><span class="detail">นาย</span></td>
                                    <td align="center"><span class="detail">ก่อสร้าง</span></td>
                                    <td align="center"><span class="detail">อาคาร101</span></td>
                                    <td align="center"><span class="detail">วิศวกรผู้ควบคุมงานก่อสร้าง</span></td>
                                    <td align="center"><span class="detail">ภาคี</span></td>
                                    <td align="center"><span class="detail">โยธา</span></td>
                                    <td align="center"><span class="detail">99999999</span></td>
                                    <td align="center"><span class="detail">21/10/2028</span></td>
                                    <td align="center"><span class="detail">5 ปี</span></td>
                                </tr>
                            </table>
                        </div>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบการขอเปลี่ยนตัวผู้ควบคุมงาน ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">1. สำเนาหนังสือการแจ้งบอกเลิกผู้ควบคุมงาน คนเก่า, หนังสือแจ้งชื่อผู้ควบคุมงานคนใหม่
                                                <a href="แบบ_กนอ_น.7.pdf" target="_blank">กนอ. น.7</a> แบบฟอร์ม (<a href="แบบ_กนอ_น.4-2.pdf" target="_blank">กนอ น.4-2</a>,
                                                <a href="แบบ_กนอ_น.4-4.pdf" target="_blank">กนอ น.4-4</a>, <a href="แบบ_กนอ_น.4-6.pdf" target="_blank">กนอ น.4-6</a>) แล้วแต่กรณี
                                                พร้อมสำเนาใบประกอบวิชาชีพของผู้ควบคุมงานคนใหม่ และหนังสือรับรองการได้รับอนุญาต ที่ออกโดยสภา</label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">2. หนังสือแจ้งการบอกเลิกผู้ควบคุมงานของผู้ได้รับใบอนุญาต <a href="แบบ_กนอ_น.5.pdf" target="_blank">กนอ. น.5</a>
                                                หรือ หนังสือแจ้งการบอกเลิกการเป็นผู้ควบคุมงานของผู้ควบคุมงาน <a href="แบบ_กนอ_น.6.pdf" target="_blank">กนอ. น.6</a></label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">3. หนังสือรับรองการจดทะเบียนจัดตั้งนิติบุคคลและวัตถุประสงค์การจัดตั้งของผู้ประกอบการ (ไม่เกิน 6 เดือน นับตั้งแต่วันที่ออกหนังสือ)</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <label class="col-lg-12">4. หนังสือมอบอำนาจ ปิดอากรแสตมป์ประกอบด้วย</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.1 สำเนาบัตรประจำตัวประชาชน หรือ สำเนาหนังสือเดินทาง (Passport) ผู้มอบอำนาจ</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.2 สำเนาบัตรประจำตัวประชาชน หรือ สำเนาหนังสือเดินทาง (Passport) ผู้รับมอบอำนาจ</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
