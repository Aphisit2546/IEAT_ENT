...
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="PlanType_id" id="PlanType_id" value="<?php echo $data['PlanType_id']; ?>" readonly />
        <?= csrf_field() ?>
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        รหัสอ้างอิง
                        <input type="text" class='form-control' name="PlanTypeCode" id="code_ref" value="<?php echo $data['PlanTypeCode']; ?>" readonly />
                    </div>
                    <div class="col-3">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-2">
                        <label>
                            <input type="radio" name="TypeHeadPlan" value="1" <?php if ($data['TypeHeadPlan'] == '1') {
                                                                                    echo "checked";
                                                                                }  ?> />
                            แผนยุทธศาสตร์
                        </label>
                    ...
                    <div class="col-2">
                        <label>
                            <input type="radio" name="TypeHeadPlan" value="2" <?php if ($data['TypeHeadPlan'] == '2') {
                                                                                    echo "checked";
                                                                                }  ?>>
                            แผนงบประมาณ
                        </label>
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-12">
                        ชื่อภาษาไทย
                        <input type="text" class='form-control' name="name_th" id="name_th" value="<?php echo $data['name_th']; ?>" onkeyup="isThaichar(this.value,this)" required />
                    </div>
                </div>
            </div>
        </div>
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-12">
                        ชื่อภาษาอังกฤษ
                        <input type="text" class='form-control' name="name_en" id="name_en" value="<?php echo $data['name_en']; ?>" onkeyup="isEngchar(this.value,this)" required />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="col-sm-12 text-right">
                <input name="btnSave" id="btnSave" type="submit" class="btn btn-success" value="ยืนยันข้อมูล" onclick="javascript:return formCheck();">
