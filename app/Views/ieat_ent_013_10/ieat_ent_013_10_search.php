                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกบริษัทที่ต้องการดำเนินการควบรวมกิจการ</td>
                                    ...
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4" colspan="2">
                                            <font color="red">**กรณีมากกว่า 1 บริษัท ให้เลือกเพิ่มเติมในรายการด้านล่าง**</font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกบริษัทที่ต้องการดำเนินการควบรวมกิจการ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <select name="user_id_receive_2" id="user_id_receive_2" class="form form-control">
                                                <option value="0">-- เลือกข้อมูล --</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกบริษัทที่ต้องการดำเนินการควบรวมกิจการ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <select name="user_id_receive_3" id="user_id_receive_3" class="form form-control">
                                                <option value="0">-- เลือกข้อมูล --</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกบริษัทที่ต้องการดำเนินการควบรวมกิจการ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <select name="user_id_receive_4" id="user_id_receive_4" class="form form-control">
                                                <option value="0">-- เลือกข้อมูล --</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4" colspan="2">
                                            <font color="red">**กรณีบริษัทที่ควบกิจการไม่อยู่ในนิคม ให้กรอกข้อมูลเพิ่มเติมในรายการด้านล่าง**</font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4" align="right">1.</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <div class="row row-form">
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_view"> ชื่อบริษัท</div>
                                                    <div class="col-lg-12">
                                                        <input type="text" id="companyname_merge1"
                                                            name="companyname_merge1"
                                                            class="form-control inputMask-phone"
                                                            value="<?php echo $datashow['companyname_merge1']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_ext_view"> เลขประจำตัวผู้เสียภาษี</div>
                                                    <div class="col-lg-6">
                                                        <input type="text" id="taxid_merge1"
                                                            name="taxid_merge1"
                                                            class="form-control inputMask-numeric"
                                                            value="<?php echo $datashow['taxid_merge1']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4" align="right">2.</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <div class="row row-form">
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_view"> ชื่อบริษัท</div>
                                                    <div class="col-lg-12">
                                                        <input type="text" id="companyname_merge2"
                                                            name="companyname_merge2"
                                                            class="form-control inputMask-phone"
                                                            value="<?php echo $datashow['companyname_merge2']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_ext_view"> เลขประจำตัวผู้เสียภาษี</div>
                                                    <div class="col-lg-6">
                                                        <input type="text" id="taxid_merge2"
                                                            name="taxid_merge2"
                                                            class="form-control inputMask-numeric"
                                                            value="<?php echo $datashow['taxid_merge2']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                            </div>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4" align="right">3.</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <div class="row row-form">
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_view"> ชื่อบริษัท</div>
                                                    <div class="col-lg-12">
                                                        <input type="text" id="companyname_merge3"
                                                            name="companyname_merge3"
                                                            class="form-control inputMask-phone"
                                                            value="<?php echo $datashow['companyname_merge3']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="col-lg-6 form-label" for="factory_fax_no_ext_view"> เลขประจำตัวผู้เสียภาษี</div>
                                                    <div class="col-lg-6">
                                                        <input type="text" id="taxid_merge3"
                                                            name="taxid_merge3"
                                                            class="form-control inputMask-numeric"
                                                            value="<?php echo $datashow['taxid_merge3']; ?>" style="width: 100%" onkeypress="return integeronly(event)" />
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
