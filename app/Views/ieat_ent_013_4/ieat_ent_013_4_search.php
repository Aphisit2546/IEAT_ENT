...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>กนอ. 01/3 (การเปลี่ยนแปลงสิทธิในที่ดิน)</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-106-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-106-00001-2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>(กนอ. 01/3 การเปลี่ยนแปลงสิทธิในที่ดิน)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกประเภทการรับสิทธิ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <select name="transfer_permission_id" class="form form-control">
                                                <option value="0">-- เลือก --</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกลักษณะพื้นที่ที่รับสิทธิ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <select name="character_transfer_area" class="form form-control">
                                                <option value="0">-- เลือก --</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกลักษณะการรับ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                    ...
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกผู้โอนสิทธิ์การเปลี่ยนแปลงการใช้ที่ดิน</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <div class="panel-heading">
                            <span class="font_header">กรุณาระบุแปลงที่ดินและเนื้อที่ที่ประสงค์จะเปลี่ยนแปลงสิทธิในที่ดิน</span>
                        </div>
                        <div class="table-responsive div_header p-4">
