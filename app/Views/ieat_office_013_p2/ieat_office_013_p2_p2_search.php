...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>กนอ. 01/3 (เพิ่มหรือเปลี่ยนแปลงประเภทการประกอบกิจการ)</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-107-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-5">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-107-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>(กนอ. 01/3 เพิ่มหรือเปลี่ยนแปลงประเภทการประกอบกิจการ)</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            <span class="head_detail">
                                                <input type='text' name='new_factory_type' value='4(1), 7(1), 1, 2, 3'>
                                                </font>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            <span class="head_detail">
                                                <input type='radio' name='check_out_bu' id='check_out_bu' value='1' checked>
                                                ใช้ข้อมูลเลขทะเบียนผู้ประกอบอุตสาหกรรมเดิม
                                                <br />
                                                <font color='red'>** <u>คำอธิบายเพิ่มเติม</u>**
                                                    <br />
                                                    เลขทะเบียนประกอบอุตสาหกรรม เมื่อออกแล้วจะไม่มีการเปลี่ยนแปลง แก้ไข แต่ในกรณีที่มีการเปลี่ยนแปลงประเภทการประกอบกิจการเป็นกิจการที่ไม่เกี่ยวเนี่องกับการประกอบอุตสาหกรรม เจ้าหน้าที่สามารถกำหนดโปรแกรม ให้ไม่ออกเลขทะเบียนอุตสาหกรรมได้ตามดุลยพินิจ
                                                </font>
                                                <br />
                                                <input type='radio' name='check_out_bu' id='check_out_bu' value='2'>
                                                ไม่ออกเลขทะเบียนผู้ประกอบอุตสาหกรรม
                                                <input type='hidden' name='new_business_no' value=''>
                ...
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="table-responsive div_header p-4">
                        <div class="panel-heading">
                            <span class="font_header_detail"><b>เลือกเพิ่มหรือเปลี่ยนแปลงประเภทการประกอบกิจการ</b></span>
                        </div>
                            ...
                            <div class="radio-lists">
                                <span class="font_header_detail">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="radio" id="add_operation_type_view_01" name="operation_type_modify_view" value="1" checked />
                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <input type="radio" id="operation_type_modify_view_02" name="operation_type_modify_view" value="2" disabled />
                                    <?php endif; ?>
