...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>ข.4</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-206-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-206-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>ข.4</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id='t01'>
                                    <tr>
                                        <th colspan="3" align="left">การจัดเตรียมเอกสาร</th>
                                    </tr>
                                </table>
                                <br />
                                <table width="100%" border="0" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td width="20%" valign="top"><span class="head_detail">การต่ออายุใบอนุญาต ครั้งที่</span></td>
                                        <td align="left" valign="top"><span class="detail"><input type="text" name="expend_doc" id="expend_doc" value="1"></span></td>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="top"><span class="head_detail">ให้ต่ออายุใบอนุญาตฉบับนี้</span></td>
                                        <td align="left" valign="top">
                                            <span class="detail">
                                                <select name='expiredate_expend'>
                                    ...
                                    <tr>
                                        <td align="left" valign="top"><span class="head_detail">โดยมีเงื่อนไข</span></td>
                                        <td align="left" valign="top"><span class="detail"><textarea name="remarks_doc" id="remarks_doc" cols="100" rows="4"></textarea></span></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="card p-4">.
                        <div class="row">
                            <div class="col-3" align="left">
                                <div class="table-responsive div_header p-4">
                                    <div class="card-header">
                                        <span class="font_header"><b>ความคืบหน้าในการก่อสร้าง (เปอร์เซ็นต์)</b></span>
                                    </div>
                                    <br />
                                    <div class="row row-form" align="center">
                                        <div class="col-lg-12">
                                            <span class="font_header_detail">80</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-9" align="left">
                                <div class="table-responsive div_header p-4">
                                    <div class="card-header">
                                        <span class="font_header"><b>เหตุผลในการต่ออายุ</b></span>
                                    </div>
                                    <br />
                                    <div class="row row-form">
                                        <div class="col-lg-12">
                                            <span class="font_header_detail">เนื่องจากประสบภาวะทางการเงินจึงทำให้ดำเนินการล่าช้ากว่าแผน จึงขอต่ออายุ</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบคำขอต่ออายุใบอนุญาตก่อสร้างอาคาร ดัดแปลง รื้อถอนอาคาร เคลื่อนย้ายอาคาร ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">
                                                3. หนังสือแสดงความยินยอมพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพสถาปัตยกรรมควบคุม และ
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                5. หนังสือแสดงความยินยอมพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม และ หนังสือรับรองการได้รับอนุญาต
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">6. รายงานความคืบหน้าโครงการพร้อมรูปประกอบ</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">7. เอกสารประกอบอื่นๆ</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
