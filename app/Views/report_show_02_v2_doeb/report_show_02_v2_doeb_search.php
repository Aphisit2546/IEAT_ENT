...
<div class="class_header_page_02">
    <br />
    รายงานสรุปความคืบหน้าตามแผนและตัวชี้วัด
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="6" class="align-middle text-left">รายงานสรุปความคืบหน้าตามแผนและตัวชี้วัด</th>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <th class="align-middle text-center">เป้าหมาย</th>
                                <th class="align-middle text-center">ตัวชี้วัด</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
