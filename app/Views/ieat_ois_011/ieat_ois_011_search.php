...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_011" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.6 (คำสั่งให้รื้อถอนอาคารตามมาตรา 42)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_011</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.6 (คำสั่งให้รื้อถอนอาคารตามมาตรา 42)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้รื้อถอนอาคารตามมาตรา 42
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="controller" id="chk_controller">
                                    <label class="form-check-label" for="chk_controller">ผู้ควบคุมงาน</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="operator" id="chk_operator">
                                    <label class="form-check-label" for="chk_operator">ผู้ดําเนินการ</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="employee" id="chk_employee">
                                    <label class="form-check-label" for="chk_employee">ลูกจ้าง</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="servant" id="chk_servant">
                                    <label class="form-check-label" for="chk_servant">บริวาร</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2" style="text-indent: 40px;">ด้วยปรากฏว่า ท่านได้ทําการ</div>
                            <div class="col-md-10">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control form-control-sm d-inline-block" 
                                        style="width:200px;" name="address_postcode">
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                        ...
                        <div class="pl-4 mb-4">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col">
                                    การกระทําดังกล่าว ไม่สามารถแก้ไขเปลี่ยนแปลง ให้ถูกต้องตามกฎกระทรวงซึ่งออกตามความในมาตรา 8 
                                    แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ข้อบัญญัติท้องถิ่น ซึ่งออกตามความในมาตรา 9 หรือมาตรา 10 
                                    แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 หรือประกาศซึ่งออกตามความใน มาตรา 13 แห่ง 
                                    พระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 และพระราชบัญญัติการนิคมอุตสาหกรรมแห่งประเทศไทย พ.ศ. 2522
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    <div class="d-flex flex-wrap align-items-center gap-2">
                                        <span>เจ้าของอาคารมิได้ปฏิบัติตามคําสั่งของเจ้าพนักงานท้องถิ่น คำสั่งเลขที่</span>
                                        <input type="text" class="form-control form-control-sm mx-1" style="width: 100px;" name="order_no">
                                        <span>ลงวันที่</span>
                                        <input type="text" class="form-control form-control-sm mx-1" style="width: 50px;" name="order_date">
                                        <span>เดือน</span>
                                        <input type="text" class="form-control form-control-sm mx-1" style="width: 100px;" name="order_month">
                                        <span>พ.ศ.</span>
                                        <input type="text" class="form-control form-control-sm mx-1" style="width: 60px;" name="order_year">
                                        <span>ตามมาตรา 41 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                    <input type="checkbox" name="sec41_opt3" value="1">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control form-control-sm" name="other_details">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col">
                                    อาศัยอํานาจตามความในมาตรา 42 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ให้ท่านรื้อถอนอาคาร ทั้งหมด/บางส่วน ดังนี้ *
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-auto">
                                    ) วัน** นับแต่วันที่ท่านได้รับคําสั่งนี้หากพ้นกําหนดนี้แล้วจะดําเนินการตามกฎหมายต่อไป
                                </div>
                            </div>
                            </br>
