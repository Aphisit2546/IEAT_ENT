        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        ช่วงปีงบประมาณ
                        <?php echo form_dropdown('Fiscalyear_start', $dropdown_year_thai, $data["Fiscalyear_start"], "class='form form-control' "); ?>
                    </div>
                    <div class="col-3">
                        ถึง
                        <?php echo form_dropdown('Fiscalyear_finish', $dropdown_year_thai, $data["Fiscalyear_finish"], "class='form form-control' "); ?>
                    </div>
                </div>
            </div>
        </div>
