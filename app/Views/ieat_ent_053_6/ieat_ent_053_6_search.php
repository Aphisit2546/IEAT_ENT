...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_6" style="color: #6007b3ff; font-size: 18px;"><b>คำขอเปลี่ยนชื่อนิติบุคคลประเภทบริษัทจำกัด</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอเปลี่ยนชื่อนิติบุคคลประเภทบริษัทจำกัด</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>กรอกข้อมูลคำขอ</b></span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>ชื่อนิติบุคคลเดิม (ภาษาไทย)</td>
                                        <td class="text-center align-middle">
                                    ...
                                    <tr>
                                        <td>ชื่อนิติบุคคลเดิม (ภาษาอังกฤษ)</td>
                                        <td class="text-center align-middle">
                                            <div class="col-md-12 mb-1">
                                                <input type="text" class="form-control" placeholder="" name="fname[]">
                                            </div>
                                    ...
                                    <tr>
                                        <td>ชื่อนิติบุคคลใหม่ (ภาษาไทย)</td>
                                        <td class="text-center align-middle">
                                            <div class="col-md-12 mb-1">
                                                <input type="text" class="form-control" placeholder="" name="fname[]">
                                            </div>
                                    ...
                                    <tr>
                                        <td>ชื่อนิติบุคคลใหม่ (ภาษาอังกฤษ)</td>
                                        <td class="text-center align-middle">
                                            <div class="col-md-12 mb-1">
                                                <input type="text" class="form-control" placeholder="" name="fname[]">
                                            </div>
                                    ...
                                    <tr>
                                        <td>เลขที่่หนังสือรับรองนิติบุคคลใหม่ (จากกระทรวงพาณิชย์)</td>
                                        <td class="text-center align-middle">
                                            <div class="col-md-12 mb-1">
                                                <input type="text" class="form-control" placeholder="" name="fname[]">
                                            </div>
