                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width='100%' border='0' align='center' cellpadding='10' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td width="94%" height='35' valign='top'>
                                            <input type="text" name="pp_000" value="การขออนุญาตตัด, ลดระดับคันหิน-ทางเท้า หรือทำทางเชื่อม" size="80" /></font>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table width='100%' border='0' align='center' cellpadding='5' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            ...
                                            2. <input type="text" name="pp_002_1" value="คำขออนุญาตตัด/ลดระดับคันหิน-ทางเท้า, ทำทางเชื่อม เลขที่ 1-15-0-213-00001-2568 ลงวันที่ 25 พฤศจิกายน 2568" size="120" /><br />
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table width='100%' border='0' align='center' cellpadding='7' cellspacing='1'>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 1<br />
                                            <textarea name="pp_004" id="pp_004" cols="120" rows="8">ตามหนังสือที่อ้างถึง 1 บริษัท สมมุติ15 จำกัด ได้รับหนังสืออนุญาตให้ใช้ที่ดินฯล่าสุด เลขที่ TEST015 ออกให้ ณ วันที่ 31-01-2554 ประกอบกิจการ ชุบเคลือบผิวทองแดงและทองเหลืองด้วยความร้อน (Plating, Heat Treatment) ซื้อ-ขายของที่ไม่ได้ใช้แล้วทุกชนิด, ชื้อ-ขาย ผลิตภัณฑ์เงินทุกชนิดทุกประเภท ผลิตภัณฑ์ทองแดงทุกชนิดทุกประเภท ผลิตภัณฑ์สังกะสีทุกชนิดทุกประเภท เหล็กกล้า ทองเหลือง อลูมิเนียม อัลลอย โลหะบริสุทธิ์ ลวดอัลลอย ในนิคมอุตสาหกรรม เกตเวย์ ซิตี้ จังหวัด ฉะเชิงเทรา ในเขตอุตสาหกรรม ประกอบการเสรี แปลงที่ดินเลขที่  พื้นที่ประมาณ 0 ไร่ 0 งาน 0.0 ตารางวา บริษัทฯ มีการขออนุญาตก่อสร้างฯและยื่นคำขออนุญาตตัด/ลดระดับคันหิน-ทางเท้า, ทำทางเชื่อม ตามหนังสือที่อ้างถึง 2 ความละเอียดแจ้งแล้ว นั้น</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 2<br />
                                            <textarea name="pp_005" id="pp_005" cols="120" rows="8">การนิคมอุตสาหกรรมแห่งประเทศไทย (กนอ.) พิจารณาแล้ว บริษัทฯ สามารถดำเนินการตัด, ลดระดับคันหิน-ทางเท้า หรือทำทางเชื่อม ตามแบบแปลนและรายการคำนวณ ที่ระบุในคำขอฯได้ ทั้งนี้ บริษัทฯ ต้องปฏิบัติตามกฎหมายที่เกี่ยวข้อง และให้คำนึงถึงความปลอดภัย ในการปฏิบัติงานต่อไป</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <br /><br />
                            ขออนุญาตตัดคันหินทางเท้าและทำทางเชื่อมกับถนนภายในนิคมอุตสาหกรรมเข้าด้างข้างโรงงาน
                        </div>
                    </div>
