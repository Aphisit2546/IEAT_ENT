...
<div class="class_header_page_02">
    <br />
    รายงานสรุปค่าใช้จ่ายตามแผนปฏิบัติราชการ 5 ปี
    <hr />
</div>
<div class="row">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        ค้นหาชื่อแผนปฏิบัติราชการ 5 ปี
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="10" class="align-middle text-left">รายงานสรุปค่าใช้จ่ายตามแผนปฏิบัติราชการ 5 ปี</th>
                            </tr>
                            <tr class="align-middle">
                                <th rowspan="2" class="align-middle text-center" width="5%">#</th>
                                <th rowspan="2" class="align-middle text-center">แผนย่อย</th>
                                <th rowspan="2" class="align-middle text-center">โครงการ</th>
                                <th rowspan="2" class="align-middle text-center">หน่วยงาน</th>
                                <th colspan='5' class="align-middle text-center">ประมาณการแผนประมาณรายปี (บาท)</th>
                                <th rowspan="2" class="align-middle text-center">แหล่งที่มาของงบประมาณ</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center">ปีที่ 1</th>
                                <th class="align-middle text-center">ปีที่ 2</th>
                                <th class="align-middle text-center">ปีที่ 3</th>
                                <th class="align-middle text-center">ปีที่ 4</th>
                                <th class="align-middle text-center">ปีที่ 5</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
