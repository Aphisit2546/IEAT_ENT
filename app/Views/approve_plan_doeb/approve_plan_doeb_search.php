                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-center">
                                            <?php if ($item["ActiveStatusApprove"] == 'Y' and $item["HoldStatusApprove"] == 'Y'): ?>
                                                <span class="detail">
                                            ...
                                            <?php else: ?>
                                                <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["CreatePlan_id"] ?>"><i class="fas fa-edit"></i> ตรวจสอบและพิจารณา</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php
