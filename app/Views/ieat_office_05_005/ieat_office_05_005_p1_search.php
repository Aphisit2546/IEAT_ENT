...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_05_005" style="color: #6007b3ff; font-size: 18px;"><b>คำขออนุญาตถือกรรมสิทธิ์ที่ดินในนิคมฯ (15ส. นิติบุคคลต่างด้าว)*มีค่าใช้จ่าย</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>01-02-51-000001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <div class="row row-form">
        <div class="col-lg-4">
            ...
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>17-1 และ 17-2</b></font>0
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                                        ...
                                        <td style="width:75%;">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-6">
                                                    <span class="form-control-plaintext">5000.00</span>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-4">
                                                    ...
                                                    <span class="form-control-plaintext">8</span>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3 col-sm-4">
                                                    ...
                                                    <span class="form-control-plaintext">17</span>
                                                </div>
                                                <div class="col-md-1 col-sm-2 align-self-end mb-2">
                                                    หุ้น
                                                </div>
                                                <div class="col-md-3 col-sm-4">
                                                    ...
                                                    <span class="form-control-plaintext">85000.00</span>
                                                </div>
                                                <div class="col-md-1 col-sm-2 align-self-end">
                                                    บาท
                                                </div>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:40%; text-align:center;">
                                            สัญชาติ
                                            <div style="font-size:12px; color:#ff0000; margin-top:3px;">
                                                หากไม่พบข้อมูลสัญชาติที่ต้องการ กรุณาแจ้ง update มาที่  
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="form-control-plaintext text-right">6</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="form-control-plaintext">No</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-2 col-sm-3 mb-2">
                                    <span class="form-control-plaintext text-right">30000.00</span>
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <span class="form-control-plaintext text-center">ไม่ได้ระบุ</span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="form-control-plaintext text-right">999</span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="form-control-plaintext text-center">ไม่ได้ระบุ</span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="form-control-plaintext text-right">9999</span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="form-control-plaintext">กรุงเทพมหานคร</span>
                                            </td>
                                            <td class="align-middle">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:70%;">
                                            <span class="form-control-plaintext">เพื่อประกอบกิจการร้านอาหาร</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                        ...
                                        <td>
                                            <span class="form-control-plaintext">บริษัท เทส จำกัด</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                        ...
                                        <td>
                                            <span class="form-control-plaintext">บริษัท ทอสอบ จำกัด</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                        ...
                                        <td>
                                            <span class="form-control-plaintext">บริษัท ทดลอง จำกัด</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                        ...
                                        <td>
                                            <span class="form-control-plaintext">ธนาคารสมมุติ จำกัด (มหาชน)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                        ...
                                        <td>
                                            <span class="form-control-plaintext">ศาลจังหวัด</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle" style="width:40%;">
                                            <span class="form-control-plaintext text-right">20</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:20%;">ตร.ม. (square meters)</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%; text-align:center;">พื้นที่ ตร.ม.<br>(square meters)</th>
                                        <th style="width:10%; text-align:center;">รวมพื้นที่ ตร.ม.<br>(square meters)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">80</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>1.2 อาคารย่อย</td>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width:50%;" class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">110</span>
                                        </td>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="width:70%; text-align:center;">รายการ</th>
                                        <th style="width:30%; text-align:center;">หน่วย ตร.ม.<br>(square meters)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>ลาน/โรงเก็บผลิตภัณฑ์ ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>โรงอาหาร ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ลาน/โรงจอดรถ ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ถนนภายใน ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>บริเวณที่ขนถ่ายสินค้า ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>โรงซ่อมอุปกรณ์เครื่องจักร ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>ป้อมยาม ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>โรงสูบน้ำ ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Boiler ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>อาคารสำนักงาน ใช้พื้นที่</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>บริเวณเก็บกักน้ำมันเชื้อเพลิง</td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">10</span>
                                        </td>
                                    </tr>
