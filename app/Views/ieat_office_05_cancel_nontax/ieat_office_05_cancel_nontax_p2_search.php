...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-01-0-501-00133-2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-0-501-00133-2568</b></font>
    &nbsp;&nbsp;
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table table-bordered" id="datatable01">
                                <tbody>
                                    <tr>
                                        <td class="text-center"><span class="font_header_detail_red"> -- ไม่มีข้อมูล --</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. หนังสือ/จดหมายยืนยันการยกเลิกสิทธิประโยชน์ด้านไม่เกี่ยวกับภาษีอากร</td>
                                        <td width="30%">
