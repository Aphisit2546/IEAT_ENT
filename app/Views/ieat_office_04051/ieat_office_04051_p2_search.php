...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-83-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-83-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>IEAT-E-03</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/04051.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_04051/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>ประเภทของที่ต้องการนำออก
                                        <td>
                                            ผลิตภัณฑ์ สิ่งพลอยได้ และสิ่งอื่นที่ได้จากการผลิตในเขตประกอบการเสรี
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>นำของออกโดย
                        ...
                        <div class="table-responsive div_header p-4">
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                <tr>
                                    <td align="left">
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>รายการ Invoice ใบที่ </font>&nbsp;1 </span>
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>Invoice เลขที่ :</font>&nbsp;-</span>
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>ลงวันที่ :</font>&nbsp;9999-12-31</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>หมายเหตุ :</font>&nbsp;-</span>
                                    </td>
                                </tr>
                            </table>
                            <table class="table">
                                <tr>
                                    <td align="center"><span class="font_head_detail_table">ลำดับรายการ</span></td>
                                    <td width="35%" align="center"><span class="font_head_detail_table">ชื่อรายการ</span></td>
                                    <td align="center"><span class="font_head_detail_table">พิกัดศุลกากร</span></td>
                                    <td align="center"><span class="font_head_detail_table">เลขสถิติ</span></td>
                                    <td align="center"><span class="font_head_detail_table">ปริมาณ</span></td>
                                    <td align="center"><span class="font_head_detail_table">หน่วย</span></td>
                                    <td align="center"><span class="font_head_detail_table">น้ำหนัก</span></td>
                                    <td align="center"><span class="font_head_detail_table">หน่วย</span></td>
                                    <td align="center"><span class="font_head_detail_table">ราคา</span></td>
                                    <td align="center" width="208"><span class="font_head_detail_table">หมายเหตุ</span></td>
                                </tr>
                                <tr>
                                    <td align="center">1</td>
                                    <td align="left">SUGAR / COCOA PREPARATION (S-C/PM(30)) / น้ำตาลผสมผงโกโก้</td>
                                    <td align="center">000018061000</td>
                                ...
                                <tr>
                                    ...
                                    <td align="left">SUGAR / COCOA PREPARATION (PP-1) / น้ำตาลผสมผงโกโก้</td>
                                    <td align="center">000018061000</td>
                                    <td align="center">000</td>
                                    <td align="center">40000</td>
                                    <td align="center">BG</td>
                                ...
                                <tr>
                                    ...
                                    <td align="left">SUGAR / COCOA PREPARATION (S-C/PP (10.5)) / น้ำตาลผสมผงโกโก้</td>
                                    <td align="center">000018061000</td>
                                    <td align="center">000</td>
                                    <td align="center">40000</td>
                                    <td align="center">BG</td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="40%">
                                            1. INVOICE (ไฟล์ PDF ไม่เกิน 5 MB)
                                        </td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="40%">
                                            2. หลักฐานอื่นที่เกี่ยวเนื่องเพื่อการนั้น (ไฟล์ PDF ไม่เกิน 5 MB)
                                        </td>
                                        <td width="30%">
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
