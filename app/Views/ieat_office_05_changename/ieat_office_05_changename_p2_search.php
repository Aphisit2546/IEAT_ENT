...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_05_changename" style="color: #6007b3ff; font-size: 18px;"><b>คำขอการเปลี่ยนแปลงคำนำหน้าชื่อ ชื่อ สกุล ของช่างฝีมือ ผู้ชำนาญการและครอบครัว</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-1-0-99-00007-2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-1-0-99-00007-2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอการเปลี่ยนแปลงคำนำหน้าชื่อ ชื่อ สกุล ของช่างฝีมือ ผู้ชำนาญการและครอบครัว</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>เลือกและกรอกข้อมูลที่ต้องการแก้ไข</b></span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th colspan="3" class="text-center align-middle">
                                            <div class="row">
                                                <div class="col-md-2 col-sm-4 text-right align-middle" style="margin:auto 0;">
                                                    เลือกรายชื่อช่าง
                                                </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle">
                                            <input type="checkbox" name="edit_field[]" value="prefix">
                                        </td>
                                        <td class="align-middle">คำนำหน้าชื่อ</td>
                                        <td class="text-center align-middle">
                                    ...
                                    <tr>
                                        <td class="text-center align-middle">
                                            <input type="checkbox" name="edit_field[]" value="fname">
                                        </td>
                                        <td class="align-middle">ชื่อ</td>
                                        <td class="text-center align-middle">
                                    ...
                                    <tr>
                                        <td class="text-center align-middle">
                                            <input type="checkbox" name="edit_field[]" value="mname">
                                        </td>
                                        <td class="align-middle">ชื่อกลาง</td>
                                        <td class="text-center align-middle">
                                    ...
                                    <tr>
                                        <td class="text-center align-middle">
                                            <input type="checkbox" name="edit_field[]" value="lname">
                                        </td>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหนังสือเดินทางของช่างฝีมือ ผู้ชำนาญการ (เล่มเดิม และ เล่มใหม่)</td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. หลักฐานการเปลี่ยนแปลงคำนำหน้าชื่อ/ชื่อและชื่อสกุล</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. เอกสารอื่นๆ</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
