...
<div class="class_header_page_02">
    <br />
    รายงานสรุปสถานะโครงการตามปีงบประมาณ
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="12" class="align-middle text-left">รายงานสรุปสถานะโครงการตามปีงบประมาณ</th>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <th colspan="2" class="align-middle text-center">ช่วงก่อนเริ่มสัญญา</th>
                                <th colspan="3" class="align-middle text-center">ความก้าวหน้างานสะสม</th>
                                <th colspan="3" class="align-middle text-center">การเบิกจ่ายสะสม</th>
                            </tr>
                            <tr>
                                <th class="align-middle text-center">ขั้นตอนในปัจจุบัน</th>
                                <th class="align-middle text-center">สถานะ</th>

                                <th class="align-middle text-center">เดือนล่าสุด</th>
                                <th class="align-middle text-center">จำนวน</th>
                                <th class="align-middle text-center">งวดงาน</th>

                                <th class="align-middle text-center">เดือนล่าสุด</th>
                                <th class="align-middle text-center">จำนวน</th>
                                <th class="align-middle text-center">งวดเบิกเงิน</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
