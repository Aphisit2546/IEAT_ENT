...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>กนอ. 01/3 (การเลิก/หยุดประกอบกิจการ)</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-999-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-999-00001-2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>(กนอ. 01/3 การเลิก/หยุดประกอบกิจการ)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="1" <?php echo $checked1; ?>> เลิกประกอบกิจการทั้งหมด
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="2" <?php echo $checked2; ?>> หยุดประกอบกิจการทั้งหมด
                                            วันที่ <input name="starttime_cancel" type="text" id="starttime_cancel" value="<?php echo $datashow['starttime_cancel']; ?>" />
                                            ถึงวันที่ <input name="finishtime_cancel" type="text" id="finishtime_cancel" value="<?php echo $datashow['finishtime_cancel']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="3" <?php echo $checked3; ?>> หยุดประกอบกิจการบางส่วน
                                            วันที่ <input name="starttime_cancel_hold" type="text" id="starttime_cancel_hold" value="<?php echo $datashow['starttime_cancel_hold']; ?>" />
                                            ถึงวันที่ <input name="finishtime_cancel_hold" type="text" id="finishtime_cancel_hold" value="<?php echo $datashow['finishtime_cancel_hold']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <br />
                                            <textarea name="detail" cols="100" rows="5"><?php echo $datashow['detail']; ?></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
