...
<form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
    ...
    <input type="hidden" name='ChangeBudgetPlanID' id="ChangeBudgetPlanID" value="<?php echo $ChangeBudgetPlanID; ?>">
    <hr />
                            ...
                            <tr>
                                <th class="text-left">
                                    <div class="class_header_page_03">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        งบประมาณที่ได้รับตาม พ.ร.บ. <font style="color:black; font-size:20px;"><?php if ($detailsub_last['detail_sub2'][0]['Budget01'] != '' && $detailsub_last['detail_sub2'][0]['Budget01'] != null) {
                        ...
                        <?php if ($detailsub_last['detail_sub2'][0]['NameActivity'] != ''): ?>
                            <table class="table table-bordered" id="datatable1">
                                <tr class="bg_th">
                                    ...
                                    <th class="text-center">
                                        <font color='white'>งบประมาณที่ได้รับการจัดสรรเดิม (บาท)</font>
                                    </th>
                                    <th class="text-center">
                                        <font color='white'>งบประมาณที่ดำเนินการแล้ว (บาท)</font>
                                    </th>
                                    <th class="text-center">
                                        <font color='white'>คงเหลือ (บาท)</font>
                                    </th>
                                    <th class="text-center">
                                        <font color='white'>งบประมาณที่ขอใหม่ (บาท)</font>
                                    </th>

                                    <th class="text-center">
                                        <font color='white'>งบประมาณที่ได้รับการจัดสรรใหม่ (บาท)</font>
                                    </th>
                                </tr>
                                <?php $seq_all = 1; ?>
                                        ...
                                        <?php if ($detail_sub2['CreatePlanDetail_id'] != ''): ?>
                                            ...
                                            <tr>
                                                <td align="left" valign="middle">
                                                    ...
                                                    <input type="hidden" name='ItemL3_Type1_<?php echo $seq_01; ?>' id="ItemL3_Type1_<?php echo $seq_01; ?>" value="<?php echo $detailsub_last['detail_sub2'][0]['ItemL3Project']; ?>">
                                                ...
                                                <td align="right" valign="middle">
                                                    <?php if ($detail_sub2['Budget02'] != '' && $detail_sub2['Budget02'] != null) {
                                                        echo number_format($detail_sub2['Budget02'], 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange01_Type1_<?php echo $seq_01; ?>' id="BudgetChange01_Type1_<?php echo $seq_01; ?>" value="<?php echo $detail_sub2['Budget02']; ?>">
                                                </td>
                                                <td align="right" valign="SumTotalAccumulateDisbursement">
                                                    <?php if ($detail_sub2['SumTotalAccumulateDisbursement'] != '' && $detail_sub2['SumTotalAccumulateDisbursement'] != null) {
                                                        echo number_format($detail_sub2['SumTotalAccumulateDisbursement'], 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange02_Type1_<?php echo $seq_01; ?>' id="BudgetChange02_Type1_<?php echo $seq_01; ?>" value="<?php echo $detail_sub2['SumTotalAccumulateDisbursement']; ?>">
                                                </td>
                                                <td align="right" valign="middle">
                                                    <?php if ($detail_sub2['Budget02'] != '' && $detail_sub2['SumTotalAccumulateDisbursement'] != '') {
                                                        $remaining = $detail_sub2['Budget02'] - $detail_sub2['SumTotalAccumulateDisbursement'];
                                                        echo number_format($remaining, 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange03_Type1_<?php echo $seq_01; ?>' id="BudgetChange03_Type1_<?php echo $seq_01; ?>" value="<?php echo $remaining; ?>">
                                                </td>
                                                <td align="right" valign="middle">
                                                    <?php if ($detail_sub2['TotalDisbursementLast'] != '' && $detail_sub2['TotalDisbursementLast'] != null) {
                                                        echo number_format($detail_sub2['TotalDisbursementLast'], 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange04_Type1_<?php echo $seq_01; ?>' id="BudgetChange04_Type1_<?php echo $seq_01; ?>" value="<?php echo $detail_sub2['TotalDisbursementLast']; ?>">
                                                </td>
                                                <td align="center" valign="middle">
                                                    <?php
                                                    if ($detail_sub2['Budget02New'] != '' && $detail_sub2['Budget02New'] != null) {
                                                        $Budget02New_type1 = $detail_sub2['Budget02New'];
                                                    } elseif ($detail_sub2['TotalDisbursementLast'] != '' && $detail_sub2['TotalDisbursementLast'] != null) {
                                                        $Budget02New_type1 = $detail_sub2['TotalDisbursementLast'];
                                                    } else {
                                                        $Budget02New_type1 = 0;
                                                    }
                                                    ?>
                                                    <input size='13' name="Budget02_Type1_<?php echo $seq_01; ?>" type="text" id="Budget02New" value="<?php echo number_format($Budget02New_type1, 2); ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" oninput="updateColumn3(this)" />
                                                </td>
                                            </tr>
                                        ...
                                        <?php if ($detail_sub2['DraftBudgetControlDetail_id'] != ''): ?>
                                            ...
                                            <tr>
                                                <td align="left" valign="middle">
                                                    ...
                                                    <input type="hidden" name='ItemL3_Type3_<?php echo $seq_array_01; ?>' id="ItemL3_Type3_<?php echo $seq_array_01; ?>" value="<?php echo $detailsub_last['detail_sub2'][0]['ItemL3Project']; ?>">
                                                ...
                                                <td align="right" valign="middle">
                                                    <span class="detail">
                                                        <?php echo number_format($detail_sub2['Budget02'], 2); ?>
                                                    </span>
                                                    <input type="hidden" name='BudgetChange01_Type3_<?php echo $seq_array_01; ?>' id="BudgetChange01_Type3_<?php echo $seq_array_01; ?>" value="<?php echo $detail_sub2['Budget02']; ?>">
                                                </td>
                                                <td align="right" valign="SumTotalAccumulateDisbursement">
                                                    <?php if ($detail_sub2['SumTotalAccumulateDisbursement'] != '' && $detail_sub2['SumTotalAccumulateDisbursement'] != null) {
                                                        echo number_format($detail_sub2['SumTotalAccumulateDisbursement'], 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange02_Type3_<?php echo $seq_array_01; ?>' id="BudgetChange02_Type3_<?php echo $seq_array_01; ?>" value="<?php echo $detail_sub2['SumTotalAccumulateDisbursement']; ?>">
                                                </td>
                                                <td align="right" valign="middle">
                                                    <?php if ($detail_sub2['Budget02'] != '' && $detail_sub2['SumTotalAccumulateDisbursement'] != '') {
                                                        $remaining_type3 = $detail_sub2['Budget02'] - $detail_sub2['SumTotalAccumulateDisbursement'];
                                                        echo number_format($remaining_type3, 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange03_Type3_<?php echo $seq_array_01; ?>' id="BudgetChange03_Type3_<?php echo $seq_array_01; ?>" value="<?php echo $remaining_type3; ?>">
                                                </td>
                                                <td align="right" valign="middle">
                                                    <?php if ($detail_sub2['SumTotalAccumulateDisbursement'] != '' && $detail_sub2['TotalDisbursementLast'] != '') {
                                                        $remaining_type3s = $detail_sub2['Budget02'] - $detail_sub2['SumTotalAccumulateDisbursement'];
                                                        echo number_format($remaining_type3s, 2);
                                                    } ?>
                                                    <input type="hidden" name='BudgetChange04_Type3_<?php echo $seq_array_01; ?>' id="BudgetChange04_Type3_<?php echo $seq_array_01; ?>" value="<?php echo $remaining_type3s; ?>">
                                                </td>
                                                <td align="center" valign="middle">
                                                    <?php
                                                    if ($detail_sub2['Budget02New'] != '' && $detail_sub2['Budget02New'] != null) {
                                                        $Budget02New_type3 = $detail_sub2['Budget02New'];
                                                    } elseif ($detail_sub2['SumTotalAccumulateDisbursement'] != '' && $detail_sub2['SumTotalAccumulateDisbursement'] != null) {
                                                        $Budget02New_type3 = $detail_sub2['Budget02'] - $detail_sub2['SumTotalAccumulateDisbursement'];
                                                    } else {
                                                        $Budget02New_type3 = 0;
                                                    }
                                                    ?>
                                                    <input size='13' name="Budget02_Type3_<?php echo $seq_array_01; ?>" type="text" id="Budget02New" value="<?php echo number_format($Budget02New_type3, 2); ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" oninput="updateColumn3(this)" />
                                                </td>
                                            </tr>
                                            <?php
                                            $seq_main_01++;
