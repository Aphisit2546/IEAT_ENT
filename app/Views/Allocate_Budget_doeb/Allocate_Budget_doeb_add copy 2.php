    ...
    <div class="form-group row">
        <table class="table table-bordered" id="datatable1">
            ...
            ?>
                    ...
                    ?>
                        <tr>
                            <td align="left" valign="middle"><?php echo $seq_main_01; ?>.<?php echo $seq_sub; ?></td>
                            <td align="left" valign="middle">
                                <span class="detail">
                            ...
                            <td align="right" valign="middle">
                                ...
                                <input type="hidden" name='sum_budget_Type3_<?php echo $seq_array_01; ?>' id="sum_budget" value="<?php echo $result_data_set3_sub['price_all']; ?>">
                                <input type="hidden" name='DraftBudgetControlDetailSub_id_Type3_<?php echo $seq_array_01; ?>' id="DraftBudgetControlDetailSub_id_Type3" value="<?php echo $result_data_set3_sub['DraftBudgetControlDetailSub_id']; ?>">
                            </td>

                            <td align="center" valign="middle"><input size='13' name="Budget01_Type3_<?php echo $seq_array_01; ?>" type="text" id="Budget01" value="<?php if ($result_data_set3_sub['Budget01'] != '' && $result_data_set3_sub['Budget01'] != null) {
                                                                                                                                                                        echo number_format($result_data_set3_sub['Budget01'], 2);
                                                                                                                                                                    } ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" /></td>
                            <td align="center" valign="middle"><input size='13' name="Budget02_Type3_<?php echo $seq_array_01; ?>" type="text" id="Budget02" value="<?php if ($result_data_set3_sub['Budget02'] != '' && $result_data_set3_sub['Budget02'] != null) {
                                                                                                                                                                        echo number_format($result_data_set3_sub['Budget02'], 2);
                                                                                                                                                                    } ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" oninput="updateColumn3(this)" /></td>
                            <td align="center" valign="middle"><input class="col3-output" size='10' style="border-width: 0px; text-align: right; font-size:16px;" name="BudgetNegative_Type3_<?php echo $seq_array_01; ?>" type="text" id="BudgetNegative" value="<?php echo $result_data_set3_sub['BudgetNegative']; ?>"></td>
                            <td align="center" valign="middle"><input size='10' style="border-width: 0px; text-align: right; font-size:16px;" name="BudgetPercentage_Type3_<?php echo $seq_array_01; ?>" type="text" id="BudgetPercentage" value="<?php echo $result_data_set3_sub['BudgetPercentage']; ?>"></td>
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="right" valign="middle">
                                ...
                                <input type="hidden" name='sum_budget_Type4_<?php echo $seq_array_02; ?>' id="sum_budget" value="<?php echo $result_data_set4_sub['price_all']; ?>">
                                <input type="hidden" name='DraftBudgetControlDetailSub_id_Type4_<?php echo $seq_sub; ?>' id="DraftBudgetControlDetailSub_id_Type4_" value="<?php echo $result_data_set4_sub['DraftBudgetControlDetailSub_id']; ?>">
                            </td>

                            <td align="center" valign="middle"><input size='13' name="Budget01_Type4_<?php echo $seq_array_02; ?>" type="text" id="Budget01" value="<?php if ($result_data_set4_sub['Budget01'] != '' && $result_data_set4_sub['Budget01'] != null) {
                                                                                                                                                                        echo number_format($result_data_set4_sub['Budget01'], 2);
                                                                                                                                                                    } ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" /></td>
                            <td align="center" valign="middle"><input size='13' name="Budget02_Type4_<?php echo $seq_array_02; ?>" type="text" id="Budget02" value="<?php if ($result_data_set4_sub['Budget02'] != '' && $result_data_set4_sub['Budget02'] != null) {
                                                                                                                                                                        echo number_format($result_data_set4_sub['Budget02'], 2);
                                                                                                                                                                    } ?>" onkeyup="dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" oninput="updateColumn3(this)" /></td>
                            <td align="center" valign="middle"><input size='10' style="border-width: 0px; text-align: right; font-size:16px;" name="BudgetNegative_Type4_<?php echo $seq_array_02; ?>" type="text" id="BudgetNegative" value="<?php echo $result_data_set4_sub['BudgetNegative']; ?>"></td>
                            <td align="center" valign="middle"><input size='10' style="border-width: 0px; text-align: right; font-size:16px;" name="BudgetPercentage_Type4_<?php echo $seq_array_02; ?>" type="text" id="BudgetPercentage" value="<?php echo $result_data_set4_sub['BudgetPercentage']; ?>"></td>

                            <td align="center" valign="middle">
                                -
                            </td>
                        </tr>
                        <?php $sum_budget[] = $result_data_set4_sub['price_all']; ?>
                        <?php $sum_budget_04[] = $result_data_set4_sub['price_all']; ?>
                        <?php $seq_sub++; ?>
                        <?php $seq_array_02++; ?>
                    <?php endforeach; ?>
                <?php
