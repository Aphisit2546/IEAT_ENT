...
<div class="class_header_page_02">
    <br />
    ผลการปฏิบัติงานภารกิจด้านคุณภาพ
    <hr />
</div>
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td class="align-top text-left">ตรวจคุณภาพ</td>
                ...
                <tr>
                    <td class="align-top text-left">ต่ออายุผู้ค้าน้ำมันหล่อลื่น</td>
                ...
                <tr>
                    <td class="align-top text-left">ขอความเห็นชอบ/แบบแจ้ง E-OFFSPEC สารเติมแต่ง ไบโอดีเชล (บี100) ไบโอดีเซลชุมชน น้ำมันหล่อลื่น</td>
                ...
                <tr>
                    <td class="align-top text-left">ขอเปลี่ยนแปลงรายละเอียดการได้รับความเห็นชอบ E-OFFSPEC สารเติมแต่ง ไบโอดีเชล (บี100) ไบโอดีเซลชุมชน น้ำมันหล่อลื่น</td>
