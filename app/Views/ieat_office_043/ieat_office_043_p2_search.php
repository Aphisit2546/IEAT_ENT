...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_043" style="color: #6007b3ff; font-size: 18px;"><b>ยื่นคำขอยกเว้นหรือคืนค่าภาษีอากร สำหรับเครื่องจักร วัตถุดิบ นำเข้าจากต่างประเทศ IEAT-I-05</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-13-1-43-00001-2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-13-1-43-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>IEAT-I-05</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
        ...
        <div class="card-body">
            <div class="tab-content">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/043.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_043/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>ยื่นคำขอยกเว้นหรือคืนค่าภาษีอากร สำหรับเครื่องจักร วัตถุดิบ นำเข้าจากต่างประเทศ IEAT-I-05</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>ประเภทที่นำเข้าส่วนใหญ่เป็น
                                        <td>
                                            วัตถุดิบ
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-lg">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-detail-right col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            <div class="initial-form">ท่า 9999<?php echo $_SESSION['companyname_th_view']; ?></div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
