                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <th colspan='2' class="align-middle text-center">ความก้าวหน้าสะสม</th>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <th class="align-middle text-center">ยอดเบิกจ่าย<br />ณ ปัจจุบัน (บาท)</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-top text-center">
                                                    <?php if ($item["ActiveStatus"] == 'Y'): ?>
                                                        <a id="btnView" class="btn btn-primary" onclick="window.open('<?php echo base_url(); ?>Report_01_activity_doeb/view/<?= $item["MonthlyActivity_id"] ?>', '_blank', 'width=1200,height=550,scrollbars=1');">ดูรายละเอียดข้อมูล</a>
                                                    <?php else: ?>
                                                        <a id="btnEdit" class="btn btn-warning" href="<?php echo base_url(); ?>Report_01_activity_doeb/edt/<?= $item["MonthlyActivity_id"] ?>"><i class="fas fa-edit"></i> แก้ไข</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php
