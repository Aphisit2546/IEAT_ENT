...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>ข.7</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-210-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-210-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>ข.7</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/0210.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_0210/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left col-xs-3 col-sm-3 col-md-3 col-lg-3"><span class="font_header_detail">ผู้รับโอนอาคาร</span></td>
                                        <td class="table-detail-left col-xs-9 col-sm-9 col-md-9 col-lg-9">
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบการขอโอนใบอนุญาตก่อสร้าง ดัดแปลง รื้อถอน เคลื่อนย้าย หรือเปลี่ยนการใช้อาคาร (ข.7) ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">3. แผนผังแปลงที่ดิน/ผังแม่บท</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">4. โฉนดที่ดิน</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">5. หนังสืออนุญาตใช้ที่ดิน กนอ. 01/2 หรือ กนอ.03/6 ล่าสุด พร้อมเงื่อนไขแนบท้าย</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">6. เอกสารอื่นๆที่เกี่ยวข้อง</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
