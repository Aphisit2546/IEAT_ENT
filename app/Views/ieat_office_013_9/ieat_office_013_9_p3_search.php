                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_013_9/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="1" <?php echo $checked1; ?> disabled> เลิกประกอบกิจการทั้งหมด
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="2" <?php echo $checked2; ?> disabled> หยุดประกอบกิจการทั้งหมด
                                            วันที่ -
                                            ถึงวันที่ -
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="radio" name="type_cancel" value="3" <?php echo $checked3; ?> checked> หยุดประกอบกิจการบางส่วน
                                            วันที่ 20/11/2568
                                            ถึงวันที่ 31/12/2568
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <br />
                                            เนื่องจากปรับโครงสร้างของโรงงานบางส่วน
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
