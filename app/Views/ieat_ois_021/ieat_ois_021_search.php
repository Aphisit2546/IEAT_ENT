...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_021" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.11 (คำสั่งให้บรรเทาเหตุที่อาจก่อให้เกิดอันตรายหรือห้ามใช้อาคาร กรณีฉุกเฉิน ตามมาตรา 46 วรรคหนึ่ง ประกอบกับข้อ 7 แห่งกฎกระทรวง ฉบับที่ 47 (พ.ศ. 2540) ออกตามความในพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_021</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.11 (คำสั่งให้บรรเทาเหตุที่อาจก่อให้เกิดอันตรายหรือห้ามใช้อาคาร กรณีฉุกเฉิน ตามมาตรา 46 วรรคหนึ่ง ประกอบกับข้อ 7 แห่งกฎกระทรวง ฉบับที่ 47 (พ.ศ. 2540) ออกตามความในพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้บรรเทาเหตุที่อาจก่อให้เกิดอันตรายหรือห้ามใช้อาคาร กรณีฉุกเฉิน<br>
                                ตามมาตรา 46 วรรคหนึ่ง ประกอบกับข้อ 7 แห่งกฎกระทรวง ฉบับที่ 47 (พ.ศ. 2540)<br>
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                มีสภาพหรือมีการใช้ที่อาจเป็นภยันตรายต่อสุขภาพ ชีวิต ร่างกาย 
                        ...
                        <div class="pl-4 mb-4">
                            <div class="mb-2 text-justify" style="text-indent: 40px;">
                                	อาศัยอำนาจตามความในมาตรา 46 วรรคหนึ่ง แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ประกอบ 
                                    กับข้อ 7 แห่งกฎกระทรวง ฉบับที่ 47 (พ.ศ. 2540) ออกตามความในพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    ให้ท่านดำเนินการเพื่อบรรเทาเหตุที่อาจก่อให้เกิดภยันตรายดังกล่าวตามรายละเอียดตามรายการแนบท้ายคำสั่งนี้ * ให้เสร็จภายใน
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-md-3 col-sm-4 mb-2">
                                    <input type="text" class="form-control form-control-sm" name="within_day_text">
                                </div>
                                <div class="col-auto">(</div>
                                <div class="col-md-3 col-sm-4 mb-2">
                                    <input type="text" class="form-control form-control-sm" name="within_day_num">
                                </div>
                                <div class="col-auto">
                                    ) วัน* นับแต่วันที่ท่านได้รับคำสั่งนี้ หากพ้นกำหนดนี้แล้วจะดำเนินการตามกฎหมายต่อไป
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    ห้ามมิให้ท่านใช้หรือยินยอมให้ผู้อื่นใช้อาคารดังนี้
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                ไว้ก่อนจนกว่าจะมีการแก้ไขเพื่อบรรเทาเหตุที่อาจก่อให้เกิดภยันตราย ตามรายการแนบท้ายคำสั่งนี้ *
                            </div>
                        </div>
