...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="center_ieat_ent" style="color: #6007b3ff; font-size: 18px;"><b>คำขอ สาธารณสุข</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_077" style="color: #6007b3ff; font-size: 18px;"><b>คำขอประกอบกิจการที่เป็นอันตรายต่อสุขภาพ</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-70-0-707-80003-2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-70-0-707-80003-2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอประกอบกิจการที่เป็นอันตรายต่อสุขภาพ</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>ข้อมูลประกอบคำขอ</b></span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>เสำเนาหนังสือรับรองตัวตัวของผู้ยื่นคำขอ (หนังสือรับรองนิติบุคคล/สำเนาบัตรประชาชน)</td>
                                    ...
                                    <tr>
                                        <td class="align-middle">แนบเอกสารประกอบมติเห็นชอบจากการทำประชาพิจารณ์</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>กรุณาเลือกกลุ่มกิจการที่ต้องขออนุญาต</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>กรุณาเลือกกิจการที่ต้องขออนุญาต</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>ปัญหาผลกระทบที่สืบเนื่องจากกิจการ</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>มลพิษทางน้ำ</td>
                                        <td>แนวทางการควบคุมการก่อเกิดมลพิษทางน้ำ ตามมาตรฐานข้อกำหนด</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>มลพิษทางอากาศ</td>
                                        <td>แนวทางการควบคุมการก่อเกิดมลพิษทางอากาศ ตามมาตรฐานข้อกำหนด</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>มลพิษทางเสียงและความสั่นสะเทือน</td>
                                        <td>แนวทางการควบคุมมลพิษทางเสียงและความสั่นสะเทือนตามมาตรฐานข้อกำหนด</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>ด้านความปลอดภัย อาชีวอนามัย และสุขภาพของผู้ปฏิบัติงาน</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>มาตรการความปลอดภัยของสถานประกอบการ</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>ข้อมูลสถานที่ที่ปลอดภัยสำหรับเก็บรักษาวัตถุอันตราย (ถ้ามี)</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>รูปภาพแสดงสถานที่ชำระร่างกายฉุกเฉินและที่ล้างตาฉุกเฉิน ที่สอดคล้องกับการประกอบกิจการ</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>รูปภาพการจัดวางอุปกรณ์เครื่องจักร เครื่องมือต่าง ๆ ในสถานประกอบการ</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>รูปภาพ ระบบป้องกันอันตราย และป้ายคำเตือนหรือคำแนะนำในการป้องกันอันตรายจากอุปกรณ์ เครื่องมือ เครื่องจักร หรือเตือนอันตรายจากสภาพแวดล้อมในการทำงาน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>รูปภาพอุปกรณ์คุ้มครองความปลอดภัยสำหรับบุคคล</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เอกสารหลักฐานการบำรุงรักษาอุปกรณ์คุ้มครองความปลอดภัยส่วนบุคคล</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เอกสารหลักฐานการจัดอบรมผู้ปฏิบัติงานได้รับการฝึกอบรมเกี่ยวกับวิธีการใช้และบำรุงรักษาอุปกรณ์คุ้มครองความปลอดภัยส่วนบุคคล</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>ด้านการป้องกันและระงับอัคคีภัย</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>แผนผังอาคารแสดงระบบน้ำดับเพลิงและอุปกรณ์ประกอบเพื่อใช้ในการดับเพลิง</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เครื่องดับเพลิงแบบเคลื่อนย้ายได้ ประเภท A จำนวน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เครื่องดับเพลิงแบบเคลื่อนย้ายได้ ประเภท B จำนวน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เครื่องดับเพลิงแบบเคลื่อนย้ายได้ ประเภท C จำนวน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>เอกสารหลักฐานการฝึกอบรมการดับเพลิงขั้นต้นแก่ผู้ปฏิบัติงาน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>แผนการฝึกซ้อมดับเพลิงและฝึกซ้อมอพยพหนีไฟ</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>ด้านการจัดสวัสดิการและการตรวจสุขภาพของผู้ปฏิบัติงาน</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>หลักฐานการให้สวัสดิการแก่พนักงาน ลูกจ้างของผู้ประกอบการ</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td>หลักฐานการตรวจสุขภาพผู้ปฏิบัติงาน</td>
                                        <td class="text-center align-middle">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:75%;">
                                            <div class="row mb-2">
                                                <div class="col-md-3 col-sm-4 align-middle">
                                                    จดหมาย
                                                </div>
                                                <div class="col-md-9 col-sm-8">
                                                    <input type="text" class="form-control" name="complaint_mail">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-md-3 col-sm-4 align-middle">
                                                ...
                                                <div class="col-md-9 col-sm-8">
                                                    <input type="text" class="form-control" name="complaint_email">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-md-3 col-sm-4 align-middle">
                                                ...
                                                <div class="col-md-9 col-sm-8">
                                                    <input type="text" class="form-control" name="complaint_system">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3 col-sm-4 align-middle">
                                                ...
                                                <div class="col-md-9 col-sm-8">
                                                    <input type="text" class="form-control" name="complaint_website">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหลักฐานการอนุญาตตามกฎหมายว่าด้วยการควบคุมอาคารที่แสดงว่าอาคารดังกล่าว สามารถใช้ประกอบกิจการตามที่ขออนุญาตได้</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. สำเนาใบอนุญาตตามกฎหมายอื่นที่เกี่ยวข้องในแต่ละประเภทกิจการ เช่น ใบอนุญาตตามพ.ร.บ. โรงงาน พ.ศ. 2535 พ.ร.บ. ควบคุมอาคาร พ.ศ. 2522 พ.ร.บ. โรงแรม พ.ศ. 2547 พ.ร.บ. การเดินเรือในน่านน้ำไทย พ.ศ. 2546</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. ใบรับรองแพทย์และหลักฐานแสดงว่าผ่านการอบรมเรื่องสุขาภิบาลอาหาร (กรณียื่นขออนุญาตกิจการที่เกี่ยวข้องกับอาหาร)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. หลักฐานแสดงว่าผ่านการอบรมเรื่องสุขาภิบาลอาหาร (กรณียื่นขออนุญาตกิจการที่เกี่ยวข้องกับอาหาร)</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">5. หนังสือรับรองนิติบุคคล</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">6. ใบมอบอำนาจ (ในกรณีที่มีการมอบอำนาจ)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">7. หลักฐานที่แสดงการเป็นผู้มีอำนาจลงนามแทนนิติบุคคล</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">8. สำเนาเอกสารสิทธิ์ หรือสัญญาเช่า หรือสิทธิอื่นใด ตามกฎหมายในการใช้ประโยชน์สถานที่ที่ใช้ประกอบกิจการในแต่ละประเภทกิจการ</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">9. สำเนาเอกสารหรือหลักฐานเฉพาะกิจการที่กฎหมายกำหนดให้มีการประเมินผลกระทบ เช่น รายงานการวิเคราะห์ผลกระทบสิ่งแวดล้อม (EIA) รายงานการประเมินผลกระทบต่อสุขภาพ (EHIA)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">10. ผลการตรวจวัดคุณภาพด้านสิ่งแวดล้อม (ในแต่ละประเภทกิจการที่กำหนด)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
