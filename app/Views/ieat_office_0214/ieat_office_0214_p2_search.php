...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>การขออนุญาตติดตั้งปั้นจั่นหอสูง (Tower Crane)</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-214-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-5">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-214-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>การขออนุญาตติดตั้งปั้นจั่นหอสูง (Tower Crane)</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
        ...
        <div class="card-body">
            <div class="tab-content">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width='100%' border='0' align='center' cellpadding='10' cellspacing='1'>
                                    <tr>
                                        <td align='left' valign='top' width='30%'><br /><br /><br />ที่ <input type="text" name="number_doc_pp" value="อก 5103.2.2/" />
                                            <font color="red">กรอกเลข อก.</font>
                                        </td>
                                        <td align='center' width='40%'><img src='https://epp-ieat-dev.nidprotech.com/new_epp_ieat_tester_67/assets/logo_new.png' border='0' /></td>
                                ...
                                <table width='100%' border='0' align='center' cellpadding='10' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td width="94%" height='35' valign='top'>
                                            <input type="text" name="pp_000" value="การติดตั้งปั้นจั่นยกของแบบหอสูง (Tower Crane) ที่ใช้ในการก่อสร้างอาคารฯ" size="80" /></font>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td height='35' valign='top'>
                                            <input type="text" name="pp_001" value="กรรมการผู้จัดการบริษัท บริษัท สมมุติ15 จำกัด" size="80" />
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table width='100%' border='0' align='center' cellpadding='5' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            1. <input type="text" name="pp_002" value="หนังสืออนุญาตใช้ที่ดินและประกอบกิจการล่าสุด เลขที่ TEST015 ลงวันที่ 31-01-2554" size="120" /><br />
                                            2. <input type="text" name="pp_002_1" value="ใบอนุญาตก่อสร้างอาคารฯ เลขที่ _______________________ ลงวันที่ _______________________" size="120" /><br />
                                            3. <input type="text" name="pp_002_1" value="คำขอแจ้งการติดตั้งปั้นจั่นยกของแบบหอสูงฯ เลขที่ 1-15-0-214-00003-2568 ลงวันที่ 25 พฤศจิกายน 2568" size="120" />
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table width='100%' border='0' align='center' cellpadding='7' cellspacing='1'>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 1<br />
                                            <textarea name="pp_004" id="pp_004" cols="120" rows="8">ตามหนังสือที่อ้างถึง 1 บริษัท สมมุติ15 จำกัด ได้รับหนังสืออนุญาตให้ใช้ที่ดินฯล่าสุด เลขที่ TEST015 ออกให้ ณ วันที่ 31-01-2554 ประกอบกิจการ ชุบเคลือบผิวทองแดงและทองเหลืองด้วยความร้อน (Plating, Heat Treatment) ซื้อ-ขายของที่ไม่ได้ใช้แล้วทุกชนิด, ชื้อ-ขาย ผลิตภัณฑ์เงินทุกชนิดทุกประเภท ผลิตภัณฑ์ทองแดงทุกชนิดทุกประเภท ผลิตภัณฑ์สังกะสีทุกชนิดทุกประเภท เหล็กกล้า ทองเหลือง อลูมิเนียม อัลลอย โลหะบริสุทธิ์ ลวดอัลลอย ในนิคมอุตสาหกรรม เกตเวย์ ซิตี้ จังหวัด ฉะเชิงเทรา ในเขตอุตสาหกรรม ประกอบการเสรี แปลงที่ดินเลขที่  พื้นที่ประมาณ 0 ไร่ 0 งาน 0.0 ตารางวา บริษัทฯ มีการขออนุญาตก่อสร้างฯและยื่นคำขอ แจ้งการติดตั้งปั้นจั่นยกของแบบหอสูง (Tower Crane) ตามหนังสือที่อ้างถึง 2 และ 3 ความละเอียดแจ้งแล้วนั้น</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 2<br />
                                            <textarea name="pp_005" id="pp_005" cols="120" rows="8">การนิคมอุตสาหกรรมแห่งประเทศไทย (กนอ.) พิจารณาแล้ว บริษัทฯ สามารถดำเนินการติดตั้ง ปั้นจั่นยกของแบบหอสูง (Tower Crane) ตามชนิด แบบแปลนผังบริเวณ และรายการคำนวณที่ระบุใน คำขอฯได้ ทั้งนี้ บริษัทฯ ต้องปฏิบัติตามกฎหมายที่เกี่ยวข้องและให้คำนึงถึงความปลอดภัย ในการปฏิบัติงานต่อไป</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <span class="font_header_detail"><b>รายละเอียดการติดตั้งที่จะขออนุญาต</b></span>
                            <br /><br />
                            ติดตั้งปั้นจั่นหอสูงเพื่อดำเนินการก่อสร้างคลังสินค้า
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบการ การขออนุญาตติดตั้งปั้นจั่นหอสูง (Tower Crane) ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">5. ผังบริเวณติดตั้งปั้นจั่นหอสูง (Tower Crane)</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">6. รายละเอียดการติดตั้งปั้นจั่นหอสูง (Tower Crane)</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">7. คู่มือการบำรุงรักษา</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">8. เอกสารอื่นๆ ที่เกี่ยวข้อง</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">1. หนังสือรับรองพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม (ผู้ออกแบบ ด้านวิศวกรรม (วิศวกรเครื่องกล))</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">2. หนังสือรับรองพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม (ผู้ควบคุมงาน ด้านวิศวกรรม (วิศวกรเครื่องกล))</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">3. หนังสือรับรองพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม (ผู้ออกแบบ ด้านวิศวกรรม (วิศวกรโยธา))</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">4. หนังสือแสดงความยินยอมพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม (ผู้ควบคุมงาน ด้านวิศวกรรม (วิศวกรโยธา))</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
