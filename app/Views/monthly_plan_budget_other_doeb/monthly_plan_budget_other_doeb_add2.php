...
<div class="class_header_page_02">
    <br />
    ปรับแผนการใช้งบประมาณ (ทั่วไป)
    <hr />
</div>
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="DraftBudgetControlDetail_id" id="DraftBudgetControlDetail_id" value="<?php echo $data['DraftBudgetControlDetail_id']; ?>" />
