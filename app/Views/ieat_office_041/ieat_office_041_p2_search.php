...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_041" style="color: #6007b3ff; font-size: 18px;"><b>คำขอใบรับรองเป็นผู้ประกอบการในเขตประกอบการเสรี (คำขอนำเข้าวัตถุดิบ) IEAT-I-01</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-13-1-41-00001-2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-13-1-41-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>IEAT-I-01</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
        ...
        <div class="card-body">
            <div class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_041/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>เอกสารที่เกี่ยวข้อง</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <div class="card-header">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="30%">
                                            <div class="custom-file">
                                                <span class="font_header_detail"><a href="#">ไฟล์เอกสาร</a></span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header">2. รายการวัตถุดิบ (ไฟล์ PDF ไม่เกิน 5 MB)</td>
                                        <td>
                                            <div class="custom-file">
                                                <span class="font_header_detail"><a href="#">ไฟล์เอกสาร</a></span>
                                            </div>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. เอกสารอื่นๆ เพิ่มเติม(ถ้ามี)</td>
                                        <td>
                                            <div class="custom-file">
                                                <span class="font_header_detail"><a href="#">ไฟล์เอกสาร</a></span>
                                            </div>
