            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="col-lg-12">
                                <span class="font_header"><b>เลือกข้อมูลอาคารที่จะขออนุญาต <font color='red'><b>*</b></font></b></span>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <label><input type="radio" id="construction_type_id_view_1" name="construction_type_id_view" value="1" <?php if ($data_show['construction_type_id_view'] == '1'): echo "checked='checked'";
                                                                                                                                        endif ?> /> ก่อสร้างอาคาร</label>&nbsp;
                                <label><input type="radio" id="construction_type_id_view_2" name="construction_type_id_view" value="2" <?php if ($data_show['construction_type_id_view'] == '2'): echo "checked='checked'";
                                                                                                                                        endif ?> /> ดัดแปลงอาคาร </label>&nbsp;
                                <label><input type="radio" id="construction_type_id_view_3" name="construction_type_id_view" value="3" <?php if ($data_show['construction_type_id_view'] == '3'): echo "checked='checked'";
                                                                                                                                        endif ?> /> รื้อถอนอาคาร </label>&nbsp;
                                <label><input type="radio" id="construction_type_id_view_4" name="construction_type_id_view" value="4" <?php if ($data_show['construction_type_id_view'] == '4'): echo "checked='checked'";
                                                                                                                                        endif ?> /> ก่อสร้างและดัดแปลงอาคาร </label>&nbsp;
                                <label><input type="radio" id="construction_type_id_view_4" name="construction_type_id_view" value="5" <?php if ($data_show['construction_type_id_view'] == '5'): echo "checked='checked'";
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="col-lg-12">
                                <span class="font_header"><b>โดยจะเริ่มต้นก่อสร้างอาคาร / ดัดแปลงอาคาร / รื้อถอนอาคาร เมื่อ</b></span> <input type='text' class='date_plan_build' name='start_plan_build' id='start_plan_build' value='<?php echo $data_show['start_plan_build']; ?>' size='10' readonly onclick="dochange_date_build()">
                                <span class="font_header"><b>และจะแล้วเสร็จ เมื่อ</b></span> <input type='text' class='date_plan_build' name='finish_plan_build' id='finish_plan_build' value='<?php echo $data_show['finish_plan_build']; ?>' size='10' readonly onclick="dochange_date_build()">
                                <span class="font_header"><b>กำหนดแล้วเสร็จใน</b></span> <input type='text' name='total_time_build' id='total_time_build' value='<?php echo $data_show['total_time_build']; ?>' size='5' onclick="dochange_date_build()"> <span class="font_header"><b>วัน</b></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id="datatable02" class="table table-bordered">
                                <tr>
                                    ...
                                    <th class="text-center">พื้นที่ตารางเมตร/พื้นที่ความยาว</th>
                                    <th class="text-center">ค่าธรรมเนียม(บาท/ตร.ม.)/ค่าธรรมเนียม(บาท/ม.)</th>
                                    <th class="text-center">คิดเป็นเงิน</th>
                                </tr>
                                <tr>
                                    <td align="center"><input type="checkbox" name="chk2" value="" /></td>
                                    <td align="center">
                                        <input name="building_total_floor_view[]" type="text" id="building_total_floor_view" size="100" value="" />
                                    </td>
                                    <td align="center">
                                        <input name="sqr[]" type="text" id="sqr[]" size="10" value="" />
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                        <input name="money[]" id="money[]" type="text" size="10" value="" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">10. รายงานการสำรวจดินฐานราก ประกอบด้วย หนังสือรับรองรายงานการสำรวจดินฐานราก, สำเนาหนังสือรับรองจดทะเบียนนิติบุคคลของบริษัท พร้อมสำเนาบัตรประชาชนของกรรมการบริษัทที่ดำเนินการสำรวจดินฐานราก, สำเนาใบประกอบวิชาชีพนิติบุคคลจากสภาวิศวกร ของบริษัทที่ดำเนินการสำรวจดินฐานราก, สำเนาใบประกอบวิชาชีพควบคุมของผู้รับรองรายการสำรวจดินฐานราก</label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">
                                                ...
                                                <a href="1_แบบ_กนอ_น2-2.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">
                                                ...
                                                <a href="2_แบบ_กนอ_น4-3.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                ...
                                                <a href="3_แบบ_กนอ_น2-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                ...
                                                <a href="4_แบบ_กนอ_น4-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                ...
                                                <a href="5_แบบ_กนอ_น2-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                ...
                                                วิศวกรรมควบคุมที่ออกโดยสภาวิศวกร (ผู้ออกแบบ ด้านวิศวกรรม (วิศวกรเครื่องกล))
                                                <a href="6_แบบ_กนอ_น2-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                7. หนังสือรับรองพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม และ หนังสือรับรองการได้รับอนุญาตให้เป็นผู้ประกอบวิชาชีพ
                                                วิศวกรรมควบคุมที่ออกโดยสภาวิศวกร (ผู้ออกแบบ ด้านวิศวกรรม (วิศวกรสิ่งแวดล้อม))
                                                <a href="6_แบบ_กนอ_น2-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                8. หนังสือรับรองพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม และ หนังสือรับรองการได้รับอนุญาตให้เป็นผู้ประกอบวิชาชีพ
                                                วิศวกรรมควบคุมที่ออกโดยสภาวิศวกร (ผู้ออกแบบ ด้านวิศวกรรม (วิศวกรอุตสาหการ))
                                                <a href="6_แบบ_กนอ_น2-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">
                                                9. หนังสือรับรองการให้ข้อมูลและการแจ้งสิทธิในการแสดงความคิดเห็นต่อเจ้าพนักงานท้องถิ่นแก่บุคคลที่อยู่บริเวณข้างเคียงตามมาตรา 39 ทวิ (10)
                                                <a href="yp3.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
