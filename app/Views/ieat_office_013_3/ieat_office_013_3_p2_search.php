...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>กนอ. 01/3 (การรับสิทธิ์การใช้ที่ดินคืน)</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-105-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-105-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>(กนอ. 01/3 การรับสิทธิ์การใช้ที่ดินคืน)</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">รับคืนสิทธิจาก</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <div class="panel-heading">
                            <span class="font_header">แปลงที่ดินและเนื้อที่ที่ประสงค์จะรับคืนสิทธิ</span>
                        </div>
                        <div class="table-responsive div_header p-4">
