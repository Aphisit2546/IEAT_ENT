                ...
                <div class="col-12 col-md-6 col-lg-4" style="min-width: 500px;">
                    <div class="card bg-white mb-5 mt-5 border-0" style="box-shadow: 0 12px 15px rgba(0, 0, 0, 0.02);">
                        <div class="table-responsive div_header p-5" align='center'>
                            ...
                            <button class="btn btn-primary mb-3" onclick="window.location='ieat_office_013_3/final'">
                                ยืนยันรหัส OTP
                            </button>

                            <p class="resend text-muted mb-0">
                                กรณีไม่ได้รับ OTP คลิก <a href="ieat_office_013_3/otp">ขอรับรหัส OTP ใหม่</a>
                            </p>
                        </div>
                    </div>
                </div>
