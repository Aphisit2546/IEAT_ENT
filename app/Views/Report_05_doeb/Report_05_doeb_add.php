...
<div class="class_header_page_02">
    <br />
    ผลการปฏิบัติงานสถาบันพัฒนาเทคนิคพลังงาน
    <hr />
</div>
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td class="align-top text-left">ตรวจขอใบรับรอง</td>
                    ...
                    <td class="align-top text-center">10</td>
                    <td class="align-top text-center">ใบรับรอง</td>
                </tr>
                <tr>
                    <td class="align-top text-left">ตรวจต่ออายุใบอนุญาต (วิทยากร/ผู้ฝึกอบรม/ผู้ทดสอบตรวจสอบ)</td>
                ...
                <tr>
                    <td class="align-top text-left">สอบภาคทฤษฎี</td>
                    <td class="align-top text-center">3</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">3</td>
                    <td class="align-top text-center">ท่าน</td>
                </tr>
                <tr>
                    <td class="align-top text-left">ขอใหม่ (จำนวนบัตร)</td>
                ...
                <tr>
                    <td class="align-top text-left">ต่ออายุ (จำนวนบัตร)</td>
                    <td class="align-top text-center">5</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">5</td>
                    <td class="align-top text-center">ใบ</td>
                ...
                <tr>
                    <td class="align-top text-left">ใบแทน (จำนวนบัตร)</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบ</td>
                ...
                <tr>
                    <td class="align-top text-left">การออกใบรับรองเป็นผู้มีสิทธิจัดทำรายงานเกี่ยวกับสิ่งแวดล้อมระบบการขนส่งก๊าซธรรมชาติ</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบรับรอง</td>
