                    ...
                    <tr class="child-row" data-target="row-<?php echo $seq_row; ?>">
                        ...
                        <?php for ($seq_row = 1; $seq_row <= 12; $seq_row++): ?>
                            <td class="align-top text-center">
                                <input size='3' type='text' name='<?php echo $seq_row; ?>_<?php echo $lstData_mapping_result['variable_name']; ?>' id='<?php echo $seq_row; ?>_<?php echo $lstData_mapping_result['variable_name']; ?>' value='<?php echo $data['month_' . $seq_row][$seq_var]['data_value']; ?>' " onkeyup=" dokeyupMoney(this);" onchange="dokeyupMoney(this);" onkeypress="checknumberMoney()" oninput="updateColumn3(this)" autocomplete="off">
