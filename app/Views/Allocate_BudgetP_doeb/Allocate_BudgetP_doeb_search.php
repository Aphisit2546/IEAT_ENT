...
<div class="class_header_page_02">
    <br />
    จัดสรรงบประมาณส่วนสำนักงานพลังงานจังหวัด
    <hr />
</div>
<div class="row">
    <!--
                                            ...
                                            <td class="align-top text-center">
                                                ...
                                                <?php if ($item["ActiveStatusFinalALL"] == 'Y'): ?>
                                                    ...
                                                    <span class="detail">
                                                        ...
                                                        <?php if ($item["ActiveStatusChangeALL"] == 'Y'): ?>
                                                            <a id="btnEdit" class="btn btn-danger" href="<?= $routeGroup ?>/edt_3/<?= $item["OverAllBudget_id"] ?>"><i class="fas fa-edit"></i> ปรับแผนงบ</a>
                                                        <?php else: ?>
