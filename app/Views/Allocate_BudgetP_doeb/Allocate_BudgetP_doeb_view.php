        ...
        <table class="table table-bordered" id="datatable1">
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" valign="middle"><?php if ($result_data_set1['Budget01'] != '' && $result_data_set1['Budget01'] != null) {
                        ...
                        <td align="right" valign="middle"><?php echo number_format($result_data_set1['BudgetNegative'], 2); ?></td>
                        <td align="right" valign="middle"><?php echo $result_data_set1['BudgetPercentage']; ?></td>
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" valign="middle"><?php if ($result_data_set2['Budget01'] != '' && $result_data_set2['Budget01'] != null) {
                        ...
                        <td align="right" valign="middle"><?php echo number_format($result_data_set2['BudgetNegative'], 2); ?></td>
                        <td align="right" valign="middle"><?php echo $result_data_set2['BudgetPercentage']; ?></td>
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" valign="middle"><?php if ($result_data_set3['Budget01'] != '' && $result_data_set3['Budget01'] != null) {
                        ...
                        <td align="right" valign="middle"><?php echo $result_data_set3['BudgetNegative']; ?></td>
                        <td align="right" valign="middle"><?php echo $result_data_set3['BudgetPercentage']; ?></td>
            ...
            ?>
                    <tr>
                        ...
                        <td align="right" valign="middle"><?php if ($result_data_set4['Budget01'] != '' && $result_data_set4['Budget01'] != null) {
                        ...
                        <td align="right" valign="middle"><?php echo $result_data_set4['BudgetNegative']; ?></td>
                        <td align="right" valign="middle"><?php echo $result_data_set4['BudgetPercentage']; ?></td>
                            ...
                            <tr>
                                <td align="left" valign="middle">
                                    <span class="detail">
                                        ความคิดเห็นเพิ่มเติม
                                        <br />
                                        - <?php echo $data_main['RemarksApprove']; ?>
                                    </span>
                                </td>
                            </tr>
                        </table>
