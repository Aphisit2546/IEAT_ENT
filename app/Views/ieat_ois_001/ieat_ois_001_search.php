...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_001" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.1 (คำสั่งให้แก้ไขเปลี่ยนแปลงแผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลนหรือรายการคำนวณตามมาตรา 27 วรรคหนึ่ง)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_001</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.1 (คำสั่งให้แก้ไขเปลี่ยนแปลงแผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลนหรือรายการคำนวณตามมาตรา 27 วรรคหนึ่ง)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้แก้ไขเปลี่ยนแปลงแผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลน<br>
                                หรือรายการคำนวณตามมาตรา 27 วรรคหนึ่ง
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-2 align-items-center" style="text-indent: 40px;">
                            <div class="col-md-3">ตามคำขอฯ เลขที่</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="address_road">
                            </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">เพื่อทำการ</div>
                            <div class="col-md-10">
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">บ้านเลขที่</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="factory_no">
                            </div>
                            <div class="col-md-1 text-right">หมู่ที่</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="factory_moo">
                            </div>
                            <div class="col-md-1 text-right">ตรอก/ซอย</div>
                            <div class="col-md-4">
                                <input type="text" class="form-control form-control-sm" name="factory_soi">
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">ถนน</div>
                            <div class="col-md-3">
                                <input type="text" class="form-control form-control-sm" name="factory_road">
                            </div>
                            <div class="col-md-1 text-right">ตำบล/แขวง</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="factory_tambon">
                            </div>
                            <div class="col-md-2 text-right">อำเภอ/เขต</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="factory_amphur">
                            </div>
                        </div>
                        <div class="row mb-3 align-items-center">
                            <div class="col-md-2">จังหวัด</div>
                            <div class="col-md-3">
                                <input type="text" class="form-control form-control-sm" name="factory_province">
                            </div>
                            <div class="col-md-2 text-right">รหัสไปรษณีย์</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="factory_postcode">
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-md-10 d-flex align-items-center flex-wrap">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="land_doc[]" value="chanote" checked>
                                    <label class="form-check-label">โฉนดที่ดิน</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="land_doc[]" value="ns3">
                                    <label class="form-check-label">น.ส. 3</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="land_doc[]" value="ns3k">
                                    <label class="form-check-label">น.ส. 3 ก.</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="land_doc[]" value="sk1">
                                    <label class="form-check-label">ส.ค.1</label>
                                </div>
                                <span class="ml-3 mr-2">อื่นๆ</span>
                                <input type="text" class="form-control form-control-sm d-inline-block" style="width:220px;" name="land_doc_other">
                                <span class="ml-3 mr-2">เลขที่</span>
                                <input type="text" class="form-control form-control-sm d-inline-block" style="width:220px;" name="land_doc_no">
                            </div>
                        </div>
                        
                        <div class="row mb-4 align-items-center">
                            <div class="col-md-2">เป็นที่ดินของ</div>
                            <div class="col-md-7">
                                <input type="text" class="form-control form-control-sm" name="land_owner">
                            </div>
                            <div class="col-md-3 text-right font-weight-bold">
                                ซึ่งเจ้าหน้าที่ได้รับคำขอไว้นั้น ปรากฏว่า
                            </div>
                        </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mr-2">
                                    <input type="checkbox" name="detail_1" value="1" checked>
                                </div>
                                <div>
                                    (1) แผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลน หรือรายการคำนวณ ยังไม่ถูกต้อง
                                    และไม่เป็นไปตามกฎกระทรวง ข้อบัญญัติท้องถิ่น หรือประกาศ ซึ่งออกตามความในพระราชบัญญัติควบคุมอาคาร
                                    พ.ศ. 2522 และพระราชบัญญัติการนิคมอุตสาหกรรมแห่งประเทศไทย พ.ศ. 2522 ตามรายการแนบท้ายคำสั่งนี้ *
                                </div>
                            </div>
                            <div class="d-flex mb-2">
                                <div class="mr-2">
                                ...
                                <div>
                                    (2) คำขออนุญาตของท่านที่ได้ยื่นไว้ยังขาดเอกสาร หรือเอกสารไม่ถูกต้อง ตามรายการแนบท้ายคำสั่งนี้ *
                                </div>
                            </div>
                        </div>
                        
                        <div class="mb-4 text-justify" style="text-indent: 40px;">
                            อาศัยอำนาจตามความในมาตรา 27 วรรคหนึ่ง แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522
                            ให้ท่านจัดการแก้ไขเปลี่ยนแปลงแผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลน หรือรายการคำนวณ
                            ให้ถูกต้องและเป็นไปตามกฎกระทรวง ข้อบัญญัติท้องถิ่นหรือประกาศดังกล่าวข้างต้น และให้ท่านไปรับคำขออนุญาตคืน
                            เพื่อจัดการแก้ไขและจัดส่งเอกสารหรือแก้ไขเอกสารตาม (1) หรือ (2) และส่งคืนภายในกำหนด
                            <input type="text" class="form-control form-control-sm d-inline-block text-center" style="width:60px;" name="due_day">
                            วัน (<input type="text" class="form-control form-control-sm d-inline-block text-center" style="width:150px;" name="due_day_text">)
                            วัน ** นับแต่วันที่ท่านได้รับคำสั่งนี้ หากพ้นกำหนดนี้แล้วให้ถือว่าท่านได้เพิกถอนคำขออนุญาตที่ได้ยื่นนั้น
                        </div>
                        
                        <div class="mb-5 text-justify" style="text-indent: 40px;">
                            อนึ่ง ผู้ได้รับคำสั่งจากเจ้าพนักงานท้องถิ่นมีสิทธิอุทธรณ์คำสั่งดังกล่าวต่อคณะกรรมการพิจารณาอุทธรณ์
                            ตามมาตรา 52 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวันนับแต่วันทราบคำสั่ง
                            โดยทำเป็นหนังสือและยื่นต่อเจ้าพนักงานท้องถิ่นผู้ออกคำสั่งนี้
                        </div>
