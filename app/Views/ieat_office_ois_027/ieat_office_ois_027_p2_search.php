...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_office_ois_027/p2</b></a>
</div>
<br />
    ...
    <div class="row row-form mb-3">
        <div class="col-12">
            <span style="color:#000; font-size:25px; font-weight:bold;">
                พิจารณาหนังสือคำสั่ง ค.14 (คำสั่งให้ดำเนินการแก้ไขอุปกรณ์ประกอบต่างๆ ของอาคารตามมาตรา 46 ทวิ วรรคหนึ่ง (2))
            </span>
        </div>
    </div>
