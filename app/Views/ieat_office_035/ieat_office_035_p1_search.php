                ...
                <div class="tab-pane" id="tab2">
                    <div class="table-responsive div_header p-4">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td><!--เลือกความประสงค์--> ความประสงค์ </td>
                                    <td>
                                        <?php
                                        if ($datashow['type_extend'] == '1'):
                                            $checked1 = "checked";
                                        endif;
                                        if ($datashow['type_extend'] == '2'):
                                            $checked2 = "checked";
                                        endif;
                                        ?>
                                        ขยายระยะเวลาการแจ้งเริ่มประกอบกิจการ
                                        <input type="hidden" name="type_extend" value="2">
                                    </td>
                                </tr>
                                <tr>
                                    <td>ระบุวันที่ขอบเขตการขยาย</td>
                                    <td>31/01/2569</td>
                                </tr>
                                <tr>
                                    <td>ระบุรายละเอียดการขอขยาย</td>
                                    <td>เนื่องจากเครื่องจักรมีปัญหา ทำให้เปิดส่วนผลิตได้ช้า จึงขอขยายระยะเวลาการแจ้งเริ่มประกอบกิจการ</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
