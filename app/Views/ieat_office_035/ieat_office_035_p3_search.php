...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>คำขอขยายระยะเวลาการแจ้งเริ่มประกอบกิจการ</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-305-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-5">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-305-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>คำขอขยายระยะเวลาการแจ้งเริ่มประกอบกิจการ</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/035.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_035/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="datatable01" class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="land_acquisition_type_id_view[]">
                                                <option value="1">-- เลือก --</option>
                                            </select>
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="land_acquisition_from_view[]" id="land_acquisition_from_view" value="<?php echo $land_acquisition_from_view; ?>" />
                                        </td>
                                        <td>
                                            <select class="form-control" name="land_type_view[]">
                                                <option value="1">-- เลือก --</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control" name="land_transfer_type_id_view[]">
                                                <option value="1">-- เลือก --</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control" name="land_submit_type_id_view[]">
                                                <option value="1">-- เลือก --</option>
                                            </select>
                                        </td>
                                        <td>
                                            <input class="form-control" type="text" name="land_remarks_view[]" id="land_remarks_view" value="<?php echo $land_remarks_view; ?>" />
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="container div_header p-4">
                            <div class="col-lg-10 col-lg-offset-1">
                                ...
                                <div class="row" style="margin-top: 15px">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" id="operation_type_view" name="operation_type_view" rows="3" style="width: 100%"><?php echo $datashow['operation_type_view']; ?></textarea>
                                    </div>
                                </div>
                                <br />
                            </div>
