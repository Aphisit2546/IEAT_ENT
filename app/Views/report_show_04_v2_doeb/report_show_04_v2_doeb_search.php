...
<div class="class_header_page_02">
    <br />
    รายงานสรุปคำของบประมาณประจำปี แยกตามประเภทรายจ่ายตามงบประมาณ หรือหมวดหมู่ของงบประมาณ และแหล่งงบประมาณ
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="8" class="align-middle text-left">รายงานสรุปคำของบประมาณประจำปี แยกตามประเภทรายจ่ายตามงบประมาณ หรือหมวดหมู่ของงบประมาณ และแหล่งงบประมาณ</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center" width="5%">ลำดับ</th>
                                <th class="align-middle text-center">ชื่อแผน</th>
                                <th class="align-middle text-center">ปีที่ดำเนินการ</th>
                                <th class="align-middle text-center">หน่วยงาน</th>
                                <th class="align-middle text-center">งบลงทุน (บาท)</th>
                                <th class="align-middle text-center">งบดำเนินการ (บาท)</th>
                                <th class="align-middle text-center">งบรายจ่ายอื่นๆ (บาท)</th>
                                <th class="align-middle text-center">รวมงบประมาณ (บาท)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="align-middle">
                                <td class="align-middle text-center" width="5%">1.</td>
                                <td class="align-middle text-center">แผนปฏิบัติราชการประจำปี 2569 ของ กธก.</td>
                                <td class="align-middle text-center">2569</td>
                                <td class="align-middle text-center">กธก.</td>
                                <td class="align-middle text-right">5,000,000.00</td>
                                <td class="align-middle text-right">8,000,000.00</td>
                                <td class="align-middle text-right">12,000,000.00</td>
                                <td class="align-middle text-right">25,000,000.00</td>
                            </tr>
                            <tr class="align-middle">
                                <td class="align-middle text-center" width="5%">2.</td>
                                <td class="align-middle text-center">แผนปฏิบัติราชการประจำปี 2569 ของ สลก.</td>
                                <td class="align-middle text-center">2569</td>
                                <td class="align-middle text-center">สลก.</td>
                                <td class="align-middle text-right">8,000,000.00</td>
                                <td class="align-middle text-right">9,000,000.00</td>
                                <td class="align-middle text-right">7,000,000.00</td>
                                <td class="align-middle text-right">24,000,000.00</td>
                            </tr>
                            <?php
                            $rowIndx = 1;
                            if (!empty($lstData)) {
