...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_016" style="color: #6007b3ff; font-size: 18px;"><b>พิจารณาหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น ให้กลับคืนสู่สภาพเดิมตามมาตรา 45)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_016</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>พิจารณาหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น ให้กลับคืนสู่สภาพเดิมตามมาตรา 45)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        <div class="card-header p-4" style="text-align: center;">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#tab2" data-toggle="tab"><span class="font_header_detail"><b>พิจารณาอนุมัติอนุญาต</b></span></a></li>
            </ul>
        </div><!-- /.card-header -->
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="table-responsive div_header p-4" style="border: 2px dashed #6007b3ff; position: relative;">
                        <div>
							<br />
							<embed src="https://epp-ieat-dev.nidprotech.com/new_epp_ieat_tester_67/gen_pdf/02_K8/202512/test_1764751247.pdf" width="100%" height="1200px" />
							<br />
						</div>
						<hr />
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <input class='btn btn-success btn-lg btn-block' name="Submit_continue" type="button" id="Submit" value="ตีกลับเอกสาร" onclick="return confirm('ตีกลับเอกสาร !!!')" onclick="window.location='center_ieat_ent/page_office'" />
                                </div>
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาผู้อนุมัติอนุญาต" onclick="return confirm('พิจารณาผู้อนุมัติอนุญาต !!!')" onclick="window.location='center_ieat_ent/page_office'" />
                                </div>
                            </div>
                        </div>
                    </div>
