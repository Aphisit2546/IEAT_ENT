...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="OverAllPlan_id" id="OverAllPlan_id" value="<?php echo $data['OverAllPlan_id']; ?>" readonly />
        <?= csrf_field() ?>
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-6">
                        ประเภทแผน
                        <?php echo form_dropdown('TypePlan', $dropdown_master_plan, $data["TypePlan"], "class='form form-control' "); ?>
                    </div>
                    <div class="col-3">
                        ช่วงเวลาของแผนจาก
                        <input style="background-color:white;" data-provide="datepicker" data-date-language="th-th" type="text" class='form-control' name="StartPlan" id="StartPlan" value="<?php echo $data['StartPlan']; ?>" readonly />
                    </div>
                    <div class="col-3">
                        ถึง
                        <input style="background-color:white;" data-provide="datepicker" data-date-language="th-th" type="text" class='form-control' name="FinishPlan" id="FinishPlan" value="<?php echo $data['FinishPlan']; ?>" readonly />
                    </div>
                </div>
            </div>
        </div>
