...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_029" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.15 (คำสั่งห้ามใช้อาคารตามมาตรา 46 ทวิ วรรคสอง)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_029</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.15 (คำสั่งห้ามใช้อาคารตามมาตรา 46 ทวิ วรรคสอง)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งห้ามใช้อาคารตามมาตรา 46 ทวิ วรรคสอง
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                         ...
                         <div class="row mb-2 align-items-center" style="text-indent: 40px;">
                            <div class="col-md-3">ตามที่เจ้าพนักงานท้องถิ่นได้มีคำสั่งเลขที่</div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="address_road">
                            </div>
                            <div class="col-md-1 text-right">เมื่อวันที่</div>
                            <div class="col-md-1">
                                <input type="text" class="form-control form-control-sm" name="address_tambon">
                            </div>
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ตามมาตรา 46 ทวิ วรรคหนึ่ง (1) และ (2) แห่งพระราชบัญญัติควบคุม อาคาร พ.ศ. 2522 
                                ห้ามมิให้ท่านใช้หรือยินยอมให้บุคคลใดใช้อุปกรณ์ประกอบต่าง ๆ ของอาคาร ดำเนินการแก้ไขอุปกรณ์ประกอบต่าง ๆ 
                                ของอาคารให้อยู่ในสภาพที่ปลอดภัยหรือสามารถใช้งานได้ภายใน ระยะเวลาที่กำหนด ปรากฏว่าท่านมิได้ปฏิบัติตามคำสั่งดังกล่าว 
                                และอุปกรณ์ดังกล่าวมีผลทำให้อาคารนั้น มีสภาพหรือมีการใช้ที่อาจเป็นอันตรายอย่างร้ายแรงต่อสุขภาพ ชีวิต ร่างกาย หรือทรัพย์สิน
                            </div>
                        </div>
                        
                        <div class="pl-4 mb-4">
                            <div class="mb-2 text-justify" style="text-indent: 40px;">
                                อาศัยอำนาจตามความในมาตรา 46 ทวิ วรรคสอง แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 
                                ห้ามมิให้ท่านและบุคคลใดใช้หรือเข้าไปในส่วนใด ๆ ของอาคารหรือบริเวณที่มีการกระทำดังนี้ *
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                	อนึ่ง ผู้ได้รับคำสั่งจากเจ้าพนักงานท้องถิ่นมีสิทธิอุทธรณ์คำสั่งดังกล่าวต่อคณะกรรมการ พิจารณาอุทธรณ์ 
                                    ตามมาตรา 52 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวันนับแต่ วันทราบคำสั่ง 
