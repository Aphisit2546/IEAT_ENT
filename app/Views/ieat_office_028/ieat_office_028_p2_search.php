            ...
            <div class="tab-content">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
                                        ...
                                        <td align="center">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="30%" align="right" valign='top'>แบบ อ.2</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center"><b>ใบอนุญาตเปลี่ยนการใช้อาคาร</b></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="18%" align="left" valign="top"><span class="head_detail">&nbsp;xxxx/2568 <input type="hidden" name="d006" id="d006" value="2-31-1-208-00002-2568">
                                                            <input type="hidden" name="doc_run_number" id="doc_run_number" value="0014/2568">
                                                        </span></td>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="80%" align="left" valign="top">เปลี่ยนการใช้อาคาร</td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="left" valign="top">&nbsp;</td>
                                                    <td align="left" valign="middle">อาคารทดสอบการยื่น ขร.1 ขร.2 ต่ออายุ</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width='30%' valign="top" align="left">นิคมอุตสาหกรรม&nbsp;&nbsp;&nbsp;อาหารฮาลาล จังหวัดปัตตานี</td>
                                                    <td width='30%' valign="top" align="left">ในเขต&nbsp;&nbsp;&nbsp;อุตสาหกรรมทั่วไป</td>
                                                    <td width='40%' valign="top" align="left">แปลงที่ดินเลขที่&nbsp;&nbsp;&nbsp;TEST001 , TEST001</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="20%" align="left" valign="top">หมู่ที่&nbsp;&nbsp;<input type="text" name="ad_002" id="ad_002" value="9" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ตรอก/ซอย&nbsp;&nbsp;<input type="text" name="ad_003" id="ad_003" value="-" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">ถนน&nbsp;&nbsp;<input type="text" name="ad_004" id="ad_004" value="คลอง" size='20'>&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="25%" align="left" valign="top">ตำบล/แขวง&nbsp;&nbsp;&nbsp;คลองตัน </td>
                                                    <td width="25%" align="left" valign="top">อำเภอ/เขต&nbsp;&nbsp;&nbsp;คลองเตย </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width='50%' valign="top" align="left">ในที่ดินโฉนดที่ดินเลขที่&nbsp;&nbsp;&nbsp;<input size="40" type="text" name="title_deed" value="ทดสอบ 44444" /></td>
                                                    <td width='50%' valign="top" align="left">เป็นที่ดินของ&nbsp;&nbsp;&nbsp;<input size="60" type="text" name="owner_land" value="ทดสอบ 55555" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="left" valign="top">&nbsp;</td>
                                                    <td width="90%" align="left" valign="top">จากที่ได้รับอนุญาตไว้เดิม เพื่อใช้เป็นอาคารประเภทควบคุมการใช้ ดังนี้</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="90%" align="left" valign="top">
                                                        <input class="form form-control" type="text" name="d007[]" value="ทดสอบ 1" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="ทดสอบ 2" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="ทดสอบ 3" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="ทดสอบ 4" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="ทดสอบ 5" size='130' maxlength='130' />
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <td align="left" valign="middle">
                                                        ...
                                                        <table class='table'>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="middle">
                                                                    <span class="detail">
                                                                        <input class="form form-control" name="dc001[]" type="text" id="dc001[]" size="150" value="" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </table>
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="25%" align="right" valign='top'>แบบ อ.2</td>
                                    </tr>
                                </table>
                                <br />
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail">แบบ อ.2 เลขที่ xxxx/2568 วันที่ </span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="card-header">
                                <span class="font_header">วัตถุประสงค์ในการเปลี่ยนการใช้อาคาร</span>
                            </div>
                            <br />
                            <div class="row row-form">
                                <div class="col-lg-12">
                                    เพื่อสอดคล้องกับทางนโยบายบริษัท
                                </div>
                            </div>
                        </div>
                    </div>
