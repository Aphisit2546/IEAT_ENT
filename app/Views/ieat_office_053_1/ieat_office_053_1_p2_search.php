...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_1" style="color: #6007b3ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขอแจ้งยกเลิกสิทธิการอยู่ในราชอาณาจักรของครอบครัว)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-1-56-00001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-1-56-00001/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขอแจ้งยกเลิกสิทธิการอยู่ในราชอาณาจักรของครอบครัว)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>เลือกรายการช่างฝีมือ ผู้ชำนาญการ</b></span>
                        </div>
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        ...
                                        <th style="vertical-align:top;" h>ตำแหน่ง</th>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหนังสือการเดินทางของคู่สมรสและหรือบุคคลซึ่งอยู่ในอุปการะ (หน้าแรก, หน้าวีซ่า non-o, หน้าที่ประทับตราอนุญาตตามหนังสือ กนอ. หน้าประทับตราขาเข้าด่าน ตม. ครั้งล่าสุด, หน้าบัตร TM.6)</td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. หนังสือมอบอำนาจ พร้อมติดอากรตามกฎหมาย (ถ้ามี)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. เอกสารอื่น (ถ้ามี)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
