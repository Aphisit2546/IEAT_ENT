                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th class="align-middle text-center">ชื่อแผนย่อย</th>
                                <th class="align-middle text-center">ชื่อเป้าหมาย</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-left"><?= $item["StrategyRelateDetailName"]; ?></td>
                                        <td class="align-top text-left"><?= $item["StrategyTarGetDetailName"]; ?></td>
                                        ...
                                        <td class="align-top text-center">
                                            <?php if ($item["ActiveStatus"] == 'Y'): ?>
                                                ...
                                                <br />
                                                <span class="detail">
                                                    <a id="btnView" class="btn btn-primary" onclick="window.open('<?= $routeGroup ?>/view/<?= $item["StrategyIndicator_id"] ?>', '_blank', 'width=1050,height=550,scrollbars=1');">ดูรายละเอียดข้อมูล</a>
                                                </span>
                                            <?php else: ?>
                                                <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["StrategyIndicator_id"] ?>"><i class="fas fa-edit"></i> ปรับปรุงข้อมูล</a>
                                                <a id="btnDel" class="btn btn-danger" href="<?= $routeGroup ?>/del/<?= $item["StrategyIndicator_id"] ?>"><i class="fas fa-edit"></i> ลบ</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php
