...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="StrategyIndicator_id" id="StrategyIndicator_id" value="<?php echo $data['StrategyIndicator_id']; ?>" readonly />
        <?= csrf_field() ?>
        ...
        <?php if (empty($data['StrategyIndicator_id'])): ?>
            <div class="row text-left">
                <div class="col-md-12">
                    <div class="form-group row">
                        <div class="col-12">
            ...
            <div class="row text-left">
                <div class="col-md-12">
                    <div class="form-group row">
                        <div class="col-12">
                            เลือกเป้าหมาย
                            <?php echo form_dropdown('StrategyTarGetDetail_id', $dropdown_StrategyTarGet_default, $data["StrategyTarGetDetail_id"], "class='form form-control' id='StrategyTarGetDetail_id' "); ?>
                        </div>
                    </div>
                </div>
            </div>
