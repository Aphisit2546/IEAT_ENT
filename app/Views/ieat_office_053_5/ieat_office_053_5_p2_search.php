...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_5" style="color: #6007b3ff; font-size: 18px;"><b>คำขอรับการตรวจลงตราประเภทคนอยู่ชั่วคราว</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-2-61-01081/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-2-61-01081/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอรับการตรวจลงตราประเภทคนอยู่ชั่วคราว</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>เลือกรายการ</b></span>
                        </div>
                        ...
                        <div class="div_header p-4">
                            <div class="table-responsive" style="overflow-x:auto;">
                                <table class="table table-bordered" style="min-width:1800px;">
                                    <thead>
                                        <tr style="color:#000;">
                                            <th style="width:8%; text-align:center; vertical-align:top;">ตำแหน่ง</th>
                                            ...
                                            <th style="width:8%; text-align:center; vertical-align:top;">
                                                สัญชาติ
                                            </th>
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>สถานที่ขอรับการตรวจลงตรา</b></span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                            <td>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหนังสือเดินทางของช่างฝีมือ ผู้ชำนาญการ (หน้าแรก และต้องมีอายุไม่น้อยกว่า 8 เดือน นับแต่วันที่ส่งคำขอให้ กนอ.)</td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. สำเนาคุณวุฒิการศึกษา</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. สำเนาใบผ่านงาน</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. ผังองค์กร (แสดงชื่อตำแหน่ง/ชื่อช่างฝีมือ ที่ได้รับอนุญาตจาก กนอ.แล้ว และที่อยู่ระหว่างการยื่นคำขออนุญาต)</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. หนังสือมอบอำนาจ พร้อมติดอากรตามกฎหมาย (ถ้ามี)</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
