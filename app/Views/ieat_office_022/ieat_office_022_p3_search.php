            ...
            <div class="tab-content">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/022.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                    ...
                                    <table class="table table-lg">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail">200.00</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail">2,000.00</span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail">220.00</span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail">2,620.00</span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_022/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="col-lg-12">
                                <span class="font_header"><b>โดยจะเริ่มต้นก่อสร้างอาคาร / ดัดแปลงอาคาร / รื้อถอนอาคาร เมื่อ</b></span> <span class="font_header_detail_red">31/12/2568</span>
                                <span class="font_header"><b>และจะแล้วเสร็จ เมื่อ</b></span> <span class="font_header_detail_red">31/03/2569</span>
                                <span class="font_header"><b>กำหนดแล้วเสร็จใน</b></span> <span class="font_header_detail_red">90</span> <b>วัน</b></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive div_header p-4">
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id="datatable02" class="table">
                                <tr>
                                    ...
                                    <th class="text-center"><span class="font_header_detail">พื้นที่ตารางเมตร/พื้นที่ความยาว</span></th>
                                    <th class="text-center"><span class="font_header_detail">ค่าธรรมเนียม(บาท/ตร.ม.)/ค่าธรรมเนียม(บาท/ม.)</span></th>
                                    <th class="text-center"><span class="font_header_detail">คิดเป็นเงิน(บาท)</span></th>
                                </tr>
                                <tr>
                                    <td align="center">
                                        ค.ส.ล 2 ชั้น
