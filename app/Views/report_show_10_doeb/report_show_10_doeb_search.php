...
<div class="class_header_page_02">
    <br />
    รายงานผลการพิจารณา รายงานทางด้านสิ่งแวดล้อม (ER/MR)
    <hr />
</div>
<div class="row">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        ค้นหาชื่อผู้ประกอบการหรือผู้จัดทำรายงาน
                        <input type="text" class='form-control' name="FinishYearPlan" id="FinishYearPlan" value="<?php echo $data['FinishYearPlan']; ?>" autocomplete="off" />
                    </div>
                    <div class="col-3">
                        <br />
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="6" class="align-middle text-left">รายงานผลการพิจารณา รายงานทางด้านสิ่งแวดล้อม (ER/MR)</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center" width="5%">ลำดับ</th>
                                <th class="align-middle text-center">ประเภทคำขอ</th>
                                <th class="align-middle text-center">ชื่อโครงการ</th>
                                <th class="align-middle text-center">จังหวัด</th>
                                <th class="align-middle text-center">โครงการ EIA ที่เกี่ยวข้อง</th>
                                <th class="align-middle text-center">ผู้ประกอบการ</th>
                                <th class="align-middle text-center">ผู้จัดทำรายงาน</th>
                                <th class="align-middle text-center">วันที่ส่งคำขอ</th>
                                <th class="align-middle text-center">สถานะคำขอปัจจุบัน</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
