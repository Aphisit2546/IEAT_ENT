...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>ขร.2</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-204-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-204-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>ขร.2</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                ...
                <div class="tab-pane" id="tab9">
                    <div class="row row-form">
                        ...
                        <div class="table-responsive div_header p-4">
                            <div style="border: solid 3px #009933; width:100%">
                                <table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
                                            ...
                                            <table width='100%' border='0' cellspacing='0' cellpadding='5' align='center'>
                                                <tr>
                                                    <td width='30%' align='left' valign='top'>
                                                        เลขที่&nbsp;&nbsp;xxxx/2568 </td>
                                                    <td width='40%' align='center' valign='middle'><img src='https://epp-ieat.ieat.go.th/new_epp_ieat/assets/logo_new.png' border='0' /></td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <font style='font-size:22px;'>ใบรับรองการตรวจสอบอาคาร</font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center">
                                            <font style='font-size:18px;'>ใบรับรองฉบับนี้ออกให้เพื่อแสดงว่า</font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">อาคาร&nbsp;&nbsp;</td>
                                                    <td width="90%" align="left" valign="top">
                                                        <input type="text" name="d007[]" value="ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นโรงงานและสำนักงาน (อาคาร B 2.9),ทดสอบ" size='150' maxlength='200' />
                                                        <br /> <input type="text" name="d007[]" value="" size='150' maxlength='200' />
                                                        <br />
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="30%" align="left" valign="top">
                                                        <input type='radio' name='ad_check' value='2'> ตรวจสอบใหญ่
                                                        <input type='radio' name='ad_check' value='1' checked> ตรวจสอบประจำปี ปีที่ <input size='5' type='text' name='ad_check_1' value='2'>
                                                    </td>
                                                    <td width="30%" align="left" valign="top">นิคมอุตสาหกรรม&nbsp;&nbsp;อาหารฮาลาล จังหวัดปัตตานี&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">แปลงที่ดิน&nbsp;&nbsp;TEST001 , TEST001&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ตั้งอยู่เลขที่&nbsp;&nbsp;<input type='text' name='ad_001' value='99999,123'>&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">หมู่ที่&nbsp;&nbsp;<input type='text' name='ad_004' value='99'>&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ตรอก/ซอย&nbsp;&nbsp;<input type='text' name='ad_002' value='-'>&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">&nbsp;</td>
                                                    <td width='30%' align='left'>ถนน&nbsp;&nbsp;&nbsp;<input type='text' name='ad_003' value='-'></td>
                                                    <td width='60%' align='left'>ตำบล/แขวง&nbsp;&nbsp;&nbsp;ตาสิทธิ์ </td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">อำเภอ/เขต&nbsp;&nbsp;ปลวกแดง &nbsp;&nbsp;</td>
                                                    <td width="50%" align="left" valign="top">จังหวัด&nbsp;&nbsp;ระยอง &nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">&nbsp;</td>
                                                    <td width="90%" align="left" valign="top">
                                                        ได้ผ่านการตรวจสอบอาคาร ตามพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 แล้ว
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="80%" align="left" valign="top">
                                                        เจ้าพนักงานท้องถิ่นได้พิจารณาผลการตรวจสอบอาคาร
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="right" valign="top">&nbsp;</td>
                                                    <td width="90%" align="left" valign="top">
                                                        ซึ่งทำการตรวจสอบโดยผู้ตรวจสอบชื่อ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ทดสอบ&nbsp;เลขทะเบียน&nbsp;น.9999999999 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;แล้ว
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="75%" align="left" valign="top">
                                                        เห็นว่าอาคารนี้ มีสภาพปลอดภัยในการใช้งาน
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td align='left'>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td height="40" align="right" valign="top">ออกให้ ณ วันที่</td>
                                                    <td colspan="2" valign="top">
                                                        <!-- <input readonly type="text" size="10" id="datepicker-th-3" name="d009" value="" /> -->
                                                        &nbsp;&nbsp;<span class="head_detail">
                                                            <font color='red'>** จะแสดงวันที่ปัจจุบันในส่วนของผู้พิจารณาอนุมัติ</font>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <div class="col-6" align="center">
                                <div class="table-responsive div_header p-4">
                                    ...
                                    <table class="table table-lg">
                                        <tbody>
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">เอกสารประกอบการขอรับใบรับรองการตรวจสอบอาคารตามมาตรา 32 ทวิ (ขร.2)</span></td>
                                            ...
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">รายงานการตรวจรับอาคาร (ทั้งฉบับ)</span></td>
                                                <td class="table-detail-left col-lg-6">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile">
                                                        <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="row row-form">
                                <div class="col-lg-6">
                                    <span class="font_header_detail"><b>เลือกข้อมูลอาคารที่จะขอรับรอง <font color='red'><b>*</b></font></b></span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label><input checked type="radio" id="construction_type_id_view_1" name="construction_type_id" value="1" <?php if ($datashow['construction_type_id'] == '1'): echo "checked='checked'";
                                                                                                                                                endif ?> /> <span class="font_header_detail"><b>ตรวจสอบประจำปี</b></span></label>&nbsp;
                                    <label><input disabled type="radio" id="construction_type_id_view_2" name="construction_type_id" value="2" <?php if ($datashow['construction_type_id'] == '2'): echo "checked='checked'";
                                                                                                                                                endif ?> /> <span class="font_header_detail"><b>ตรวจสอบใหญ่</b></span></label>&nbsp;
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>ผู้ตรวจสอบอาคาร</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id="datatable03" name='datatable03' class="table">
                                ...
                                <tr>
                                    ...
                                    <td align='center'><span class="detail">ก่อสร้าง</span></td>
                                    <td align='center'><span class="detail">อาคาร04</span></td>
                                    <td align='center'><span class="detail">สามัญ</span></td>
                                    <td align='center'><span class="detail">โยธา</span></td>
                                    <td align='center'><span class="detail">สย.99999</span></td>
                                    <td align='center'><span class="detail">13/09/2027</span></td>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบการ การขอใบรับรองการตรวจสอบอาคารตามมาตรา 32 ทวิ (ขร.2) ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">3. หนังสือรับรองของผู้ตรวจสอบอาคารตามมาตรา 32 ทวิ</label>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="col-lg-12" style="padding-left: 20px">3.1 กรณีบุคคลธรรมดา ได้แก่ หนังสือรับรองของผู้ตรวจสอบอาคารตามมาตรา 32 ทวิ / สำเนาใบประกอบวิชาชีพ / สำเนาการขึ้นทะเบียนเป็นผู้ตรวจสอบอาคาร</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12" style="padding-left: 20px">3.2 กรณีนิติบุคคล ได้แก่ หนังสือรับรองของผู้ตรวจสอบอาคารตามมาตรา 32 ทวิ / สำเนาหนังสือจดทะเบียนนิติบุคคล ไม่เกิน 6 เดือนของผู้ตรวจสอบอาคาร / สำเนาบัตรประชาชนของผู้มีอำนาจลงลายมือชื่อ นิติบุคคล / สำเนาใบประกอบวิชาชีพนิติบุคคล / สำเนาการขึ้นทะเบียนเป็นผู้ตรวจสอบอาคารนิติบุคคล</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">4. สำเนาใบรับรองการตรวจสอบอาคารเดิม (แบบ ร.๑) <font color='red'>**ถ้ามี**</font></label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">5. รายงานการตรวจสอบอาคาร (ทั้งฉบับ)</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">6. สรุปความเห็นของผู้ตรวจสอบอาคาร</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
