        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <input type="text" name="data_search1" id="data_search1" class="form form-control" value="<?php echo $data_search1; ?>">
                    </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <button type="button" class="btn btn-secondary" name='reset_value' value="reset" onclick="clearInput()"><i class="fas fa-reply"></i> ล้างข้อมูล</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th class="align-middle text-center" width="20%">ชื่อแผนงบประมาณ</th>
                                <th class="align-middle text-center">ประเภทแผน</th>
                                <th class="align-middle text-center">ช่วงเวลา</th>
                                <th class="align-middle text-center">จำนวนยุทธศาสตร์ที่เกี่ยวข้อง</th>
                                <th class="align-middle text-center">จำนวนนโยบายที่เกี่ยวข้อง</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-left"><?= $item["TypePlan"]; ?></td>
                                        <td class="align-top text-center"><?= $item["StartPlan"]; ?> ถึง <?= $item["FinishPlan"]; ?></td>
                                        <td class="align-top text-center"><?= $item["CountRelatedStrategies"]; ?></td>
                                        <td class="align-top text-center"><?= $item["CountRelatedPolicies"]; ?></td>
                                        ...
                                        <td class="align-top text-center">
                                            <?php if ($item["ActiveStatus"] == 'Y'): ?>
                                                ...
                                                <br />
                                                <span class="detail">
                                                    <a id="btnView" class="btn btn-primary" onclick="window.open('<?= $routeGroup ?>/view/<?= $item["OverAllBudget_id"] ?>', '_blank', 'width=1050,height=550,scrollbars=1');">ดูรายละเอียดข้อมูล</a>
                                                </span>
                                            <?php else: ?>
                                                <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["OverAllBudget_id"] ?>"><i class="fas fa-edit"></i> ปรับปรุงข้อมูล</a>
                                                <a id="btnDel" class="btn btn-danger" href="<?= $routeGroup ?>/del/<?= $item["OverAllBudget_id"] ?>"><i class="fas fa-edit"></i> ลบ</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php
                                ...
                                ?>
                                <tr>
                                    <td colspan="9" class="align-top text-center">
