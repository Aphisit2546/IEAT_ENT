...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>1-1-64-00001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-1-64-00001/2568</b></font>
    &nbsp;&nbsp;
    <br />
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        <th style="vertical-align:top;">เลือก</th>
                                        ...
                                        <th style="vertical-align:top;">วัน/เดือน/ปีเกิด</th>
                                        <th style="vertical-align:top;">อนุญาตสิ้นสุดวันที่</th>
                                        <th style="vertical-align:top;">หมายเหตุเพิ่มเติม<br>ก่อนต่ออายุ</th>
                                        <th style="vertical-align:top;">เลขที่หนังสือเดินทาง</th>
                                        <th style="vertical-align:top;">วันที่ยกเลิกสิทธิการอยู่<br>(dd/mm/YYYY)<br>**Ex. 01/01/1900</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. เอกสารอื่นที่เกี่ยวข้อง</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
