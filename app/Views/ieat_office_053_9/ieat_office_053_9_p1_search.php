                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        <th>คำนำหน้า</th>
                                        <th>ชื่อ–ชื่อรอง–ชื่อสกุล บุคคลต่างด้าว</th>
                                ...
                                <tbody>
                                    <tr style="text-align:center;">
                                        ...
                                        <td>ม.6</td>
                                        <td>หัวหน้าช่าง</td>
                                        <td>ควบคุม บำรุงรักษา และปรับปรุง</td>
                                        <td>30/11/2027</td>
                                        <td>ไม่มี</td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        ...
                                        <th>ความสัมพันธ์</th>
                                        <th>คำนำหน้า</th>
                                        <th>ชื่อ–ชื่อรอง–ชื่อสกุล</th>
                                        <th>เลขที่หนังสือเดินทาง</th>
                                        <th>วันที่หนังสือเดินทางหมดอายุ</th>
                                        <th>สัญชาติ</th>
                                        <th>วัน/เดือน/ปีเกิด</th>
                                        <th>อนุญาตสิ้นสุดวันที่</th>
                                        <th>หมายเหตุเพิ่มเติมก่อนต่ออายุ</th>
                                        <th>เลขที่หนังสือเดินทาง</th>
                                        <th>วันที่ยกเลิกสิทธิการอยู่</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
