...
<div class="class_header_page_02">
    <br />
    ผลการปฏิบัติงานภารกิจด้านการค้าและการสำรอง
    <hr />
</div>
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td class="align-top text-left">อนุญาต/จดทะเบียน/รับแจ้ง/เปลี่ยนแปลง/แจ้งเลิก</td>
                ...
                <tr>
                    <td class="align-top text-left">รับชำระค่าธรรมเนียมรายปี</td>
                ...
                <tr>
                    <td class="align-top text-left">เห็นชอบ/ออกหนังสือรับรองการส่งออก(ฉบับ)</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบ</td>
                </tr>
                <tr>
                    <td class="align-top text-left">เห็นชอบ/ออกหนังสือรับรอง/รับแจ้งการนำเข้า(ฉบับ)</td>
                ...
                <tr>
                    <td class="align-top text-left">ประมวลผลข้อมูล (นพ.201-209) และ ธพ.ธ 213-217 ข้อมูลสถิติ ผลิต นำเข้า จำหน่าย ส่งออก</td>
                ...
                <tr>
                    <td class="align-top text-left">แผนการค้า (นพ.211-212) แผนการค้าล่วงหน้า 3 เดือน</td>
                    <td class="align-top text-center">5</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">5</td>
                    <td class="align-top text-center">แผน</td>
                </tr>
                <tr>
                    <td class="align-top text-left">ตรวจสอบการค้างชำระค่าธรรมเนียมรายปี</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบอนุญาต</td>
                ...
                <tr>
                    <td class="align-top text-left">ตรวจสอบการปฏิบัติงานตามนโยบาย (ข้อมูล B100)</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">รายงาน</td>
                ...
                <tr>
                    <td class="align-top text-left">เห็นชอบปริมาณการค้าประจำปี/เก็บน้ำมันแทนกัน</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบ</td>
                ...
                <tr>
                    <td class="align-top text-left">เห็นชอบสถานที่เก็บสำรอง</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ใบ</td>
                ...
                <tr>
                    <td class="align-top text-left">ออกตรวจวัดสำรอง/ออกตรวจสถานที่เก็บ(ใหม่)</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ครั้ง</td>
                </tr>
                <tr>
                    <td class="align-top text-left">ตรวจสอบรายงานปริมาณน้ำมันเชื้อเพลิงคงเหลือ ผ่านระบบ stockpile</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">รายงาน</td>
                ...
                <tr>
                    <td class="align-top text-left">กำกับการค้า LPG</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">รายงาน</td>
                ...
                <tr>
                    <td class="align-top text-left">การสมัครแก้ไขยกเลิกเป็นร้านค้าก๊าซเพื่อรับชำระเงินจากการใช้สิทธิสวัสดิการแห่งรัฐ</td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center"><input class="form-control" type='text' name='data_entry_01' value=''></td>
                    <td class="align-top text-center">2</td>
                    <td class="align-top text-center">ราย</td>
                </tr>
            </tbody>
        </table>
        <div class="row text-left">
