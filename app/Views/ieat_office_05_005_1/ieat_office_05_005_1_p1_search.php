...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_05_005_1" style="color: #6007b3ff; font-size: 18px;"><b>คำขออนุญาตถือกรรมสิทธิ์ที่ดินในนิคมฯ (เปลี่ยนแปลงสัดส่วนผู้ถือหุ้น)*มีค่าใช้จ่าย</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>01-02-52-000001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="width:60%;">ผู้ประกอบการ มีความประสงค์จะขอรับหนังสือ</td>
                                        <td style="width:40%;" class="text-center align-middle">
                                            <span class="form-control-plaintext">หนังสือรับรองการทดสอบ</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-1 col-sm-2 align-self-center mb-2">หุ้น</div>
                                ...
                                <div class="col-md-1 col-sm-2 align-self-center">บาท</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>กรอกข้อมูลที่ดิน</b></span>
                        </div>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:70%;">
                                            <span class="form-control-plaintext">
                                                ขอใช้ที่ดินเพื่อประกอบกิจการร้านอาหาร
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle" style="width:30%;">
                                            ยื่นไปสำนักงานที่ดินจังหวัด
                                        </td>
                                        <td style="width:70%;">
                                            <span class="form-control-plaintext">
                                                ชลบุรี
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            รับโอนสิทธิการใช้ที่ดินและกรรมสิทธิ์ที่ดินจากผู้ประกอบการในนิคม
                                            <span style="color:red;">(ข้อมูล ชื่อบริษัทผู้โอนสิทธิฯ)</span>
                                        </td>
                                        <td>
                                            <span class="form-control-plaintext">
                                                บริษัท สมมุติ จำกัด
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            สถาบันการเงิน (ระบุชื่อสถาบันการเงิน)
                                        </td>
                                        <td>
                                            <span class="form-control-plaintext">
                                                ธนาคารเดาสุ่ม จำกัด (มหาชน)
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>รายละเอียดความต้องการในการใช้พื้นที่</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td style="width:60%;">โดยมีความจำเป็นต้องใช้พื้นที่รวมทั้งสิ้น</td>
                                        <td class="text-center align-middle" style="width:40%;">
                                            <span class="form-control-plaintext text-right">1,200</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="card-header">
                                <span class="font_header"><b>โดยแยกเป็น</b></span>
                            </div>
                        </div>
                        <br>
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>1. พื้นที่อาคารโรงงานรวมทั้งสิ้น</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle" style="width:50%;">
                                            <span class="form-control-plaintext text-right">600</span>
                                        </td>
                                        <td style="width:50%;">ตร.ม. (square meters)</td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="width:70%; text-align:center;">รายการ</th>
                                        <th style="width:10%; text-align:center;">จำนวน (หลัง)</th>
                                        <th style="width:10%; text-align:center;">พื้นที่ ตร.ม.</th>
                                        <th style="width:10%; text-align:center;">รวมพื้นที่ ตร.ม.</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">200</span>
                                        </td>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">400</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>1.2 อาคารย่อย</td>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>2. พื้นที่อาคารประกอบหรือสนับสนุนมีพื้นที่ ทั้งสิ้น</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="width:70%; text-align:center;">รายการ</th>
                                        <th style="width:30%; text-align:center;">หน่วย ตร.ม.</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr><td>ลาน/โรงเก็บผลิตภัณฑ์ ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">50</span></td></tr>
                                    <tr><td>โรงอาหาร ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">30</span></td></tr>
                                    <tr><td>ลาน/โรงจอดรถ ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">60</span></td></tr>
                                    <tr><td>ถนนภายใน ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">40</span></td></tr>
                                    <tr><td>บริเวณที่ขนถ่ายสินค้า ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">50</span></td></tr>
                                    <tr><td>โรงซ่อมอุปกรณ์เครื่องจักร ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">40</span></td></tr>
                                    <tr><td>ป้อมยาม ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">10</span></td></tr>
                                    <tr><td>โรงสูบน้ำ ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">10</span></td></tr>
                                    <tr><td>Boiler ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">50</span></td></tr>
                                    <tr><td>อาคารสำนักงาน ใช้พื้นที่</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">30</span></td></tr>
                                    <tr><td>บริเวณเก็บกักน้ำมันเชื้อเพลิง</td><td class="text-center align-middle"><span class="form-control-plaintext text-right">30</span></td></tr>
                                </tbody>
                            </table>
                        </div>
                        <br>
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>3. พื้นที่ว่างทั่วไป มีพื้นที่รวมทั้งสิ้น</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">100</span>
                                        </td>
                                        <td>ตร.ม. (square meters)</td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>4. พื้นที่สำหรับการป้องกันสิ่งเดือนร้อนรำคาญ มีพื้นที่รวมทั้งสิ้น</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">60</span>
                                        </td>
                                        <td>ตร.ม. (square meters)</td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            <div class="card-header">
                                <span class="font_header"><b>5. พื้นที่สำรองเพื่อการขยายโรงงานในอนาคต มีพื้นที่รวมทั้งสิ้น</b></span>
                            </div>
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle">
                                            <span class="form-control-plaintext text-right">40</span>
                                        </td>
                                        <td>ตร.ม. (square meters)</td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. สำเนาโฉนดที่ดิน (หน้า-หลัง)</td>
                                        <td width="30%">
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header">5. แผนผังการใช้ที่ดิน (Lay out)</td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header">6. ผังแม่บท</td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header">7. ผังจัดสรร (ตามข้อบังคับคณะกรรมการ กนอ. พ.ศ.2562)</td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">8. หนังสือมอบอำนาจ พร้อมติดอากรตามกฎหมาย</td>
                                        <td width="30%">
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left radio-header">9. เอกสารอื่น</td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                                    </tr>
