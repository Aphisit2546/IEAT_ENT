...
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 01-02-51-000001/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขออนุญาตถือกรรมสิทธิ์ที่ดินในนิคมฯ (เปลี่ยนแปลงสัดส่วนผู้ถือหุ้น)*มีค่าใช้จ่าย</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div class="card p-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="transfer">
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="buy">
                                            ซื้อที่ดินจาก
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="buy_from">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="developer">
                                            ผู้พัฒนาที่ดิน
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="bank">
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="court_sale">
                                            การขายทอดตลาดตามคำสั่งศาล
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="court_sale_detail">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">
                                            <input type="checkbox" name="land_source[]" value="other">
                                            อื่นๆ
                                        </td>
                                        <td>
                                            <input type="text" class="form-control" name="other_detail">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>โดยมีความจำเป็นต้องใช้พื้นที่รวมทั้งสิ้น</td>
                                        <td class="text-center align-middle">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%; text-align:center;">พื้นที่ ตร.ม.<be>(square meters)</th>
                                        <th style="width:10%; text-align:center;">รวมพื้นที่ ตร.ม.<be>(square meters)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th style="width:70%; text-align:center;">รายการ</th>
                                        <th style="width:30%; text-align:center;">หน่วย ตร.ม.<be>(square meters)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
