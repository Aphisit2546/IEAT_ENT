...
<div class="class_header_page_02">
    <br />
    รายงานสรุปข้อมูลการนัดหมายตามช่วงเวลา
    <hr />
</div>
<div class="row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        ...
                        <label>
                            ...
                            ทดสอบตรวจสอบก่อนเริ่มประกอบกิจการ
                        </label>
                        <label>
                        ...
                        <label>
                            ...
                            ตรวจตราตรวจเยี่ยมโดยเจ้าหน้าที่
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="7" class="align-middle text-left">รายงานสรุปข้อมูลการนัดหมายตามช่วงเวลา</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center" width="5%">ลำดับ</th>
                                <th class="align-middle text-center">ผู้ประกอบกิจการ</th>
                                <th class="align-middle text-center">ผู้ทดสอบตรวจสอบ</th>
                                <th class="align-middle text-center">หน่วยงาน ธพ.</th>
                                <th class="align-middle text-center">วันที่นัดหมาย</th>
                                <th class="align-middle text-center">ถึงวันที่</th>
                                <th class="align-middle text-center">สถานะกิจกรรม</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
