                        ...
                        <div class="div_header p-4">
                            <div class="table-responsive" style="overflow-x:auto;">
                                <table class="table table-bordered" style="min-width:1800px;">
                                    <thead>
                                        <tr style="background-color:#e3f5ff; color:#000;">
                                            <th style="width:8%; text-align:center;">ตำแหน่ง</th>
                                            <th style="width:20%; text-align:center;">ขอบเขตงานที่รับผิดชอบ</th>
                                            <th style="width:8%; text-align:center;">คำนำหน้า</th>
                                            <th style="width:20%; text-align:center;">ชื่อ–ชื่อกลาง–ชื่อสกุล<br>บุคคลต่างด้าว</th>
                                            <th style="width:8%; text-align:center;">
                                                สัญชาติ
                                            </th>
                                            <th style="width:8%; text-align:center;">เลขที่หนังสือเดินทาง</th>
