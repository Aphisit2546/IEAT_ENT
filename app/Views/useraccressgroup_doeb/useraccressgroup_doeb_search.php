                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th class="align-middle text-center">ชื่อผู้ใช้งาน</th>
                                <th class="align-middle text-center">Username</th>
                                <th class="align-middle text-center">หน่วยงาน</th>
                                <th class="align-middle text-center">วัน-เวลาลงทะเบียน</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-left"><?= $item["AccountName"]; ?></td>
                                        <td class="align-top text-left"><?= $item["Username"]; ?></td>
                                        <td class="align-top text-left"><?= $item["AgencyNameTH"]; ?></td>
                                        <td class="align-top text-center"><?= $item["ModifyDate"]; ?></td>
                                        <td class="align-top text-center">
                                            <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["GroupUserMapping_id"] ?>"><i class="fas fa-edit"></i> กำหนดสิทธิ์กลุ่มใช้งาน</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
