...
<div class="class_header_page_02">
    <br />
    รายงาสรุปข้อมูลกิจกรรมที่น่าสนใจของหน่วยงาน(ปฏิทินกิจกรรม)
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="7" class="align-middle text-left">รายงาสรุปข้อมูลกิจกรรมที่น่าสนใจของหน่วยงาน(ปฏิทินกิจกรรม)</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center" width="5%">ลำดับ</th>
                                <th class="align-middle text-center">วันที่เริ่มกิจกรรม</th>
                                <th class="align-middle text-center">วันที่สิ้นสุดกิจกรรม</th>
                                <th class="align-middle text-center">ชื่อกิจกรรม</th>
                                <th class="align-middle text-center">สถานะการดำเนินการ</th>
                                <th class="align-middle text-center">ผู้รับผิดชอบกิจกรรม</th>
                                <th class="align-middle text-center">ข้อมูลประกอบการติดต่อ</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
