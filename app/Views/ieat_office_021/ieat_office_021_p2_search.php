            ...
            <div class="tab-content">
                <div class="tab-pane" id="tab9">
                    <div class="row row-form">
                        <div class="col-lg-12">
                            <div class="card-header">
                                <span class="font_header">ออกเใบอนุญาต</span>
                            </div>
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
                                        ...
                                        <td align="center">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="30%" align="right" valign='top'>แบบ อ.1</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center"><b>ใบอนุญาตก่อสร้าง ดัดแปลง รื้อถอน หรือเคลื่อนย้ายอาคาร</b></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="18%" align="left" valign="top"><span class="head_detail">&nbsp;xxxx/2568 <input type="hidden" name="d006" id="d006" value="2-31-1-201-00498-2562">
                                                            <input type="hidden" name="doc_run_number" id="doc_run_number" value="1751/2568">
                                                        </span></td>
                                    ...
                                    <tr>
                                        <td align="center">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="25%" align="right" valign="top">อนุญาตให้</td>
                                                    <td align="center" valign="top">
                                                        <span class='head_detail'><b>บริษัท สมมุติ31 จำกัด</b></span>
                                                    </td>
                                                    <td width="25%" align="left" valign="top">เจ้าของอาคาร</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width='40%' align='left'>
                                                        <span class='head_detail'>ตั้งอยู่เลขที่&nbsp;&nbsp;&nbsp;123</span>
                                                    </td>
                                                    <td width='30%' align='left'>
                                                        <span class='head_detail'>หมู่ที่&nbsp;&nbsp;&nbsp;-</span>
                                                    </td>
                                                    <td width='30%' align='left'>
                                                        <span class='head_detail'>อาคาร&nbsp;&nbsp;&nbsp; -</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width='100%' border='0' cellspacing='0' cellpadding='3' align='center'>
                                                <tr>
                                                    <td width='60%' align='left'>
                                                        <span class='head_detail'>ตรอก/ซอย&nbsp;&nbsp;&nbsp;-</span>
                                                    </td>
                                                    <td width='40%' align='left'>
                                                        <span class='head_detail'>ถนน&nbsp;&nbsp;&nbsp;ทางหลวงแผ่นดินหมายเลข 4157 ตำบล</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width='100%' border='0' cellspacing='0' cellpadding='3' align='center'>
                                                <tr>
                                                    <td width='30%' align='left'>
                                                        <span class='head_detail'>ตำบล/แขวง&nbsp;&nbsp;&nbsp;บ้านน้ำบ่อ</span>
                                                    </td>
                                                    <td width='30%' align='left'>
                                                        <span class='head_detail'>อำเภอ/เขต&nbsp;&nbsp;&nbsp;ปะนาเระ </span>
                                                    </td>
                                                    <td width='40%' align='left'>
                                                        <span class='head_detail'>จังหวัด&nbsp;&nbsp;&nbsp;ปัตตานี</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width='20%' align='center'>
                                                        <span class='head_detail'>ข้อที่ 1</span>
                                                    </td>
                                                    <td width="40%" align="left" valign="top">ทำการ&nbsp;&nbsp;&nbsp;<select name='ac_001' id="ac_001">
                                                            <option value='1' selected=selected>ก่อสร้างอาคาร</option>
                                                            <option value='2'>ดัดแปลงอาคาร</option>
                                                            <option value='3'>รื้อถอนอาคาร</option>
                                                            <option value='4'>ก่อสร้างและดัดแปลงอาคาร</option>
                                                            <option value='5'>ก่อสร้าง (รั้ว,ประตู)</option>
                                                            <option value='6'>เคลื่อนย้ายอาคาร</option>
                                                        </select></td>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width='50%' valign="top" align="left">แปลงที่ดินเลขที่&nbsp;&nbsp;&nbsp;TEST001</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="25%" align="left" valign="top">ตั้งอยู่เลขที่&nbsp;&nbsp;<input type="text" name="ad_001" id="ad_001" value="999" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="20%" align="left" valign="top">หมู่ที่&nbsp;&nbsp;<input type="text" name="ad_002" id="ad_002" value="10" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ตรอก/ซอย&nbsp;&nbsp;<input type="text" name="ad_003" id="ad_003" value="-" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">ถนน&nbsp;&nbsp;<input type="text" name="ad_004" id="ad_004" value="สมมุติ14" size='20'>&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="25%" align="left" valign="top">ตำบล/แขวง&nbsp;&nbsp;&nbsp;ตาสิทธิ์ </td>
                                                    <td width="25%" align="left" valign="top">อำเภอ/เขต&nbsp;&nbsp;&nbsp;ปลวกแดง </td>
                                                    <td width="25%" align="left" valign="top">จังหวัด&nbsp;&nbsp;&nbsp;ระยอง , ระยอง</td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width='50%' valign="top" align="left">ในที่ดินโฉนดที่ดินเลขที่&nbsp;&nbsp;&nbsp;<input size="40" type="text" name="title_deed" value="-" /></td>
                                                    <td width='50%' valign="top" align="left">เป็นที่ดินของ&nbsp;&nbsp;&nbsp;<input size="60" type="text" name="owner_land" value="บริษัท สมมุติ31 จำกัด และ บริษัท สมมุติ14 จำกัด" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="80%" align="left" valign="top">เป็นอาคาร</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="90%" align="left" valign="top">
                                                        <input class="form form-control" type="text" name="d007[]" value="ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็น " size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="ฐาน คสล. สองชั้น มีดาดฟ้า จำนวน 1 หลัง เพื่อใช้เป็น " size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="" size='130' maxlength='130' />
                                                        <br /> <input class="form form-control" type="text" name="d007[]" value="" size='130' maxlength='130' />
                                                        <br />
                                                    </td>
                                            ...
                                            <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="left" valign="top">
                                                        ตามแผนผัง แบบแปลน รายการประกอบแบบแปลน และรายการคำนวณที่แนบท้ายใบอนุญาตนี้
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td>
                                            <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="7%" align="right" valign="top">โดยมี</td>
                                                    <td width="63%" align="center" valign="top">
                                                        <font style='font-size:18px;'>
                                                            <b>
                                                                นายทดสอบ&nbsp;ระบบ&nbsp;ภย.99999<br /> </b>
                                                        </font>
                                                    </td>
                                                    <td width="20%" align="left" valign="top">เป็นผู้ควบคุมงาน</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="90%" align="left" valign="top">ผู้ได้รับใบอนุญาต ต้องปฏิบัติตามเงื่อนไขดังต่อไปนี้</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            (1) ผู้ได้รับใบอนุญาตต้องปฏิบัติตามหลักเกณฑ์ วิธีการและเงื่อนไขตามที่กำหนดในกฏกระทรวงและหรือหลักเกณฑ์ การนิคมอุตสาหกรรมแห่งประเทศไทย ซึ่งออกตามความในมาตรา 8(11) มาตรา 9 หรือ มาตรา 10 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522
                                            <input name="dc001[]" type="hidden" id="dc001[]" value="ผู้ได้รับใบอนุญาตต้องปฏิบัติตามหลักเกณฑ์ วิธีการและเงื่อนไขตามที่กำหนดในกฏกระทรวงและหรือหลักเกณฑ์การนิคมอุตสาหกรรม แห่งประเทศไทยซึ่งออกตามความในมาตรา 8(11) มาตรา 9 หรือ มาตรา 10 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522" />
                                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <br />
                                                        <span class="detail">
                                                            <input class="btn btn-success" type="button" value="เพิ่มเงื่อนไข" onClick="addRow('datatable')" />
                                                            <input class="btn btn-danger" type="button" value="ลบเงื่อนไข" onClick="deleteRow('datatable')" />
                                                            <font color='red'><b>**1 ช่อง ต่อ 1 เงื่อนไข**</b></font>
                                                        </span>
                                                        <br /><br />
                                                        <table class="table">
                                                            <tr>
                                                                <th width="10%">เลือกลบ</th>
                                                                <th width="90%">รายละเอียดเงื่อนไข</th>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" valign="middle"><input type="checkbox" name="chk2" id="chk2" /></td>
                                                                <td align="left" valign="middle">
                                                                    <span class="detail">
                                                                        <input name="dc001[]" type="text" id="dc001[]" size="150" value="นางสาว ประทีป test เป็นวิศวกรผู้ควบคุมติดตั้งสารกันไฟ" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="middle">
                                                                    <span class="detail">
                                                                        <input name="dc001[]" type="text" id="dc001[]" size="150" value="" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr>
                                        <td align='left'>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td height="40" align="right" valign="top">ใบอนุญาตฉบับนี้ให้ใช้ได้</td>
                                                    <td valign="top">
                                                        &nbsp;&nbsp;&nbsp;
                                                        <select name='approve_year'>
                                                            <option value='1' selected=selected>1 ปี</option>
                                            ...
                                            <table width='100%' border='0' cellspacing='0' cellpadding='5' align='center'>
                                                <tr>
                                                    <td align='left' width='30%'>
                                                        ...
                                                        <br />
                                                        <span class='head_detail'>2-31-1-201-00498-2562</span>
                                                    </td>
                    ...
                    <div class="row row-form">
                        <div class="col-lg-12">
                            <div class="card-header">
                                <span class="font_header">เลือก&nbsp;<input type="checkbox" name="d021" id="checkbox" value="Y" checked>&nbsp;ออกเอกสารแนบท้ายใบอนุญาต</span>
                            </div>
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="25%" align="center">&nbsp;</td>
                                        <td width="50%" align="center"><img src='https://epp-ieat.ieat.go.th/new_epp_ieat/assets/logo_new.png' border='0' /></td>
                                        <td width="25%" align="right" valign='top'>แบบ อ.1</td>
                                    </tr>
                                </table>
                                <br />
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail"><b>เอกสารแนบท้ายใบอนุญาตก่อสร้าง ดัดแปลงอาคาร หรือรื้อถอนอาคาร</b></span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail">แบบ อ.1 เลขที่ xxxx/2568 วันที่ </span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail">ของบริษัท สมมุติ31 จำกัด</span>
                                        </td>
                                    </tr>
                                </table>
                                <hr />
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="left" valign="middle">
                                            <span class="head_detail"><u><b>ข้อ 2 เป็นอาคาร :-</b></u></span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="left" valign="middle">
                                            <span class="detail">
                                                <input class='btn btn-success' type="button" value="เพิ่มบรรทัด" onClick="addRow2('datatable2')" />
                                                <input class='btn btn-danger' type="button" value="ลบบรรทัด" onClick="deleteRow2('datatable2')" />
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table class="table">
                                    <tr>
                                        <th width="10%">เลือกลบ</th>
                                        <th width="90%">เป็นอาคาร</th>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="middle"><input type="checkbox" name="chk2" id="chk2" /></td>
                                        <td align="left" valign="middle">
                                            <span class="detail">
                                                <input name="dc002[]" type="text" id="dc002[]" class="form form-control" value="ฐาน คสล. สองชั้น มีดาดฟ้า จำนวน 1 หลัง เพื่อใช้เป็นอื่นๆ" maxlength='130' />
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="middle">
                                            <span class="detail">
                                                <input name="dc002[]" type="text" id="dc002[]" class="form form-control" value="" maxlength='130' />
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="row row-form">
                        <div class="col-lg-12">
                            <div class="card-header">
                                <span class="font_header"><b>เลือก <input type="checkbox" name="check_solar" id="check_solar" value="Y" checked> กรณีคำขอนี้ มีการติดตัั้ง Solar rooftop / Solar farm / Solar floating</b></span>
                            </div>
                            <div class="table-responsive div_header p-4">
                                <table class="table table-bordered">
                                    <tr>
                                        <th class='text-center' width='20%'>
                                            <span class="font_header_detail">รูปแบบการติดตั้ง</span>
                                        </th>
                                        <th class='text-center'>
                                            <span class="font_header_detail">ประเภท / กำลังการผลิต</span>
                                        </th>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                            <span class="detail">
                                                <select name='type_solar' class="my_class">
                                                    <option value='1'>ติดตั้งเพื่อใช้เอง</option>
                                                    <option value='2' selected=selected>ติดตั้งเพื่อจำหน่าย</option>
                                                </select> </span>
                                        </td>
                                        <td class="text-left">
                                            <table border='0'>
                                                <tr>
                                                    <td width='20%'>Solar rooftop</td>
                                                    <td width='20%' align='center'><input type="text" name="solar_rooftop_value" id="solar_rooftop_value" value="1000"></td>
                                                    <td>กิโลวัตต์</td>
                                                </tr>
                                                <tr>
                                                    <td align='left'>Solar farm</td>
                                                    <td align='center'><input type="text" name="solar_farm_value" id="solar_farm_value" value="2000"></td>
                                                    <td align='left'>กิโลวัตต์</td>
                                                </tr>
                                                <tr>
                                                    <td align='left'>Solar floating</td>
                                                    <td align='center'><input type="text" name="solar_floating_value" id="solar_floating_value" value="3000"></td>
                                                    <td align='left'>กิโลวัตต์</td>
                                                </tr>
                                            </table>
                                            <br /><br />
                                            <font color='red'>*กรณีผู้ประกอบกิจการขออนุญาตอาคาร INVERTOR ของ Solar farm / Solar floating ให้ระบุกำลังการผลิตของ Solar farm / Solar floating ด้วย</font>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="row row-form">
                        <div class="col-lg-12">
                            <div class="card-header">
                                <span class="font_header"><b>กำหนดรายการอาคาร</b></span>
                            </div>
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="left" valign="middle">
                                            <font color='red'>*</font> กำหนดรายการอาคาร
                                            <span class="detail">
                                                <input class='btn btn-success' type="button" value="เพิ่มชื่ออาคาร" onClick="addRow3('sum_building')" />
                                                <input class='btn btn-danger' type="button" value="ลบชื่ออาคาร" onClick="deleteRow3('sum_building')" />
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table class="table" id="sum_building">
                                    <tr>
                                        <td colspan="14">
                                            <span class="head_detail"> การชำระเงิน : ระบุรายละเอียดการชำระเงิน</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class='text-center'>&nbsp;</td>
                                        <th class='text-center'>ชื่ออาคารที่ต้องการ<br />ให้แสดงใน ขร.1 , ขร.2</th>
                                        <th class='text-center'>ยื่น ขร.1, ขร.2</span></td>
                                        <th class='text-center'>เป็นอาคาร BEC หรือไม่</th>
                                        <th class='text-center'>ประเภทอาคาร</th>
                                        <th class='text-center'>พื้นที่:ตารางเมตร<br />(Area : Square Metre)</td>
                                        <th class='text-center'>ค่าธรรมเนียม<br />(บาท/ตร.ม.)</th>
                                        <th class='text-center'>คิดเป็นเงิน</th>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="middle"><input type="checkbox" name="chk2" id="chk2" /></td>
                                        <td>
                                            <input name="m_005[]" type="text" size="70" value="ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นอื่นๆ">
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='m_004[]' class="my_class">
                                                    <option value='0'>ไม่ต้องยื่น</option>
                                                    <option value='1'>ต้องยื่น ขร.1</option>
                                                    <option value='2'>ต้องยื่น ขร.2</option>
                                                    <option value='3' selected=selected>ต้องยื่น ขร.1, ขร.2</option>
                                                </select> </span>
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='m_0011[]' class="my_class" id="my_id">
                                                    <option value='1'>ไม่เข้าข่าย</option>
                                                    <option value='2' selected=selected>เข้าข่าย</option>
                                                </select> </span>
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='type_building[]' class="my_class" id="my_id">
                                                    <option value='1'>ทั่วไป</option>
                                                    <option value='2' selected=selected>ขนาดใหญ่</option>
                                                    <option value='3'>ใหญ่พิเศษ</option>
                                                    <option value='4'>อาคารสูง</option>
                                                    <option value='5'>สูงและใหญ่พิเศษ</option>
                                                </select> </span>
                                        </td>
                                        <td><input name="building_area[]" type="text" value="500" onkeyup="sum_building('sum_building')" OnKeyPress="return chkNumber(this)"></td>
                                        <td><select name='m_002[]' onChange=sum_building('sum_building');>
                                                <option value='0.5'>0.5</option>
                                                <option value='1'>1</option>
                                                <option value='2' selected=selected>2</option>
                                                <option value='4'>4</option>
                                            </select></td>
                                        <td><input name="m_003[]" type="text" size="10" value="1000.00" readonly></td>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="middle"><input type="checkbox" name="chk2" id="chk2" /></td>
                                        <td>
                                            <input name="m_005[]" type="text" size="70" value="ฐาน คสล. สองชั้น มีดาดฟ้า จำนวน 1 หลัง เพื่อใช้เป็นอื่นๆ">
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='m_004[]' class="my_class">
                                                    <option value='0'>ไม่ต้องยื่น</option>
                                                    <option value='1'>ต้องยื่น ขร.1</option>
                                                    <option value='2' selected=selected>ต้องยื่น ขร.2</option>
                                                    <option value='3'>ต้องยื่น ขร.1, ขร.2</option>
                                                </select> </span>
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='m_0011[]' class="my_class" id="my_id">
                                                    <option value='1' selected=selected>ไม่เข้าข่าย</option>
                                                    <option value='2'>เข้าข่าย</option>
                                                </select> </span>
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='type_building[]' class="my_class" id="my_id">
                                                    ...
                                                    <option value='3'>ใหญ่พิเศษ</option>
                                                    <option value='4'>อาคารสูง</option>
                                                    <option value='5' selected=selected>สูงและใหญ่พิเศษ</option>
                                                </select> </span>
                                        </td>
                                        <td><input name="building_area[]" type="text" value="500" onkeyup="sum_building('sum_building')" OnKeyPress="return chkNumber(this)"></td>
                                        <td><select name='m_002[]'>
                                                <option value='0.5'>0.5</option>
                                                <option value='1'>1</option>
                                                <option value='2' selected=selected>2</option>
                                                <option value='4'>4</option>
                                    ...
                                    <tr>
                                        <td align="left" valign="middle"><input type="checkbox" name="chk2" id="chk2" /></td>
                                        <td>
                                            <input name="m_005[]" type="text" size="70" value="">
                                        </td>
                                        <td>
                                            <span class="detail">
                                                <select name='m_004[]' class="my_class">
                                        ...
                                        <td><input name="building_area[]" type="text" value="" onkeyup="sum_building('sum_building')" OnKeyPress="return chkNumber(this)"></td>
                                        <td><select name='m_002[]' onChange=sum_building('sum_building');>
                                                <option value='0.5'>0.5</option>
                                                <option value='1'>1</option>
                                        ...
                                        <td><input name="m_003[]" type="text" size="10" value="" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive div_header p-4">
                                    ...
                                    <table class="table table-lg">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">ค่าธรรมเนียมในการออกใบอนุญาตฯ</span> <span class="font_header_detail_red">** ไม่รวม VAT **</span></td>
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail"><input class="form-control"></span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">ค่าธรรมเนียมในการตรวจแบบแปลน</span> <span class="font_header_detail_red">** ไม่รวม VAT **</span></td>
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail"><input class="form-control"></span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">ค่าบริการในการดำเนินการ</span> <span class="font_header_detail_red">** ไม่รวม VAT **</span></td>
                                                <td class="table-detail-left col-lg-4"><span class="font_header_detail"><input class="form-control"></span></td>
                                                <td class="table-detail-left col-lg-2"><span class="font_header_detail">บาท</span></td>
                                            </tr>
                                ...
                                <div class="table-responsive div_header p-4">
                                    ...
                                    <table class="table table-lg">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">แบบแปลนประกอบการพิจารณา</span></td>
                                                <td class="table-detail-left col-lg-6">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile">
                                                        <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table" id="datatable01">
                                <thead>
                                    <tr>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>ลำดับ</b></span></th>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>เลขที่แปลง</b></span></th>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>ไร่</b></span></th>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>งาน</b></span></th>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>ตารางวา</b></span></th>
                                        <th class="table-head-tab"><span class="font_header_detail"><b>ตารางเมตร</b></span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
