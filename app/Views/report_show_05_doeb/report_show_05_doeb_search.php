...
<div class="class_header_page_02">
    <br />
    รายงานสรุปงบประมาณเบิกจ่ายแทนกัน สพจ.
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="11" class="align-middle text-left">รายงานสรุปงบประมาณเบิกจ่ายแทนกัน สพจ.</th>
                            </tr>
                            <tr class="align-middle">
                                <th rowspan="2" class="align-middle text-center" width="5%">#</th>
                                <th rowspan="2" class="align-middle text-center">จังหวัด</th>
                                <th colspan="3" class="align-middle text-center">วงเงินที่ได้รับการจัดสรร</th>
                                <th colspan="6" class="align-middle text-center">การเบิกเงินสะสม</th>
                            </tr>
                            <tr>
                                <th class="align-middle text-center">จ้างเหมา</th>
                                <th class="align-middle text-center">งบประมาณอื่นๆ</th>
                                <th class="align-middle text-center">รวม</th>

                                <th class="align-middle text-center">จ้างเหมา</th>
                                <th class="align-middle text-center">จ้างเหมาคงเหลือ</th>
                                <th class="align-middle text-center">งบประมาณอื่นๆ</th>
                                <th class="align-middle text-center">งบประมาณอื่นๆคงเหลือ</th>
                                <th class="align-middle text-center">รวมเบิกงบประมาณ</th>
                                <th class="align-middle text-center">รวมวงเงินตามงบประมาณ</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
