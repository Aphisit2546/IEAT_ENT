...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="OverAllPlanYear_id" id="OverAllPlanYear_id" value="<?php echo $data['OverAllPlanYear_id']; ?>" readonly />
        <?= csrf_field() ?>
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        รหัสอ้างอิง
                        <input type="text" class='form-control' name="OverAllPlanYearCode" id="OverAllPlanYearCode" value="<?php echo $data['OverAllPlanYearCode']; ?>" readonly />
                    </div>
                    <div class="col-3">
                                ...
                                <div class="row text-left">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-10">
                                                แผนอ้างอิง
                                                <?php echo form_dropdown('OverAllPlan_id_ref', $dropdown_masterOverAllPlan_ref, $data["OverAllPlan_id_ref"], "class='form form-control' id='OverAllPlan_id' onchange='GetAnnualTargetValueYearDetail();' disabled "); ?>
                                            </div>
                                            <div class="col-2">
                                                ปีที่จัดทำโครงการ
                                                <?php echo form_dropdown('AnnualTargetValue_Year_ref', $dropdown_AnnualTargetValue_Year_ref, $data["AnnualTargetValue_Year_ref"], "class='form form-control' id='AnnualTargetValue_Year' disabled "); ?>
                                            </div>
                                            <input type="hidden" name="OverAllPlan_id_ref" id="OverAllPlan_id_ref" value="<?php echo $data['OverAllPlan_id_ref']; ?>" />
                                            <input type="hidden" name="AnnualTargetValue_Year_ref" id="AnnualTargetValue_Year_ref" value="<?php echo $data['AnnualTargetValue_Year_ref']; ?>" />
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
