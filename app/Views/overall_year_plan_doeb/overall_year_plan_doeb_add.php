                ...
                <div class="col-md-12">
                    <div class="form-group row">
                        <div id="divTypeSelect1" class="hide_div1">
                            เลือกโครงการ
                            <?php echo form_dropdown('OverAllPlanFiveYear_id', $dropdown_OverallFiveYearPlan, $data["OverAllPlanFiveYear_id"], "class='form form-control' id='OverAllPlanFiveYear_id' "); ?>
                        </div>
                                ...
                                <div class="row text-left">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-2">
                                                ปีที่จัดทำโครงการ
                                                <?php echo form_dropdown('AnnualTargetValue_Year_ref', $dropdown_AnnualTargetValue_Year, $data["AnnualTargetValue_Year_ref"], "class='form form-control' id='AnnualTargetValue_Year' disabled "); ?>
                                            </div>
                                ...
                                <div class="row text-left">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <div class="col-10">
                                                แผน
                                                <?php echo form_dropdown('OverAllPlan_id', $dropdown_masterOverAllPlan, $data["OverAllPlan_id"], "class='form form-control' id='OverAllPlan_id' onchange='GetAnnualTargetValueYearDetail_v2();' "); ?>
                                            </div>
                                            <div class="col-2">
                                                ปีที่จัดทำโครงการ
                                                <?php echo form_dropdown('AnnualTargetValue_Year', $dropdown_AnnualTargetValue_Year, $data["AnnualTargetValue_Year"], "class='form form-control' id='AnnualTargetValue_Year' "); ?>
...
<script>
    ...
    function GetAnnualTargetValueYearDetail_v2() {
        var OverAllPlan_id = $("[name=OverAllPlan_id]  option:selected").val();
        var objDDL = $("[name=AnnualTargetValue_Year]");
        objDDL.empty();
        objDDL.append("<option value='' >-- เลือกปี --</option>");
