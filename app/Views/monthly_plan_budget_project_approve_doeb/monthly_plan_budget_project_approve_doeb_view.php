...
<div class="class_header_page_02">
    <br />
    ตรวจสอบแผนการใช้งบประมาณ (โครงการ)
    <hr />
</div>
<div class="row">
    <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th class="align-middle text-center" width='15%'>เลือก</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-center">
                                            <a id="btnView" class="btn btn-primary" onclick="window.open('../../monthly_plan_budget_project_doeb/view/<?= $item["CreatePlanDetail_id"] ?>', '_blank', 'width=1200,height=550,scrollbars=1');">ดูรายละเอียดข้อมูล</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
