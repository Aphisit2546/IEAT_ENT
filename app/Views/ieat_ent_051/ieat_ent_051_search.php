                        ...
                        <div class="div_header p-4">
                            <div class="table-responsive" style="overflow-x:auto;">
                                <table class="table table-bordered" style="min-width:1600px;">
                                    <thead>
                                        <tr style="background-color:#e3f5ff; color:#000;">
                                            <th rowspan="2" style="width:5%; text-align:center; vertical-align:middle;">เลือก</th>
                                            <th colspan="2" style="width:20%; text-align:center;">ระยะเวลาที่ใช้ในการถ่ายทอด</th>
                                            <th rowspan="2" style="width:20%; text-align:center; vertical-align:middle;">
                                                วิธีการถ่ายทอด<br>
