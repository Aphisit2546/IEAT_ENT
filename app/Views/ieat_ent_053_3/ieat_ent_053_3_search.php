...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_3" style="color: #6007b3ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (การขอเพิ่มตำแหน่งให้ช่างฝีมือ ผู้ชำนาญการ)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (การขอเพิ่มตำแหน่งให้ช่างฝีมือ ผู้ชำนาญการ)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="background-color:#e3f5ff; color:#000000; text-align:center;">
                                    <tr>
                                        ...
                                        <th>เลขที่หนังสือรับรองออกให้ ณ วันที่<br>** วัน/เดือน/ปี พ.ศ.<br>** Ex. 01/01/2560</th>
                                        <th>สำนักงานทะเบียนหุ้นส่วนบริษัท</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="background-color:#e3f5ff; color:#000000; text-align:center;">
                                    <tr>
                                        ...
                                        <th>ชื่อบริษัทที่ต้องการเพิ่มตำแหน่ง</th>
                                        <th>เลขที่ตั้งโรงงาน<br>ที่ต้องการเพิ่มตำแหน่ง</th>
                                        <th>ชื่อตำแหน่งที่ขอเพิ่ม</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
