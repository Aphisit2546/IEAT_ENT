                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="6" cellspacing="0">
                                        ...
                                        <td align="center">
                                            <table width='100%' border='0' cellspacing='0' cellpadding='5' align='center'>
                                                <tr>
                                                    ...
                                                    <td width='40%' align='center' valign='middle' height='130'><img src='https://epp-ieat.ieat.go.th/new_epp_ieat/assets/logo_new.png' border='0' /></td>
                                    ...
                                    <tr>
                                        <td align="center"><b>ใบรับรองการก่อสร้าง การดัดแปลง หรือการเคลื่อนย้ายอาคาร ประเภทควบคุมการใช้</b></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="18%" align="left" valign="top"><span class="head_detail">&nbsp;xxxx/2568</span></td>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td colspan="6" align="center" valign="top">
                                                        บริษัท สมมุติ31 จำกัด
                                                    </td>
                                                    <td width="25%" align="left" valign="top">เจ้าของอาคาร/ผู้ครอบครองอาคาร</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="left" valign="top">ได้ทำการ</td>
                                                    <td width="25%" align="left" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td width="40%" align="left" valign="top">อาคารเป็นไปโดยถูกต้องตามที่ได้รับอนุญาตในใบอนุญาตที่</td>
                                                    <td width="25%" align="left" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="left" valign="top">วันที่ &nbsp;&nbsp;</td>
                                                    <td align="left" valign="top">ซึ่งอาคารดังกล่าวเป็นอาคารประเภทควบคุมการใช้</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="left" valign="top">การนิคมอุตสาหกรรมแห่งประเทศไทย จึงออกใบรับรองให้ดังต่อไปนี้</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="10%" align="left" valign="top">ข้อที่ 1</td>
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="90%" align="left" valign="top">
                                                        <input type="text" name="d007[]" value="1. ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นโรงงานและสำนักงาน (อาคารขนาดใหญ่พิเศษ)" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="2. ค.ส.ล. โครงหลังคาเหล็กชั้นเดียวเพื่อใช้เป็นโรงงาน" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="1. ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นโรงงานและสำนักงาน (อาคารขนาดใหญ่พิเศษ)" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="1. ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นโรงงานและสำนักงาน (อาคารขนาดใหญ่พิเศษ)" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="1. ค.ส.ล. ชั้นเดียว มีชั้นลอย จำนวน 1 หลัง เพื่อใช้เป็นโรงงานและสำนักงาน (อาคารขนาดใหญ่พิเศษ)" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="" size='120' maxlength='180' />
                                                        <br /> <input type="text" name="d007[]" value="" size='120' maxlength='180' />
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="10%" align="left" valign="top">&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ในเขต&nbsp;&nbsp;อุตสาหกรรมทั่วไป&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">นิคมอุตสาหกรรม&nbsp;&nbsp;อาหารฮาลาล จังหวัดปัตตานี&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">แปลงที่ดินเลขที่&nbsp;&nbsp;TEST001 , TEST001&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                        ...
                                        <td align="left">
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="20%" align="left" valign="top">หมู่ที่&nbsp;&nbsp;<input type="text" name="ad_002" id="ad_002" value="6" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="30%" align="left" valign="top">ตรอก/ซอย&nbsp;&nbsp;<input type="text" name="ad_003" id="ad_003" value="-" size='20'>&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">ถนน&nbsp;&nbsp;<input type="text" name="ad_004" id="ad_004" value="ทดสอบ" size='20'>&nbsp;&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="25%" align="left" valign="top">ตำบล/แขวง&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">อำเภอ/เขต&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">จังหวัด&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td width="25%" align="left" valign="top">&nbsp;</td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="5%" align="left" valign="top">โดย</td>
                                                    <td align="left" valign="top">
                                                        &nbsp;&nbsp;<input type="text" name="dc_0001" id="dc_0001" value="บริษัท สมมุติ3123 จำกัด" size='50'>&nbsp;&nbsp;เป็นเจ้าของอาคาร
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top">และ</td>
                                                    <td align="left" valign="top">
                                                        &nbsp;&nbsp;<input type="text" name="dc_0002" id="dc_0002" value="บริษัท สมมุติ3123 จำกัด" size='50'>&nbsp;
                                                        เป็นผู้ครอบครองอาคารอยู่ในที่ดินโฉนดที่ดินเลขที่&nbsp;&nbsp;<input type="text" name="title_deed_num" id="title_deed_num" value="-" size='30'>&nbsp;&nbsp;
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="top">เป็นที่ดินของ</td>
                                                    <td align="left" valign="top">
                                                        &nbsp;&nbsp;<input type="text" name="title_deed_ow" id="title_deed_ow" value="บริษัท สมมุติ3111 จำกัด" size='50'>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td>
                                            <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="80%" align="left" valign="top">ผู้ได้รับใบรับรองต้องปฏิบัติตามเงื่อนไข ดังต่อไปนี้</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            (1) ผู้ได้รับใบอนุญาตต้องปฏิบัติตามหลักเกณฑ์ วิธีการและเงื่อนไขตามที่กำหนดในกฏกระทรวงและหรือหลักเกณฑ์การนิคมอุตสาหกรรมแห่งประเทศไทย ซึ่งออกตามความในมาตรา 8(11) มาตรา 9 หรือ มาตรา 10 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522
                                            <input name="dc001[]" type="hidden" id="dc001[]" value="ผู้ได้รับใบอนุญาตต้องปฏิบัติตามหลักเกณฑ์ วิธีการและเงื่อนไขตามที่กำหนดในกฏกระทรวงและหรือหลักเกณฑ์การนิคมอุตสาหกรรมแห่งประเทศไทย ซึ่งออกตามความในมาตรา 8(11) มาตรา 9 หรือ มาตรา 10 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522" />
                                            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        ...
                                                        <br /><br />
                                                        <table class="table" width="100%" border="0" align="center" cellpadding="5" cellspacing="1" id="datatable">
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="middle">
                                                                    <span class="detail">
                                                                        <input name="dc001[]" type="text" id="dc001[]" size="150" value="อาคารในข้อที่ 2 เป็นอาคารที่ต้องจัดให้มีผู้ตรวจสอบตามมาตรา 32 ทวิ" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td align="left" valign="middle">
                                                                    <span class="detail">
                                                                        <input name="dc001[]" type="text" id="dc001[]" size="150" value="อาคารในข้อที่ 2 เป็นอาคารควบคุมการใช้" />
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <table width='100%' border='0' cellspacing='0' cellpadding='5' align='center'>
                                                <tr>
                                                    <td align='left' width='30%'>
                                                        ...
                                                        <br />
                                                        2-01-1-203-00001-2568
                                                        <input name="d006" type="hidden" value="2-31-1-203-00126-2563" />
                                                    </td>
                                                    <td align='center' valign='bottom'>
                                                        (ลายมือชื่อ)...............................................................................ผู้อนุญาต
                                                        <br /><br />
                                                        <br />
                                                        ปฏิบัติงานแทนผู้ว่าการการนิคมอุตสาหกรรมแห่งประเทศไทย
                                                        </font>
                                                    </td>
                                                </tr>
                                            </table>
                            ...
                            <div class="table-responsive div_header p-4">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="25%" align="right" valign='top'>แบบ อ.5</td>
                                    </tr>
                                </table>
                                <br />
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail"><b>เอกสารแนบท้ายใบรับรองการก่อสร้างอาคาร การดัดแปลง หรือการเคลื่อนย้ายอาคาร ประเภทควบคุมการใช้</b></span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <span class="head_detail">แบบ อ.5 เลขที่ xxxx/2568 วันที่ </span>
                                        </td>
                                    </tr>
                                </table>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1">
                            ...
                            <div class="col-6" align="center">
                                <div class="table-responsive div_header p-4">
                                    ...
                                    <table class="table table-lg">
                                        <tbody>
                                            <tr>
                                                <td class="table-detail-left col-lg-6"><span class="font_header_detail">บันทึกการตรวจพิจารณาของเจ้าหน้าที่</span></td>
