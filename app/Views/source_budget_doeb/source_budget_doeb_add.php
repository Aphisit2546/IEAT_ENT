...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="BudgetSourceType_id" id="BudgetSourceType_id" value="<?php echo $data['BudgetSourceType_id']; ?>" readonly />
        <?= csrf_field() ?>
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        รหัสอ้างอิง
                        <input type="text" class='form-control' name="BudgetSourceCode" id="BudgetSourceCode" value="<?php echo $data['BudgetSourceCode']; ?>" readonly />
                    </div>
                    <div class="col-3">
