                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <!--<td class="align-top text-left"><?= $item["BudgetSourceCode"]; ?></td>-->
                                        ...
                                        <td class="align-top text-center">
                                            <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["BudgetSourceType_id"] ?>"><i class="fas fa-edit"></i> ปรับปรุงข้อมูล</a>
                                            <a id="btnDel" class="btn btn-danger" href="<?= $routeGroup ?>/del/<?= $item["BudgetSourceType_id"] ?>"><i class="fas fa-edit"></i> ลบ</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
