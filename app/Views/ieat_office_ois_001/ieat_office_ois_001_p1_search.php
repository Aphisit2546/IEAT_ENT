...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_office_ois_001/p1"</b></a>
</div>
<br />
    ...
    <div class="row row-form mb-3">
        <div class="col-12">
            <span style="color:#000; font-size:25px; font-weight:bold;">
                จัดทำหนังสือคำสั่ง ค.1 
                (คำสั่งให้แก้ไขเปลี่ยนแปลงแผนผังบริเวณ แบบแปลน รายการประกอบแบบแปลน 
