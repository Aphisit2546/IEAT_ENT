...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        ...
        <input type="hidden" name="GroupUserID" id="GroupUserID" value="<?php echo $data['GroupUserID']; ?>" readonly />
        <?= csrf_field() ?>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <font style="font-size: 24px;">
                            ปีงบประมาณ <?php echo $data["FiscalYear"]; ?>
                        </font>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <font style="font-size: 24px;">
                            หน่วยงาน <?php echo $data["GroupUserName"]; ?>
                        </font>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                <td align="left" valign="middle">
                                    <span class="detail">
                                        ...
                                        <br />
                                        <textarea name="RemarksIns" cols='50' rows='3'><?php echo $data['RemarksIns']; ?></textarea>
                                    </span>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td align="left" valign="middle">
                                    <span class="detail">
                                        ความคิดเห็นเพิ่มเติม
                                        <br />
                                        <textarea name="RemarksApprove" cols='50' rows='3'><?php echo $data['RemarksApprove']; ?></textarea>
                                    </span>
                                </td>
                            </tr>
                        </table>
        ...
        <div class="form-row">
            <div class="col-sm-12 text-right">
                ...
                <input name="btnReject" id="btnReject" type="submit" class="btn btn-danger" value="แจ้งทบทวนเอกสาร">
