...
<div class="class_header_page_02">
    <br />
    รายงานค่าเป้าหมายและตัวชี้วัดของแผนปฏิบัติราชการ
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="8" class="align-middle text-left">รายงานค่าเป้าหมายและตัวชี้วัดของแผนปฏิบัติราชการ</th>
                            </tr>
                            <tr class="align-middle">
                                <th rowspan="2" class="align-middle text-center" width="5%">#</th>
                                <th rowspan="2" class="align-middle text-center">เป้าหมาย</th>
                                <th rowspan="2" class="align-middle text-center">ตัวชี้วัด</th>
                                <th colspan='5' class="align-middle text-center">ประมาณการแผนประมาณรายปี (ล้านบาท)</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center">2566</th>
                                <th class="align-middle text-center">2567</th>
                                <th class="align-middle text-center">2568</th>
                                <th class="align-middle text-center">2569</th>
                                <th class="align-middle text-center">2570</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
