...
<form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
                    ...
                    <td align='center'>
                        <table class="table table-bordered" id="datatable1">
                            ...
                            <tr>
                                <td align="left" valign="middle">
                                    <span class="detail">
                                        <input type='radio' name='ActiveStatusFirstIns' value='Y' <?php if ($data_main['ActiveStatusFirstIns'] == 'Y'): echo "checked";
                                                                                                    endif; ?>> อนุมัติ
                                        <input type='radio' name='ActiveStatusFirstIns' value='N' <?php if ($data_main['ActiveStatusFirstIns'] == 'N'): echo "checked";
                                                                                                    endif; ?>> ไม่อนุมัติ
                                    </span>
                                </td>
                            </tr>
                    ...
                    <td align='center'>
                        <table class="table table-bordered" id="datatable1">
                            ...
                            <tr>
                                <td align="left" valign="middle">
                                    <span class="detail">
                                        <input type='radio' name='ActiveStatusFirstApprove' value='Y' <?php if ($data_main['ActiveStatusFirstApprove'] == 'Y'): echo "checked";
                                                                                                        endif; ?>> อนุมัติ
                                        <input type='radio' name='ActiveStatusFirstApprove' value='N' <?php if ($data_main['ActiveStatusFirstApprove'] == 'N'): echo "checked";
                                                                                                        endif; ?>> ไม่อนุมัติ
                                    </span>
                                </td>
                            </tr>
    ...
    <div class="form-row">
        <div class="col-sm-12 text-right">
            <input name="btnSave" id="btnSave" type="submit" class="btn btn-danger" value="แจ้งทบทวนข้อมูล">
            <input name="btnSave2" id="btnSave2" type="submit" class="btn btn-success" value="บันทึกข้อมูล">
