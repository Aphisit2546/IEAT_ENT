...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>การขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-6">
            ...
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>การขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width='100%' border='0' align='center' cellpadding='10' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td width="94%" height='35' valign='top'>
                                            <input type="text" name="pp_000" value="การขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร" size="80" />
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table width='100%' border='0' align='center' cellpadding='5' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            ...
                                            2. <input type="text" name="pp_002_1" value="คำขออนุญาตขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร เลขที่ 1-15-0-212-00001-2568 ลงวันที่ 21 พฤศจิกายน 2568" size="120" /><br />
                                        </td>
                                    </tr>
                                </table>
                                <br />
                                <table width='100%' border='0' align='center' cellpadding='7' cellspacing='1'>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 1<br />
                                            <textarea name="pp_004" id="pp_004" cols="120" rows="8">ตามหนังสือที่อ้างถึง 1 บริษัท สมมุติ15 จำกัด ได้รับหนังสืออนุญาตให้ใช้ที่ดินฯล่าสุด เลขที่ TEST015 ออกให้ ณ วันที่ 31-01-2554 ประกอบกิจการ ชุบเคลือบผิวทองแดงและทองเหลืองด้วยความร้อน (Plating, Heat Treatment) ซื้อ-ขายของที่ไม่ได้ใช้แล้วทุกชนิด, ชื้อ-ขาย ผลิตภัณฑ์เงินทุกชนิดทุกประเภท ผลิตภัณฑ์ทองแดงทุกชนิดทุกประเภท ผลิตภัณฑ์สังกะสีทุกชนิดทุกประเภท เหล็กกล้า ทองเหลือง อลูมิเนียม อัลลอย โลหะบริสุทธิ์ ลวดอัลลอย ในนิคมอุตสาหกรรม เกตเวย์ ซิตี้ จังหวัด ฉะเชิงเทรา ในเขตอุตสาหกรรม ประกอบการเสรี แปลงที่ดินเลขที่  พื้นที่ประมาณ 0 ไร่ 0 งาน 0.0 ตารางวา บริษัทฯ มีการขอการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร ตามหนังสือที่อ้างถึง 2 ความละเอียดแจ้งแล้วนั้น</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height='35' align='center'>
                                            ย่อหน้าที่ 2<br />
                                            <textarea name="pp_005" id="pp_005" cols="120" rows="8">การนิคมอุตสาหกรรมแห่งประเทศไทย (กนอ.) พิจารณาแล้ว บริษัทฯ สามารถดำเนินการการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร ตามแบบแปลนและรายการคำนวณ ที่ระบุในคำขอฯได้ ทั้งนี้ บริษัทฯ ต้องปฏิบัติตามกฎหมายที่เกี่ยวข้อง และให้คำนึงถึงความปลอดภัย ในการปฏิบัติงานต่อไป</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            <div class="row row-form">
                                <div class="col-lg-12">
                                    <span class="font_header_detail"><b>ข้อมูลที่จะขออนุญาต <font color='red'><b>*</b></font></b></span>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <label><input checked type="radio" id="construction_type_id_view_1" name="construction_type_id" value="1" <?php if ($datashow['construction_type_id'] == '1'): echo "checked='checked'";
                                                                                                                                                endif ?> /> <span class="font_header_detail"><b>เสาเข็มตอก</b></span></label>&nbsp;
                                    <label><input disabled type="radio" id="construction_type_id_view_2" name="construction_type_id" value="2" <?php if ($datashow['construction_type_id'] == '2'): echo "checked='checked'";
                                                                                                                                                endif ?> /> <span class="font_header_detail"><b>เสาเข็มเจาะ</b></span></label>&nbsp;
                                    <label><input disabled type="radio" id="construction_type_id_view_2" name="construction_type_id" value="2" <?php if ($datashow['construction_type_id'] == '2'): echo "checked='checked'";
                                                                                                                                                endif ?> /> <span class="font_header_detail"><b>เสาเข็มตอกและเสาเข็มเจาะ</b></span></label>&nbsp;
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <br /><br />
                            ขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab3">
                    <div class="card p-4">
                        <div class="table-responsive div_header p-4">
                            ...
                            <div class="table-responsive div_header p-4">
                                <div class="card-header">
                                    <span class="font_header"><b>เอกสารประกอบการ การขอทำการเจาะกด หรือตอกเสาเข็มเพื่อทำการทดสอบที่จะใช้ในการก่อสร้างอาคาร ที่ต้องนำส่งให้เจ้าหน้าที่พิจารณา</b></span>
                                </div>
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="col-lg-12">5. ผังบริเวณพร้อมระบุตำแหน่งเสาเข็มที่จะตอกทดสอบ</label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="table table-bordered">
                                    <tr>
                                        <td width='70%'>
                                            <label class="col-lg-12">หนังสือแสดงความยินยอมพร้อมสําเนาใบอนุญาตให้เป็นผู้ประกอบวิชาชีพวิศวกรรมควบคุม (ผู้ควบคุมงาน ด้านวิศวกรรม (วิศวกรโยธา)) <a href="4_แบบ_กนอ_น4-1.pdf" target="_blank">แบบฟอร์ม Download</a></label>
                                        </td>
                                        <td>
                                            <span class="font_header_detail_red"><a href="#">ไฟล์เอกสาร</a></span>
                                        </td>
