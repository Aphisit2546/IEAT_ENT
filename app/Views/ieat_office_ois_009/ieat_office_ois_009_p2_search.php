...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_office_ois_009/p2</b></a>
</div>
<br />
    ...
    <div class="row row-form mb-3">
        <div class="col-12">
            <span style="color:#000; font-size:25px; font-weight:bold;">
                พิจารณาหนังสือคำสั่ง ค.5 (คำสั่งให้ยื่นคำขออนุญาตหรือดำเนินการแจ้ง 
                หรือดำเนินการแก้ไขเปลี่ยนแปลงการก่อสร้าง การดัดแปลง การรื้อถอน 
                หรือการเคลื่อนย้ายอาคารตามมาตรา 41)
            </span>
        </div>
    </div>
