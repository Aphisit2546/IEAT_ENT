...
<div class="class_header_page_02">
    <br />
    รายงานสรุปโครงการที่ล่าช้ากว่าเกณฑ์ดัชนีชี้วัด
    <hr />
</div>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="10" class="align-middle text-left">รายงานสรุปโครงการที่ล่าช้ากว่าเกณฑ์ดัชนีชี้วัด</th>
                            </tr>
                            <tr class="align-middle">
                                ...
                                <th rowspan='2' class="align-middle text-center">ร้อยละความล่าช้ากว่าเกณฑ์ดัชนีชี้วัด</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center">งานตามแผน</th>
                                <th class="align-middle text-center">งานสะสม</th>
                                <th class="align-middle text-center">ยอดเบิกจ่ายตามแผน</th>
                                <th class="align-middle text-center">ยอดเบิกจ่ายรวม</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
