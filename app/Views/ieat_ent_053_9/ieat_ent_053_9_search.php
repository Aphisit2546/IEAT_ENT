...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_9" style="color: #6007b3ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขออนุญาตให้นำช่างฝีมือ ผู้ชำนาญการ คู่สมรสและบุคคลซึ่งอยู่ในอุปการะ อยู่ในราชอาณาจักรตามสิทธิเดิมที่ได้รับอนุญาตไว้เดิม ( กรณีไม่ได้ทำ RE-ENTRY VISA ))</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขออนุญาตให้นำช่างฝีมือ ผู้ชำนาญการ คู่สมรสและบุคคลซึ่งอยู่ในอุปการะ อยู่ในราชอาณาจักรตามสิทธิเดิมที่ได้รับอนุญาตไว้เดิม ( กรณีไม่ได้ทำ RE-ENTRY VISA ))</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="active tab-pane" id="tab1">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>ข้อมูลที่ดิน ตามใบอนุญาต</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <table class="table table-bordered" id="datatable01" style="font-size:14px;">
                                <thead>
                                    <tr style="background-color:#e3f5ff; color:#000; text-align:center;">
                                        <th rowspan="2" style="vertical-align:middle; width:5%;">ลำดับ</th>
                                        <th rowspan="2" style="vertical-align:middle; width:15%;">เลขที่แปลง<br>(Land No.)</th>
                                        <th colspan="4" style="vertical-align:middle;">
                                            เนื้อที่แปลงโดยประมาณเนื้อที่แปลงโดยประมาณ
                                        </th>
                                    </tr>
                                    <tr style="background-color:#e3f5ff; color:#000; text-align:center;">
                                        <th style="width:10%;">ไร่<br>(Rai)</th>
                                        <th style="width:10%;">งาน<br>(Ngan)</th>
                                        <th style="width:10%;">ตร.ว.<br>(Square wah)</th>
                                        <th style="width:10%;">ตร.ม.<br>(Square meter)</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="background-color:#e3f5ff; color:#000000; text-align:center;">
                                    <tr>
                                        ...
                                        <th>ชื่อตัว–ชื่อรอง–ชื่อสกุล<br>บุคคลต่างด้าวในตำแหน่งที่ขอบรรจุ</th>
                                        <th>เลขที่<br>หนังสือเดินทาง</th>
                                        <th>วันที่หนังสือ<br>เดินทางหมดอายุ</th>
                                        <th>สัญชาติ</th>
                                        <th>วัน/เดือน/ปีเกิด</th>
                                        <th>อนุญาตสิ้นสุดวันที่</th>
                                        <th>หมายเหตุเพิ่มเติม<br>ก่อนต่ออายุ</th>
                                        <th>เลขที่หนังสือเดินทาง</th>
                                        <th>วันที่ยกเลิกสิทธิการอยู่<br>(dd/mm/YYYY)<br>**Ex. 01/01/1900</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
