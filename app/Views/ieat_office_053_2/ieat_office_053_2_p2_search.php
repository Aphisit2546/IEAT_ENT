...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_2" style="color: #6007b3ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (การเปลี่ยนตำแหน่งของช่างฝีมือ ผู้ชำนาญการ)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>11-1-57-00001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 11-1-57-00001/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (การเปลี่ยนตำแหน่งของช่างฝีมือ ผู้ชำนาญการ)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="card-header">
                            <span class="font_header" style="color:#a10ddb;">
                                <b>การเปลี่ยนตำแหน่งของช่างฝีมือ ผู้ชำนาญการ</b>
                            </span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        <th style="vertical-align:top;">ชื่อตำแหน่งที่ขอเปลี่ยน</th>
                                        <th style="vertical-align:top;">ขอบเขตงานที่รับผิดชอบ</th>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. หนังสือรับรองของบริษัท</td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. บัญชีรายชื่อผู้ถือหุ้น</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. รายงานการประชุม/ประกาศ/คำสั่ง ให้เปลี่ยนตำแหน่งช่างฝีมือ ผู้ชำนาญการ</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. สำเนาหนังสือเดินทางของช่างฝีมือ ผู้ชำนาญการ</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">5. สำเนาใบอนุญาตทำงานของช่างฝีมือ ผู้ชำนาญการ</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
