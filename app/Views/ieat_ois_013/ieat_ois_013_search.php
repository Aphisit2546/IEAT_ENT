...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_013" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.7 (คำสั่งให้ระงับการใช้อาคารตามมาตรา 44)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_013</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.7 (คำสั่งให้ระงับการใช้อาคารตามมาตรา 44)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คําสั่งให้ระงับการใช้อาคารตามมาตรา 44
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">พนักงานท้องถิ่น เลขที่</div>
                            <div class="col-md-1">
                                <input type="text" class="form-control form-control-sm" name="address_road">
                            </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    ให้ก่อสร้าง ดัดแปลง หรือเคลื่อนย้ายอาคารประเภทควบคุมการใช้ แต่ท่านได้ใช้หรือมีบุคคลใดใช้อาคารนั้นภายใน 
                                    กําหนด เวลาสามสิบวัน นับแต่วันที่เจ้าพนักงานท้องถิ่นได้รับแจ้งเป็นหนังสือให้ทําการตรวจสอบอาคาร 
                                    อันเป็นการฝ่าฝืน มาตรา 32 วรรคสาม
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    อาคารของท่านไม่เป็นอาคารประเภทควบคุมการใช้ 
                                    แต่ท่านได้ใช้หรือยินยอมให้บุคคลใด ใช้อาคารนั้นเพื่อกิจการประเภทควบคุมการใช้ 
                                    อันเป็นการฝ่าฝืนมาตรา 33 วรรคหนึ่ง
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    อาคารของท่านเป็นอาคารประเภทควบคุมการใช้สําหรับกิจการหนึ่ง แต่ท่านได้เปลี่ยนการใช้ 
                                    หรือยินยอมให้บุคคลอื่นเปลี่ยนการใช้อาคารนั้น ไปใช้เป็นอาคารประเภทควบคุมการใช้สําหรับอีกกิจการหนึ่ง 
                                    อันเป็นการ ฝ่าฝืนมาตรา 33 วรรคสอง
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    อาศัยอํานาจตามความในมาตรา 44 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ให้ท่าน
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    ระงับการใช้อาคารที่ยังไม่ได้รับใบรับรองนั้น จนกว่าท่านจะได้รับใบรับรอง หรือจนกว่า 
                                    จะพ้นกําหนดสามสิบวันนับแต่วันที่เจ้าพนักงานท้องถิ่นได้รับแจ้งเป็นหนังสือให้ทําการตรวจสอบอาคารนั้น ตามมาตรา 32 วรรคสอง
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    ระงับการใช้อาคารนั้น จนกว่าท่านจะได้รับใบอนุญาตหรือใบรับแจ้ง ตามมาตรา 33
                                </div>
                            </div>
                            <div class="col">
