                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกประเภทการโอนสิทธิ</td>
                                    ...
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">เลือกผู้รับโอนสิทธิการใช้ที่ดิน</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <div class="panel-heading">
                            <span class="font_header">กรุณาระบุแปลงที่ดินและเนื้อที่ที่ประสงค์จะโอนสิทธิ</span>
                        </div>
                        <div class="table-responsive div_header p-4">
