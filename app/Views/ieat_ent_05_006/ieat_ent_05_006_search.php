...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_05_006" style="color: #6007b3ff; font-size: 18px;"><b>คำขออนุญาตถือกรรมสิทธิ์ที่ดินเขตที่พักอาศัยและพาณิชยกรรม (15.1 ส. นิติบุคคลต่างด้าว)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>10-02-52-000001/2568 </b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 10-02-52-000001/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขออนุญาตถือกรรมสิทธิ์ที่ดินเขตที่พักอาศัยและพาณิชยกรรม (15.1 ส. นิติบุคคลต่างด้าว)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            ที่ดินสำหรับพนักงานในระดับบริหาร และช่างฝีมือ ผู้ชำนาญการ จำนวน
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    <input type="text" class="form-control" name="land_executive">
                                                </div>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            ที่ดินสำหรับคนงานในโรงงาน จำนวน
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    <input type="text" class="form-control" name="land_worker">
                                                </div>
                                                <div class="col-md-2 align-self-center">
                                                    ครอบครัว
                                                </div>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            อาคารชุดสำหรับผู้บริหาร ช่างฝีมือ ผู้ชำนาญการ จำนวน
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control" name="condo_executive_family">
                                                </div>
                                                <div class="col-md-2 align-self-center">
                                                    ครอบครัว
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control" name="condo_executive_room">
                                                </div>
                                                <div class="col-md-2 align-self-center">
                                                    ห้องชุด
                                                </div>
                                    ...
                                    <tr>
                                        <td class="align-middle">
                                            อาคารชุดสำหรับคนงานในโรงงาน จำนวน
                                        </td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control" name="condo_worker_family">
                                                </div>
                                                <div class="col-md-2 align-self-center">
                                                    ครอบครัว
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    <input type="text" class="form-control" name="condo_worker_room">
                                                </div>
                                                <div class="col-md-2 align-self-center">
                                                    ห้องชุด
                                                </div>
