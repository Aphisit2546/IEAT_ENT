                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="background-color:#e3f5ff; color:#000000; text-align:center;">
                                    <tr>
                                        <th>ใบอนุญาตทำงานเลขที่</th>
                                        <th>วันที่ออกใบอนุญาตทำงาน(ตั้งแต่วันที่ ...)</th>
                                        <th>เลขที่หนังสือเดินทาง</th>
                                        <th>วันที่ออกจากงาน<br>**(ระบุวันที่ล่วงหน้าไม่น้อยกว่า 7 วัน <br>สูงสุดไม่เกิน 30 วัน แต่ไม่เกินวันที่ตามวีซ่าที่ได้รับอนุญาต)**</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
