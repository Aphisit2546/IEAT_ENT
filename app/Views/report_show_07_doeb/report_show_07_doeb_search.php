...
<div class="class_header_page_02">
    <br />
    รายงานสรุปผลการจัดทำแบบฟอร์มลงทะเบียนผ่านระบบ
    <hr />
</div>
<div class="row">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        ค้นหาช่วงเวลาที่เริ่มลงทะเบียน
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="8" class="align-middle text-left">รายงานสรุปผลการจัดทำแบบฟอร์มลงทะเบียนผ่านระบบ</th>
                            </tr>
                            <tr class="align-middle">
                                <th class="align-middle text-center" width="5%">ลำดับ</th>
                                <th class="align-middle text-center">ชื่อแบบฟอร์ม</th>
                                <th class="align-middle text-center">วันที่เริ่มลงทะเบียน</th>
                                <th class="align-middle text-center">วันที่สิ้นสุดการลงทะเบียน</th>
                                <th class="align-middle text-center">ผู้จัดทำแบบฟอร์ม</th>
                                <th class="align-middle text-center">จำนวนข้อสอบถามประกอบการลงทะเบียน</th>
                                <th class="align-middle text-center">จำนวนผู้ลงทะเบียนตามแบบฟอร์ม</th>
                                <th class="align-middle text-center">QRCode และ Link ลงทะเบียน</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
