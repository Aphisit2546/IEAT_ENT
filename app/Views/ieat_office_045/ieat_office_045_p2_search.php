...
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            ...
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>IEAT-E-01</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
        ...
        <div class="card-body">
            <div class="tab-content">
                    ...
                    <div class="row row-form">
                        <div class="col-lg-6">
                            <div class="div_header p-2" style="text-align: center;">
                                ...
                                <embed src="Upload/doc01_001/045.pdf" width="800px" height="800px" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_045/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>คำขออนุญาตนำของออกไปจากเขตประกอบการเสรี (นำของออก) IEAT-E-01</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tr>
                                    <td align="left">
                                        ...
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>Invoice เลขที่ :</font>&nbsp;9367021351</span>
                                        <font style='font-size:16px; color:#CC0066; font-weight:bold;'>ลงวันที่ :</font>&nbsp;2025-11-24</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td align="center"><span class="font_head_detail_table">ชื่อรายการ</span></td>
                                ...
                                <tr>
                                    ...
                                    <td align="center">MOCCN CAPP.STRONG INS 30X13.2GX3</td>
                                    <td align="center">000021011299</td>
                                    <td align="center">001</td>
                                    <td align="center">6000.000</td>
                                    <td align="center">BX</td>
                                    <td align="center">7128</td>
                                    <td align="center">KGM</td>
                                    <td align="center">1,863,424.26</td>
