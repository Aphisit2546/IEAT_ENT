...
<div class="row">
    <form name"frm" id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        ...
        <input type="hidden" name="TypeChangeMoney" id="TypeChangeMoney" value="Y" />
        <?= csrf_field() ?>
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <td class="align-top text-left"><b>งบประมาณที่ได้รับการจัดสรร คงเหลือ (บาท)</b></td>
                    <td class="align-top text-center"><?= number_format($data["Budget02_remaining"], 2) ?></td>
                </tr>
            </tbody>
        </table>
        <div class="class_header_page_03">
            รายละเอียดงวดงานและงวดเงิน (ปรับแผน)
        </div>
        <table>
            <tr>
