...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="UnitManagement_id" id="UnitManagement_id" value="<?php echo $data['UnitManagement_id']; ?>" readonly />
        <?= csrf_field() ?>
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        รหัสอ้างอิง
                        <input type="text" class='form-control' name="UnitCode" id="UnitCode" value="<?php echo $data['UnitCode']; ?>" readonly />
                    </div>
                    <div class="col-3">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-4">
                        ประเภทหน่วยนับ
                        <?php echo form_dropdown('UnitType', $dropdown_unit_type, $data["UnitType"], "class='form form-control' "); ?>
                    </div>
                </div>
            </div>
        </div>
