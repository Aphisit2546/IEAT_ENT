...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_05_cancel_nontax" style="color: #6007b3ff; font-size: 18px;"><b>คำขอยกเลิกสิทธิประโยชน์ที่ไม่เกี่ยวกับภาษีอากร</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอยกเลิกสิทธิประโยชน์ที่ไม่เกี่ยวกับภาษีอากร</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>คำขอยกเลิกสิทธิประโยชน์ด้านไม่เกี่ยวกับภาษีอากร</b></span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        <td>เลือกแบบคำขอสิทธิประโยชน์ด้านไม่เกี่ยวกับภาษีอากร ที่ต้องการยกเลิก</td>
                                    ...
                                    <tr>
                                        <td class="align-middle">กรอกเลขที่ อก. หรือ</td>
                                        <td class="text-center align-middle">
                                            <input type="text" class="form-control" name="lname[]" placeholder="">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="align-middle">กรอกเลขที่คำขอของใบอนุญาต</td>
                                        <td class="text-center align-middle">
                                            <input type="text" class="form-control" name="lname[]" placeholder="">
                                        </td>
                                    </tr>
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>แสดงรายการที่ค้นหา</b></span>
                        </div>
                        <div class="table-responsive div_header p-4">
                            <table class="table table-bordered" id="datatable01">
                                <thead>
                                    <tr>
                                        <th class="table-head-tab text-center"><b>ลำดับ</b></th>
                                        <th class="table-head-tab text-center"><b>ประเภทที่นำเข้า</b></th>
                                        <th class="table-head-tab text-center"><b>พิกัดศุลกากร (12 หลัก)</b></th>
                                        <th class="table-head-tab text-center"><b>เลขสถิติ (3 หลัก)</b></th>
                                        <th class="table-head-tab text-center"><b>หมายเลข Invoice</b></th>
                                        <th class="table-head-tab text-center"><b>วันที่</b></th>
                                        <th class="table-head-tab text-center"><b>ลำดับรายการตาม Invoice</b></th>
                                        <th class="table-head-tab text-center"><b>รายละเอียด (ภาษาอังกฤษ)</b></th>
                                        <th class="table-head-tab text-center"><b>รายละเอียด (ภาษาไทย)</b></th>
                                        <th class="table-head-tab text-center"><b>จำนวน</b></th>
                                        <th class="table-head-tab text-center"><b>หน่วยนับ</b></th>
                                        <th class="table-head-tab text-center"><b>น้ำหนัก</b></th>
                                        <th class="table-head-tab text-center"><b>หน่วยนับ</b></th>
                                        <th class="table-head-tab text-center"><b>ราคา (บาท)</b></th>
                                        <th class="table-head-tab text-center"><b>วัตถุประสงค์ในการนำของเข้าเขตประกอบการเสรี</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="text-center">1.</td>
                                        <td class="text-center">A-001</td>
                                        <td class="text-center">111111111111</td>
                                        ...
                                        <td class="text-center">ลิตร</td>
                                        <td class="text-center">100</td>
                                        <td class="text-center">ไม่มี</td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">2.</td>
                                        <td class="text-center">A-002</td>
                                        <td class="text-center">222222222222</td>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหนังสือเดินทางช่างฝีมือ ผู้ชำนาญการ (หน้าแรก, หน้าวีซ่า Non-B, หน้าประทับตราขาเข้าด่าน ตม. ครั้งล่าสุด, หน้าบัตร TM.6)</td>                                       
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. สำเนาใบอนุญาตทำงาน (หน้าแรก, หน้าที่มีชื่อบริษัท/ชื่อตำแหน่ง/หน้าที่อนุญาตตามหนังสือ กนอ. และหน้าที่มีการเปลี่ยนแปลง)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
