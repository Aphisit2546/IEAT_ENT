                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="table-responsive div_header p-4">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <?php else: ?>
                                                    <input type="radio" id="past_expansion_status_view_show" name="past_expansion_status_view" value="1" />
                                                <?php endif; ?>
                                                ไม่เคย
                                                <br /><br />
                                                ...
                                                <?php else: ?>
                                                    <input type="radio" id="past_expansion_status_view_show" name="past_expansion_status_view" value="2" />
                                                <?php endif; ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="table-responsive div_header p-4">
                                            ...
                                            <br />
                                            <div class="col-lg-12">
                                                <input type="checkbox" id="building_expansion_status_view" name="building_expansion_status_view" value="Y" <?php echo $building_checked; ?> />
                                                ขยายโรงงาน โดยก่อสร้างอาคารเพิ่ม หรือดัดแปลงอาคารโรงงานเดิมเพิ่มเติม
                                                <br /><br />
                                                <input type="checkbox" id="machine_expansion_status_view" name="machine_expansion_status_view" value="Y" <?php echo $machine_checked; ?> />
                                ...
                                <div class="table-responsive div_header p-4">
                                    ...
                                    <div class="row row-form">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea rows="3" class="form-control" id="expansion_detail_view" name="expansion_detail_view"><?php echo $datashow['expansion_detail_view']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
