...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_017" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.9 (คำสั่งให้ระงับการใช้พื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่นตามมาตรา 45)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_017</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.9 (คำสั่งให้ระงับการใช้พื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่นตามมาตรา 45)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้ระงับการใช้พื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ<br>
                                และทางเข้าออกของรถเพื่อการอื่นตามมาตรา 45
                            </div>
                        </div>
                        ...
                        <div class="pl-4 mb-2">
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-3">
                                    เจ้าของอาคาร ซึ่งได้รับใบอนุญาตจาก
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">
                                เจ้าพนักงานท้องถิ่น เลขที่
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="address_road">
                            </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    	ปรากฏว่าท่านได้ใช้ ยินยอมให้บุคคลอื่นดัดแปลง หรือใช้พื้นที่ หรือสิ่งที่สร้างขึ้น 
                                        เพื่อใช้เป็น ที่จอดรถ ที่กลับรถ และทางเข้าออกของรถ ทั้งหมด/บางส่วน เพื่อการอื่นดังต่อไปนี้*
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                        ...
                        <div class="pl-4 mb-4">
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                ...
                                ให้ท่านระงับการกระทำดังกล่าวจนกว่าจะได้รับใบอนุญาตหรือใบรับแจ้งจากเจ้าพนักงานท้องถิ่น
                            </div>
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                ทั้งนี้ ตั้งแต่บัดนี้เป็นต้นไป
                            </div>
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                อนึ่ง ผู้ได้รับคําสั่งจากเจ้าพนักงานท้องถิ่นมีสิทธิอุทธรณ์คําสั่งดังกล่าวต่อคณะกรรมการพิจารณา อุทธรณ์ตามมาตรา 52 
                                แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวัน นับแต่วันทราบคําสั่ง โดยทําเป็นหนังสือ และยื่นต่อเจ้าพนักงานท้องถิ่นผู้ออกคําสั่งนี้
                            </div>
                        </div>
