...
<div class="class_header_page_02">
    <br />
    รายงานสรุปโครงการที่มีการปรับแผน
    <hr />
</div>
<div class="row">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        ค้นหาชื่อโครงการ
                        <input name='data_search1' type='text' class='form-control' value='<?php echo $data_search1; ?>'>
                    </div>
                    <div class="col-3">
                        <br />
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="6" class="align-middle text-left">รายงานสรุปโครงการที่มีการปรับแผน</th>
                            </tr>
                            <tr class="align-middle">
