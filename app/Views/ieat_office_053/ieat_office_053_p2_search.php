...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053" style="color: #6007b3ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขอแจ้งช่างฝีมือ ผู้ชำนาญการพ้นจากตำแหน่งและครอบครัว)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>2-1-55-00001/2568</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 2-1-55-00001/2568</b></font>
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอทั่วไป 17-3 (ขอแจ้งช่างฝีมือ ผู้ชำนาญการพ้นจากตำแหน่งและครอบครัว)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>เลือกรายการช่าง</b></span>
                        </div>
                        ...
                        <div class="card-header">
                            <span class="font_header" style="color:red;">
                                <b>*** โปรดปรับปรุงข้อมูลช่าง และครอบครัวให้เป็นปัจจุบัน กรณีมีการเปลี่ยนหนังสือเดินทาง (Passport) มิฉะนั้นจะไม่สามารถดำเนินการต่ออายุได้ ***</b>
                            </span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                        ...
                        <div class="card-header">
                            <span class="font_header" style="color:#a10ddb;">
                                <b>คู่สมรสและบุคคลซึ่งอยู่ในอุปการะของช่างฝีมือ ผู้ชำนาญการ</b>
                            </span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        <th style="vertical-align:top;">ความสัมพันธ์</th>
                                        <th style="vertical-align:top;">คำนำหน้า</th>
                                        <th style="vertical-align:top;">ชื่อตัว–ชื่อรอง–ชื่อสกุล<br>บุคคลต่างด้าวในตำแหน่งที่ขอบรรจุ</th>
                                        <th style="vertical-align:top;">เลขที่<br>หนังสือเดินทาง</th>
                                        <th style="vertical-align:top;">วันที่หนังสือ<br>เดินทางหมดอายุ</th>
                                        <th style="vertical-align:top;">สัญชาติ</th>
                                        <th style="vertical-align:top;">วัน/เดือน/ปีเกิด</th>
                                        <th style="vertical-align:top;">อนุญาตสิ้นสุดวันที่</th>
                                        <th style="vertical-align:top;">หมายเหตุเพิ่มเติมก่อนต่ออายุ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header" style="color:red;">
                                <b>***คลิกดูตัวอย่าง ข้อมูลเลขที่ใบอนุญาตทำงานและวันที่ตามใบอนุญาตทำงาน ***</b>
                            </span>
                        </div>
                        <div class="table-responsive div_header px-4 pb-4">
                            <br>
                            <table class="table table-bordered" style="font-size:14px;">
                                <thead style="text-align:center;">
                                    <tr>
                                        <th style="vertical-align:top;">ใบอนุญาตทำงานเลขที่</th>
                                        <th style="vertical-align:top;">วันที่ออกใบอนุญาตทำงาน(ตั้งแต่วันที่ ...)</th>
                                        <th style="vertical-align:top;">เลขที่หนังสือเดินทาง</th>
                                        <th style="vertical-align:top;">วันที่ออกจากงาน<br>**(ระบุวันที่ล่วงหน้าไม่น้อยกว่า 7 วัน <br>สูงสุดไม่เกิน 30 วัน แต่ไม่เกินวันที่ตามวีซ่าที่ได้รับอนุญาต)**</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="text-align:center;">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">1. สำเนาหนังสือเดินทางของช่างฝีมือ ผู้ชำนาญการ (หน้าแรก, หน้าวีซ่า non-b, หน้า Re-entry Visa, หน้าที่ประทับตราอนุญาตตามหนังสือ กนอ., หน้าประทับตราขาเข้าด่าน ตม. ครั้งล่าสุด, หน้าบัตร TM.6)</td>
                                        <td width="30%">
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">2. สำเนาใบอนุญาตทำงานของช่างฝีมือ ผู้ชำนาญการ (หน้าแรก, หน้าที่มีชื่อบริษัท,หน้าที่มีชื่อตำแหน่ง, หน้าที่อนุญาตตามหนังสือ กนอ.,หน้าที่มีการเปลี่ยนแปลง)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">3. สำเนาใบรับ ตท. 10 (กรณียกเลิกใบอนุญาตทำงานกับจัดหางานแล้ว)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header" width="70%">4. สำเนาหนังสือเดินทางของคู่สมรส และบุคคลซึ่งอยู่ในอุปการะ (รับรองสำเนาถูกต้องโดยครอบครัว)</td>
                                        <td width="30%">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">5. หนังสือมอบอำนาจ พร้อมติดอากรตามกฎหมาย (ถ้ามี)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
                                    ...
                                    <tr>
                                        <td class="table-detail-left radio-header">6. เอกสารอื่น (ถ้ามี)</td>
                                        <td>
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile">
                                                <label class="custom-file-label" for="customFile">อัพโหลดไฟล์ข้อมูล</label>
