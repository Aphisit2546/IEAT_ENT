...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_office_ois_015/p2</b></a>
</div>
<br />
<div class="class_header_page_02 text-center">
    <div class="row row-form mb-3">
        <div class="col-12">
            <span style="color:#000; font-size:25px; font-weight:bold;">
                พิจารณาหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่
                สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น 
                และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น 
    ...
    <div class="row row-form justify-content-center">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 mb-2">
            <div class="div_header_focus p-2">
                <span class="font_header_office_focus"><b>พิจารณา</b></span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-header p-4" style="text-align: center;">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#tab2" data-toggle="tab"><span class="font_header_office_alert"><b><font color='red'>*</font>พิจารณาอนุมัติอนุญาต<font color='red'>*</font></b></span></a></li>
            </ul>
        </div><!-- /.card-header -->
        <div class="card-body">
