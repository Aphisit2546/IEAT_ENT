...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_office_ois_015/p1</b></a>
</div>
<br />
    ...
    <div class="row row-form mb-3">
        <div class="col-12">
            <span style="color:#000; font-size:25px; font-weight:bold;">
                จัดทำหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อ
                ใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น และให้ดำเนินการ
                แก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น ให้กลับคืนสู่สภาพเดิมตามมาตรา 45)
            </span>
        </div>
    </div>
