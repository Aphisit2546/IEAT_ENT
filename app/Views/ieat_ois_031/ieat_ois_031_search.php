...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_031" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.16 (คำสั่งให้รื้อถอนอาคาร แก้ไขเปลี่ยนแปลงอาคาร ดำเนินการเพื่อขจัดหรือระงับเหตุ หรือให้ทำสัญญาเช่าที่ดินตามมาตรา 77 วรรคหนึ่ง)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_031</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.16 (คำสั่งให้รื้อถอนอาคาร แก้ไขเปลี่ยนแปลงอาคาร ดำเนินการเพื่อขจัดหรือระงับเหตุ หรือให้ทำสัญญาเช่าที่ดินตามมาตรา 77 วรรคหนึ่ง)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้รื้อถอนอาคาร แก้ไขเปลี่ยนแปลงอาคาร ดำเนินการเพื่อขจัดหรือระงับเหตุ หรือให้ทำสัญญาเช่าที่ดินตามมาตรา 77 วรรคหนึ่ง
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-auto">
                                เป็นอาคารที่ก่อสร้างในที่ดินที่เป็นสาธารณสมบัติของแผ่นดิน 
                                และได้มีพระราชกฤษฎีกากำหนดเขตปรับปรุงอาคารในท้องที่
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="industrial_estate">
                            </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="mb-2 text-justify" style="text-indent: 40px;">
                                อาศัยอำนาจตามความในมาตรา 77 วรรคหนึ่ง แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 จึงให้ท่านดำเนินการดังนี้
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    รื้อถอนอาคารส่วนที่ก่อสร้างในที่ดินที่เป็นสาธารณสมบัติของแผ่นดิน เพื่อความเป็นระเบียบเรียบร้อยของบ้านเมือง / การพัฒนาท้องถิ่น / ประโยชน์ในการใช้ ดังนี้*
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col">
                                    แก้ไขเปลี่ยนแปลงอาคารให้ถูกต้องตามพระราชกฤษฎีกาดังกล่าวนับแต่วันที่ท่านได้รับคำสั่ง ดังนี้*
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col">
                                    ดำเนินการเพื่อขจัดหรือระงับเหตุ ที่ก่อให้เกิด / อาจก่อให้เกิดสภาพที่ไม่เหมาะสม หรือไม่ปลอดภัยในการอยู่อาศัย 
                                    การป้องกันอัคคีภัย การสาธารณสุข การรักษาคุณภาพสิ่งแวดล้อม การผังเมือง และการอำนวยความสะดวกแก่การจราจร ดังนี้*
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="mb-1 text-justify">
                                ให้แล้วเสร็จภายในกำหนดหกเดือนนับแต่วันที่ท่านได้รับคำสั่งนี้
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                    <input type="checkbox" name="opt1" value="1">
                                ...
                                <div class="col">
                                    ทำสัญญาเช่าที่ดินกับเจ้าพนักงานท้องถิ่นตามระเบียบกระทรวงมหาดไทยว่าด้วย หลักเกณฑ์ 
                                    วิธีการ เงื่อนไข และอัตราค่าเช่าที่ดินที่เป็นสาธารณสมบัติของแผ่นดิน ในเขตปรับปรุงอาคาร
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-md-1">ในท้องที่</div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control form-control-sm" name="address_road">
                                </div>
                                <div class="col-md-2 text-right">ซึ่งประกาศ ณ วันที่</div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control form-control-sm" name="address_tambon">
                                </div>
                            ...
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                อนึ่ง ผู้ได้รับคำสั่งจากเจ้าพนักงานท้องถิ่นมีสิทธิอุทธรณ์คำสั่งดังกล่าวต่อคณะกรรมการ พิจารณาอุทธรณ์ ตามมาตรา 52 
                                แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวันนับแต่ วันทราบคำสั่ง 
                                โดยทำเป็นหนังสือและยืนต่อเจ้าพนักงานท้องถิ่นผู้ออกคำสั่งนี้
                            </div>
                        </div>
