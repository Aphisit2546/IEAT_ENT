...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #6007b3ff; font-size: 18px;"><b>กนอ. 01/1</b></font>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            ...
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>(กนอ. 01/1)</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane" id="tab9">
                            ...
                            <div class="table-responsive div_header p-4">
                                ...
                                <table width='100%' border='0' align='center' cellpadding='3' cellspacing='0' class="table_main_page2">
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' valign='top'><span class="head_detail"><input type="text" size="10" id="datepicker-th-1" name="d010" value="29/04/2568" readonly="readonly" /></font>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            <span class="head_detail">
                                                <textarea name="operation_type" id="operation_type" cols="100" rows="4">ทดสอบ</textarea>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' valign='top'><span class="font_header_detail_red">XXXX&nbsp;(เจ้าหน้าที่ กรุณาระบุข้อมูลในส่วนรายละเอียดข้อมูลที่ดินในหน้าจอด้านล่าง)</span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            <span class="head_detail">
                                                <input type="text" name="d003_before" id="d003_before" value="2(1)" size="15" />
                                                <span class="font_detail_head_content">
                                                    <a href='javascript:void(0);' onclick="window.open('https://epp-ieat.ieat.go.th/new_epp_ieat/popup_all/popup_controller/popup_factory2', '_blank', 'width=800,height=300,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');">เลือกประเภท</a> </span>
                                                <br />
                                                <font style="size:14px; color:red;">**กรณีมีเลขประเภทหรือชนิดโรงงานมากกว่า 1 ให้ใส่เครื่องหมาย , คั่นระหว่างเลข ตัวอย่างเช่น 72, 77(2), 91(1) **</font>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align='left' valign='top'>
                                            <span class="head_detail">
                                                <input type="radio" name="d003_select" id="d003_select" value="1" checked="checked" />&nbsp;ออกเลขทะเบียนผู้ประกอบการอุตสาหกรรม
                                                กรุณาเลือกประเภทโรงงาน&nbsp;<input type="text" name="d003" id="d003" value="2(1)" size="5" readonly />
                                                <a href='javascript:void(0);' onclick="window.open('https://epp-ieat.ieat.go.th/new_epp_ieat/popup_all/popup_controller/popup_factory', '_blank', 'width=800,height=300,scrollbars=yes,status=yes,resizable=yes,screenx=0,screeny=0');">เลือกประเภท</a> <br />
                                                <font style="size:14px; color:red;">**เลขทะเบียนโรงงานจะถูกสร้างจากระบบโดยอัตโนมัติ หลังจากเอกสารได้รับการอนุมัติเป็นที่เรียบร้อยแล้ว**</font>
                                                <br />
                                                <input type="radio" name="d003_select" id="d003_select" value="2" />&nbsp;ไม่ออกเลขทะเบียนผู้ประกอบการอุตสาหกรรม
                    ...
                    <div class="card p-4">
                        <div class="card-header">
                            <span class="font_header"><b>ข้อมูลเกี่ยวกับที่ดิน</b></span>
                        </div>
                        <br />
                        <!-- Table -->
                        <div class="table-responsive div_header p-4">
                            &nbsp;&nbsp;<input type='button' class="btn btn-success" value="เพิ่มข้อมูล (Add)" onClick="addRow01('datatable01')" />
                            &nbsp;&nbsp;<input type='button' class="btn btn-danger" value="ลบข้อมูล (Delete)" onClick="deleteRow01('datatable01')" />
                            <br /><br />
                            <table id="datatable01" class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input style="margin-left:40%" type="checkbox" name="chk" value="<?php echo $land_id_view; ?>" />
                                        </td>
                                        <td>
                                ...
                                <table width='100%' border='0' align='center' cellpadding='10' cellspacing='1'>
                                    <tr>
                                        ...
                                        <td width="94%" height='35' valign='top'>
                                            <span class="font_header_detail"><input type="text" name="pp_000" value="การอนุญาตให้ใช้ที่ดินและประกอบกิจการในนิคมอุตสาหกรรม" size="80" /></span>
                                        </td>
                                    </tr>
                                    <tr>
