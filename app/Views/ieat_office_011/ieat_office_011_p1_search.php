                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <input class='btn btn-success btn-lg btn-block' name="Submit_continue" type="button" id="Submit" value="บันทึกการตรวจสอบคำขอ" onclick="return confirm('บันทึกการตรวจสอบคำขอ !!!')" onclick="window.location='ieat_office_011/p1'" />
                                </div>
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="ส่งผลการตรวจสอบคำขอ" onclick="return confirm('ส่งผลการตรวจสอบคำขอ !!!')" onclick="window.location='ieat_office_011/p2'" />
                                </div>
                            </div>
                        </div>
                    </div>
