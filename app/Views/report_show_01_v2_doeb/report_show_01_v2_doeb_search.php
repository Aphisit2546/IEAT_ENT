...
<div class="class_header_page_02">
    <br />
    รายงานแผนการดำเนินงานต่าง ๆ ที่มีการดำเนินการในระบบ
    <hr />
</div>
<div class="row">
        ...
        <div class="row text-left">
            <div class="col-md-12">
                <div class="form-group row">
                    <div class="col-3">
                        ค้นหาประเภทแผน
                        <?php echo form_dropdown('data_search1', $dropdown_master_plan, $data_search1, "class='form form-control' id='data_search1' "); ?>
                    </div>
                    <div class="col-3">
                        ค้นหาชื่อแผน
                        <input name="data_search2" id='data_search2' type='text' class='form-control' value='<?php echo $data_search2; ?>'>
                    </div>
                    <div class="col-3">
                        <br />
                    ...
                    <table class="table table-bordered table-hover" id='content_csv'>
                        <thead>
                            <tr class="align-middle">
                                <th colspan="6" class="align-middle text-left">รายงานแผนการดำเนินงานต่าง ๆ ที่มีการดำเนินการในระบบ</th>
                            </tr>
                            <tr class="align-middle">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <td class="align-top text-center"><?= $item["seq_data"]; ?></td>
                                        <td class="align-top text-left"><?= $item["PlanName"]; ?></td>
                                        <td class="align-top text-left"><?= $item["TypePlan"]; ?></td>
                                        <td class="align-top text-center"><?= $item["StartFinishPlan"]; ?></td>
                                        <td class="align-top text-center"><?= $item["Count_RelatedStrategies"]; ?></td>
                                        <td class="align-top text-center"><?= $item["Count_RelatedPolicies"]; ?></td>
                                    </tr>
                                <?php
                                endforeach;
                            } else {
