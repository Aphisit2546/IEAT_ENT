...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ent_053_7" style="color: #6007b3ff; font-size: 18px;"><b>คำขอเปลี่ยนที่ตั้งสถานประกอบการ</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
...
<div class="class_header_page_02">
    ...
    &nbsp;&nbsp;
    <font style="color: #000000ff; font-size: 18px;"><b>คำขอเปลี่ยนที่ตั้งสถานประกอบการ</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                        ...
                        <div class="table-responsive div_header px-4 pb-4">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>ที่อยู่บ้าน/สำนักงานเลขที่ (Office location No)</td>
                                        <td class="text-center align-middle">
                                    ...
                                    <tr>
                                        <td>ชื่อนิคมอุตสาหกรรม (Industrial Estate)</td>
                                        <td class="text-center align-middle">
                                            <select class="form-control" name="foreign_nationality[]">
                                                <option value="">-- เลือก --</option>
                                            </select>
                                    ...
                                    <tr>
                                        <td>สำนักงานทะเบียนหุ้นส่วนบริษัท</td>
                                        <td class="text-center align-middle">
                                            <select class="form-control" name="foreign_nationality[]">
                                                <option value="">-- เลือก --</option>
                                            </select>
