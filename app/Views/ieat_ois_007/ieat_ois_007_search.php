...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_007" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.4 (คำสั่งห้ามใช้หรือเข้าไปในส่วนใดๆ ของอาคารหรือบริเวณที่มีการก่อสร้าง การดัดแปลง การรื้อถอน หรือการเคลื่อนย้ายอาคารตามมาตรา 40 (2))</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_007</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.4 (คำสั่งห้ามใช้หรือเข้าไปในส่วนใดๆ ของอาคารหรือบริเวณที่มีการก่อสร้าง การดัดแปลง การรื้อถอน หรือการเคลื่อนย้ายอาคารตามมาตรา 40 (2))</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งห้ามใช้หรือเข้าไปในส่วนใดๆ ของอาคารหรือบริเวณที่มีการก่อสร้าง การดัดแปลง การรื้อถอน หรือการเคลื่อนย้ายอาคารตามมาตรา 40 (2)
                            </div>
                        </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    อันเป็นการฝ่าฝืนมาตรา 21 มาตรา 22 หรือมาตรา 31 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ตามรายละเอียด ต่อไปนี้ *
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <input type="text" class="form-control form-control-sm" name="address_amphur">
                            ...
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    อาศัยอํานาจตามความในมาตรา 40 (2) แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 
                                    ห้ามมิให้ท่านและบุคคลใดใช้ หรือเข้าไปในส่วนใดของอาคาร หรือบริเวณที่มีการกระทำดังนี้ **
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <input type="text" class="form-control form-control-sm" name="address_amphur">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <div>
                                    จนกว่าจะได้รับใบอนุญาตหรือใบรับแจ้งจากเจ้าพนักงานท้องถิ่น
                                </div>
                            </div>
                            <div class="d-flex mb-2">
                                <div class="mr-2">
                                ...
                                <div>
                                    จนกว่าจะได้ดําเนินการแก้ไขเปลี่ยนแปลงให้ถูกต้องตามที่ได้รับใบอนุญาตหรือใบรับแจ้ง จากเจ้าพนักงานท้องถิ่น
                                </div>
                            </div>
                            <div class="d-flex mb-2">
                                <div>
                            ...
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                    ...
                                    อุทธรณ์ตามมาตรา 52 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวันนับแต่วันทราบคําสั่ง 
                                    โดยทําเป็น หนังสือและยื่นต่อเจ้าพนักงานท้องถิ่นผู้ออกคําสั่งนี้
                            </div>
                        </div>
