...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <font style="color: #000000ff; font-size: 18px;"><b>1-01-1-13-00001-2568</b></font>
</div>
<br />
<div class="class_header_page_02">
    ...
    <div class="row row-form">
        <div class="col-lg-4">
            <font style="color: #000000ff; font-size: 25px;"><b>คำขอ 1-01-1-13-00001-2568</b></font>
            &nbsp;&nbsp;
            <font style="color: #000000ff; font-size: 18px;"><b>ยกเลิก TAX Incentive</b></font>
            &nbsp;&nbsp;
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <input class='btn btn-primary btn-lg btn-block' name="Submit_approve" type="button" id="Submit" value="พิจารณาอนุมัติอนุญาต" onclick="window.location='ieat_office_canceltaxincentive/otp'" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="tab2">
                    <div class="table-responsive div_header p-4">
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>วัตถุประสงค์ในการขอยกเลิกเลข TAX Incentive</td>
                                    <td>
                                        เนื่องจากมีการเพิ่มประเภทกิจการเข้าไปในระบบเรียบร้อยแล้ว และใช้เลขสิทธิประโยชน์ใหม่เรียบร้อยแล้ว จึงจะขอยกเลิกเลขสิทธิประโยชน์เดิมค่ะ
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left radio-header">เอกสารอื่นๆที่เกี่ยวข้อง</td>
                                        <td>
