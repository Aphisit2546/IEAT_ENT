                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="align-top text-left"><?= $item["GroupNameTH"]; ?></td>
                                        <td class="align-top text-left"><?= $item["GroupNameEN"]; ?></td>
                                        ...
                                        <td class="align-top text-center">
                                            <a id="btnEdit" class="btn btn-warning" href="<?= $routeGroup ?>/edt/<?= $item["GroupID"] ?>"><i class="fas fa-edit"></i> แก้ไข</a>
                                            <a id="btnEdit" class="btn btn-danger" href="<?= $routeGroup ?>/del/<?= $item["GroupID"] ?>"><i class="fas fa-edit"></i> ลบ</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
