...
<div class="class_header_page_02">
    ...
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a href="ieat_ois_015" style="color: #6007b3ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น ให้กลับคืนสู่สภาพเดิมตามมาตรา 45)</b></a>
    <b>&nbsp;&nbsp;/&nbsp;&nbsp;</b>
    <a style="color: #000000ff; font-size: 18px;"><b>ieat_ois_015</b></a>
</div>
<br />
<div class="class_header_page_02">
    <font style="color: #000000ff; font-size: 18px;"><b>จัดทำหนังสือคำสั่ง ค.8 (คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น ให้กลับคืนสู่สภาพเดิมตามมาตรา 45)</b></font>
</div>
<br /><br />
<div class="col-md-12">
    <div class="card">
                    ...
                    <div>
                        <div class="text-center mb-4">
                            ...
                            <div style="font-weight: bold; font-size: 1.1em;">
                                คำสั่งให้ระงับการดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อ<br>
                                การอื่น และให้ดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้น<br>
                                ให้กลับคืนสู่สภาพเดิมตามมาตรา 45
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="occupier" id="chk_occupier1">
                                    <label class="form-check-label" for="chk_occupier1">ผู้ครอบครองพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ และทางเข้าออกของรถเพื่อการอื่น</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-4 mb-2">
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-3">
                                    เจ้าของอาคารซึ่งได้รับใบอนุญาต/ใบรับแจ้งจากเจ้า
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-2">
                                พนักงานท้องถิ่น เลขที่
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control form-control-sm" name="address_road">
                            </div>
                        ...
                        <div class="row mb-2 align-items-center">
                            <div class="col-md-7">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="build" id="chk_build">
                                    <label class="form-check-label" for="chk_build">ก่อสร้างอาคาร</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="modify" id="chk_modify">
                                    <label class="form-check-label" for="chk_modify">ดัดแปลงอาคาร</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="applicant_status[]" value="move" id="chk_move">
                                    <label class="form-check-label" for="chk_move">เคลื่อนย้ายอาคาร</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-2">
                                <div class="mb-1 text-justify">
                                    ซึ่งเป็นอาคารชนิดหรือประเภทที่ต้องมีพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ 
                                    ที่กลับรถ และทางเข้าออก ของรถตามมาตรา 8 (9) แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 นั้น
                                </div>
                            </div>
                        ...
                        <div class="pl-4 mb-4">
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify" style="text-indent: 40px;">
                                    	ปรากฏว่าท่านได้ดัดแปลงพื้นที่หรือสิ่งที่สร้างขึ้นเพื่อใช้เป็นที่จอดรถ ที่กลับรถ 
                                        และทางเข้าออก ของรถทั้งหมด/บางส่วน เพื่อการอื่นดังต่อไปนี้ *
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col">
                            ...
                            <div class="d-flex mb-2">
                                <div class="mb-1 text-justify">
                                    	โดยเจ้าของอาคารหรือผู้ครอบครองอาคารไม่ได้รับใบอนุญาตหรือใบรับแจ้งตามมาตรา 34 
                        ...
                        <div class="pl-4 mb-4">
                            <div class="row mb-2">
                                <div class="col" style="text-indent: 40px;">
                                    อาศัยอำนาจตามความในมาตรา 45 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 
                                    ให้ท่านระงับการกระทำดังกล่าวและดำเนินการแก้ไขเปลี่ยนแปลงพื้นที่หรือสิ่งที่สร้างขึ้นให้กลับคืนสู่สภาพเดิม
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ) วัน** นับแต่วันที่ท่านได้รับคำสั่งนี้ หากพ้นกำหนดนี้แล้ว จะดำเนินการตามกฎหมายต่อไป
                                </div>
                            </div>
                            <div class="mb-5 text-justify" style="text-indent: 40px;">
                                	อนึ่ง ผู้ได้รับคําสั่งจากเจ้าพนักงานท้องถิ่นมีสิทธิอุทธรณ์คําสั่งดังกล่าวต่อคณะกรรมการพิจารณา 
                                    อุทธรณ์ตามมาตรา 52 แห่งพระราชบัญญัติควบคุมอาคาร พ.ศ. 2522 ภายในสามสิบวัน 
                                    นับแต่วันทราบคําสั่ง โดยทําเป็นหนังสือ และยื่นต่อเจ้าพนักงานท้องถิ่นผู้ออกคําสั่งนี้
                            </div>
                        </div>
