                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">ลักษณะพื้นที่ที่คืนสิทธิ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            โอนกรรมสิทธิ์ในที่ดิน
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">ลักษณะการคืนสิทธิ</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                            ที่ดินพร้อมอาคาร
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="table-detail-left col-xs-4 col-sm-4 col-md-4 col-lg-4">คืนสิทธิให้ที่ดินแก่</td>
                                        <td class="table-detail-left col-xs-8 col-sm-8 col-md-8 col-lg-8">
                        ...
                        <div class="panel-heading">
                            <span class="font_header">แปลงที่ดินและเนื้อที่ที่ประสงค์จะคืนสิทธิ</span>
                        </div>
                        <div class="table-responsive div_header p-4">
