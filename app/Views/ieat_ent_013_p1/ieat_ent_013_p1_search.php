                    ...
                    <div class="card p-4">
                        ...
                        <div class="table-responsive div_header p-4">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea rows="3" class="form-control" id="new_operation_type" name="new_operation_type"><?php echo $datashow['new_operation_type']; ?></textarea>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th colspan="2" style="text-align: center;"><span class="font_header_detail"><b>โปรดแนบเอกสารเพื่อประกอบการพิจารณา : แก้ไขข้อความการประกอบกิจการ</b></span></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
