...
<div class="row">
    <form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
        <input type="hidden" name="AllPlanId" id="AllPlanId" value="<?php echo $data['AllPlanId']; ?>" readonly />
        <?= csrf_field() ?>
        <?php if (!empty($data['AllPlanId'])): ?>
            <hr />
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="scrollmenu">
                                                <table class="table table-bordered" id="datatable1">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        foreach ($OverAllPlanStrategyWorkMoneyPeriod as $result_data_set1):
                                                        ?>
                                                            <tr>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <table class="table table-bordered" id="datatable2">
                                            ...
                                            <?php
                                            foreach ($OverAllPlanStrategyDeliver as $result_data_set2):
                                            ?>
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <span class="detail">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <table class="table table-bordered" id="datatable3">
                                            ...
                                            <?php
                                            foreach ($OverAllPlanStrategyDocument as $result_data_set3):
                                            ?>
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <span class="detail">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="scrollmenu">
                                            <table class="table table-bordered" id="datatable4">
                                                ...
                                                <?php
                                                foreach ($OverAllPlanStrategyTargetKPI as $result_data_set4):
                                                ?>
                                                    <tr>
                                                        <td align="left" valign="middle">
                                                            <span class="detail">
