...
<form id="frm" class="form-horizontal" action="<?php echo base_url(); ?>/<?= $routeGroup ?>/<?= $action_page ?>" method="post">
    ...
    -->
    <div class="form-group row">
        <div class="class_header_page_03">งบลงทุน</div>
        <br /><br />
        <table class="table table-bordered" id="datatable1">
            ...
            <?php
            if (!empty($data_main['return_data_Group1'])):
                $count_data_use = count($data_main['return_data_Group1']);
                $seq = 1;
                foreach ($data_main['return_data_Group1'] as $result_data_set1):
            ?>
                    <tr>
                        <td align="left" valign="middle"><?php echo $seq++; ?>.</td>
                        <td align="left" valign="middle">
                            <span class="detail">
                                <?php echo $result_data_set1['ItemL1ProjectName']; ?>
                            </span>
                        </td>
                        <td align="left" valign="middle">
                            <span class="detail">
                                <?php echo $result_data_set1['ItemL2ProjectName']; ?>
                            </span>
                        </td>
                        <td align="left" valign="middle">
                            <span class="detail">
                                <?php echo $result_data_set1['ItemL3ProjectName']; ?>
                            </span>
                        </td>
                        <td align="left" valign="middle">
                            <span class="detail">
        ...
        <hr />
        <div class="class_header_page_03">งบดำเนินการ</div>
        <br /><br />
        <table class="table table-bordered" id="datatable1">
            <tr class="bg_th">
                <th class="text-center">
            ...
            <?php
            if (!empty($data_main['return_data_Group2'])):
                $count_data_use = count($data_main['return_data_Group2']);
                $seq = 1;
                foreach ($data_main['return_data_Group2'] as $result_data_set1):
            ?>
                    <tr>
                        <td align="left" valign="middle"><?php echo $seq++; ?>.</td>
                        <td align="left" valign="middle">
        ...
        <hr />
        <div class="class_header_page_03">งบค่าใช้จ่ายอื่นๆ</div>
        <br /><br />
        <table class="table table-bordered" id="datatable1">
            <tr class="bg_th">
                <th class="text-center">
            ...
            <?php
            if (!empty($data_main['return_data_Group3'])):
                $count_data_use = count($data_main['return_data_Group3']);
                $seq = 1;
                foreach ($data_main['return_data_Group3'] as $result_data_set1):
            ?>
                    <tr>
                        <td align="left" valign="middle"><?php echo $seq++; ?>.</td>
                        <td align="left" valign="middle">
