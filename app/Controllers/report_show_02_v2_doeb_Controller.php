...
class report_show_02_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_02_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปความคืบหน้าตามแผนและตัวชี้วัด"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow02v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปความคืบหน้าตามแผนและตัวชี้วัด" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปความคืบหน้าตามแผนและตัวชี้วัด" . date('d-m-Y_H-i-s');
