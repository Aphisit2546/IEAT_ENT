...
class report_show_04_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_04_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปคำของบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณและแหล่งงบประมาณ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow04v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปคำของบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณและแหล่งงบประมาณ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปคำของบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณและแหล่งงบประมาณ" . date('d-m-Y_H-i-s');
