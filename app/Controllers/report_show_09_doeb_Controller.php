...
class report_show_09_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_09_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปข้อมูลการนัดหมายตามช่วงเวลาที่สนใจ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow09Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปข้อมูลการนัดหมายตามช่วงเวลาที่สนใจ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปข้อมูลการนัดหมายตามช่วงเวลาที่สนใจ" . date('d-m-Y_H-i-s');
