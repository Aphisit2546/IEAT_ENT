...
use App\Models\budget_management;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;


class budget_management_Controller extends BaseController
{
	protected $programCode = "budget_management";
	...
	public function __construct()
	{
		...
		$this->model = new budget_management();
	...
	public function index()
	{
		...
		foreach ($lstData as $lstData) {
			...
			$final_data[] = array(
				"budget_management_id" => $lstData['budget_management_id'],
	...
	public function update()
	{
		...
		$this->model->update($input['budget_management_id'], $postData);
	...
	public function delete($value)
	{
		// iclude helper form
		helper("form");
		$this->model->delete_budget_management($value);
		/*
