...
class report_show_01_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_01_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานแผนการดำเนินงานต่าง ๆ ที่มีการดำเนินการในระบบ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow01v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานแผนการดำเนินงานต่าง ๆ ที่มีการดำเนินการในระบบ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_csv'] != '' && $input['search_csv'] != null) {
			...
			/*
			$filename = "รายงานแผนการดำเนินงานต่าง ๆ ที่มีการดำเนินการในระบบ" . date('d-m-Y_H-i-s');
