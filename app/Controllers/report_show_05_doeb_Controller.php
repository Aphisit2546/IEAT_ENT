...
class report_show_05_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_05_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปงบประมาณเบิกจ่ายแทนกันสพจ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow05Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปงบประมาณเบิกจ่ายแทนกันสพจ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปงบประมาณเบิกจ่ายแทนกันสพจ" . date('d-m-Y_H-i-s');
