...
class unit_doeb_Controller extends BaseController
{
	protected $programCode = "unit_doeb";
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/UnitDoeb', [
	...
	public function store()
	{
		...
		$client = new Client();
		$res = $client->post(Env("app.RestBaseURL") . '/api/UnitDoeb', [
			"body" => json_encode($input)
		]);
	...
	public function edit($value)
	{
		...
		$client = new Client();
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/UnitDoeb/' . $value . '/edit');
		$data = $res->getBody()->getContents('json');
		$data = json_decode($data, true);
	...
	public function update()
	{
		...
		$input = $this->request->getRawInput();
		$client = new Client();
		$res = $client->put(Env("app.RestBaseURL") . '/api/UnitDoeb/' . $input['UnitManagement_id'], [
			"body" => json_encode($input)
		]);
	...
	public function delete($id)
	{
		...
		helper("form");
		$client = new Client();
		$client->delete(Env("app.RestBaseURL") . '/api/UnitDoeb/' . $id, [
			"body" => json_encode($id)
		]);
