...
class report_show_05_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_05_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปการจัดสรรงบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow05v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปการจัดสรรงบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปการจัดสรรงบประมาณประจำปีแยกตามประเภทรายจ่ายตามงบประมาณหรือหมวดหมู่ของงบประมาณ" . date('d-m-Y_H-i-s');
