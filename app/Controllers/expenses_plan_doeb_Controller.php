...
class expenses_plan_doeb_Controller extends BaseController
{
	protected $programCode = "expenses_plan_doeb";
	...
	public function update()
	{
		...
		$this->model->update($input['plan_doeb_id'], $postData);
	...
	public function delete($value)
	{
		// iclude helper form
		helper("form");
		$this->model->delete_plan_doeb($value);
		/*
