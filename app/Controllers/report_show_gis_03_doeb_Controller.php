...
class report_show_gis_03_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_gis_03_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสถิติน่าสนใจประกอบการวางแผนยุทธศาสตร์"
		];
	}
