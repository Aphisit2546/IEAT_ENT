...
class inspec_plan_doeb_Controller extends BaseController
{
	protected $programCode = "inspec_plan_doeb";
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/InspecPlanDoeb', [
	...
	public function update()
	{
		...
		$client = new Client();
		$res = $client->put(Env("app.RestBaseURL") . '/api/InspecPlanDoeb/' . $input['CreatePlan_id'], [
			"body" => json_encode($input)
		]);
		$data = $res->getBody()->getContents('json');
		$data = json_decode($data, true);
