...
class Allocate_Budget_doeb_Controller extends BaseController
{
	...
	public function update()
	{
		...
		foreach ($input["count_data_03"] as $count_data_03) {
			...
			$DraftBudgetControlDetailSub_id_Type3 = $input["DraftBudgetControlDetailSub_id_Type3_" . $count_data_03];
			...
			$input_detail_03 = array(
				...
				'DraftBudgetControlDetailSub_id' => $DraftBudgetControlDetailSub_id_Type3,
			);

			//print_r($input_detail_03);
			//echo "<hr />";

			$res = $client->put(Env("app.RestBaseURL") . '/api/CreateBudgetControlDetailType2Doeb/' . $DraftBudgetControlDetailSub_id_Type3, [
		...
		foreach ($input["count_data_04"] as $count_data_04) {
			...
			$DraftBudgetControlDetailSub_id_Type4 = $input["DraftBudgetControlDetailSub_id_Type4_" . $count_data_04];
			...
			$input_detail_04 = array(
				...
				'DraftBudgetControlDetailSub_id' => $DraftBudgetControlDetailSub_id_Type4,
			);

			$res = $client->put(Env("app.RestBaseURL") . '/api/CreateBudgetControlDetailType2Doeb/' . $DraftBudgetControlDetailSub_id_Type4, [
