...
class monthly_progress_Controller extends BaseController
{
	protected $programCode = "monthly_progress";
	...
	public function index()
	{
		...
		foreach ($lstData as $lstData) {
			...
			$final_data[] = array(
				"monthly_progress_id" => $lstData['monthly_progress_id'],
	...
	public function add()
	{
		...
		$arrproject = array(
			[
				"project_id" => "1",
				"project_name" => "โครงการ 1"
			],
			[
				"project_id" => "2",
				"project_name" => "โครงการ 2"
			],
			[
				"project_id" => "3",
				"project_name" => "โครงการ 3"
			]

		);

		$this->pageData['project'] = $arrproject;
	...
	public function update()
	{
		...
		$this->model->update($input['monthly_progress_id'], $postData);
	...
	public function delete($value)
	{
		// iclude helper form
		helper("form");
		$this->model->delete_monthly_progress($value);
		/*
