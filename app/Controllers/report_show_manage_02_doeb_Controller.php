...
class report_show_manage_02_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_manage_02_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานผลการปฏิบัติงานตามปีงบประมาณ"
		];
	}
