...
class groupuseraccressprogram_doeb_Controller extends BaseController
{
	protected $programCode = "groupuseraccressprogram_doeb";
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/GroupUserDoeb', [
	...
	public function add()
	{
		...
		$this->pageData['dropdown_unit_type'] = $this->dropdown->dropdown_unit_type();
	...
	public function store()
	{
		...
		$client = new Client();
		$res = $client->post(Env("app.RestBaseURL") . '/api/GroupUserAccressProgramDoeb', [
			"body" => json_encode($input)
		]);
	...
	public function edit($value)
	{
		...
		$client = new Client();
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/GroupUserAccressProgramDoeb/' . $value . '/edit');
		$data = $res->getBody()->getContents('json');
		$data = json_decode($data, true);
	...
	public function update()
	{
		...
		$input = $this->request->getRawInput();
		$client = new Client();
		$res = $client->put(Env("app.RestBaseURL") . '/api/GroupUserAccressProgramDoeb/' . $input['GroupID'], [
			"body" => json_encode($input)
		]);
	...
	public function delete($id)
	{
		...
		helper("form");
		$client = new Client();
		$client->delete(Env("app.RestBaseURL") . '/api/GroupUserAccressProgramDoeb/' . $id, [
			"body" => json_encode($id)
		]);
