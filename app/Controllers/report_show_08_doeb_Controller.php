...
class report_show_08_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_08_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปผลการจัดทำQR Code ผ่านระบบ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow08Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปผลการจัดทำQR_Code_ผ่านระบบ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปผลการจัดทำQR_Code_ผ่านระบบ" . date('d-m-Y_H-i-s');
