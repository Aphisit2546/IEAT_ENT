...
class report_show_gis_01_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_gis_01_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานภาพรวมงานยุทธศาสตร์และแผนงาน"
		];
	}
