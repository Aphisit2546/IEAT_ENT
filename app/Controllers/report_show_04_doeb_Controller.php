...
class report_show_04_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_04_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปสถานะโครงการตามปีงบประมาณ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow04Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปสถานะโครงการตามปีงบประมาณ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปสถานะโครงการตามปีงบประมาณ" . date('d-m-Y_H-i-s');
