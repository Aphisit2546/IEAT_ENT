...
class report_show_10_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_10_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานผลการพิจารณารายงานทางด้านสิ่งแวดล้อม (ER/MR)"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow10Doeb', [
		...
		$this->pageData["filename"] = "รายงานผลการพิจารณารายงานทางด้านสิ่งแวดล้อม(ER-MR)" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานผลการพิจารณารายงานทางด้านสิ่งแวดล้อม(ER-MR)" . date('d-m-Y_H-i-s');
