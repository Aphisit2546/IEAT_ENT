...
class groupuser_doeb_Controller extends BaseController
{
	protected $programCode = "groupuser_doeb";
	...
	public function update()
	{
		...
		$input = $this->request->getRawInput();
		$client = new Client();
		$res = $client->put(Env("app.RestBaseURL") . '/api/GroupUserDoeb/' . $input['GroupID'], [
			"body" => json_encode($input)
		]);
