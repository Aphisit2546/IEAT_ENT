...
class tracking_02_doeb_Controller extends BaseController
{
	protected $programCode = "tracking_02_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "ติดตามงานภายในกรมธุรกิจพลังงาน"
		];
	}
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/MonthlyPlanBudgetActivityTrackingDoeb', [
