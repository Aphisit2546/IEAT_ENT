...
use App\Models\calendar_doeb;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;


class calendar_doeb_Controller extends BaseController
{
	protected $programCode = "calendar_doeb";
	...
	public function index()
	{
		...
		foreach ($lstData as $lstData) {
			...
			switch ($lstData['type_calendar']) {
				case '1':
					$type_calendar = "<font color='brown'><b>เผยแพร่สาธารณะ</b></font>";
					break;
				case '2':
					$type_calendar = "<font color='brown'><b>เฉพาะในหน่วยงาน</b></font>";
					break;
				case '3':
					$type_calendar = "<font color='brown'><b>เฉพาะกอง</b></font>";
					break;
				default:
					$type_calendar = "-";
					break;
			...
			$final_data[] = array(
				"calendar_doeb_id" => $lstData['calendar_doeb_id'],
	...
	public function store()
	{
		...
		try {
			...
			$postData = [
				...
				"type_calendar" => $input['type_calendar'],
	...
	public function update()
	{
		...
		$this->model->update($input['calendar_doeb_id'], $postData);
	...
	public function delete($value)
	{
		// iclude helper form
		helper("form");
		$this->model->delete_calendar_doeb($value);
		/*
