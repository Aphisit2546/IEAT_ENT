...
class report_show_06_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_06_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงาสรุปข้อมูลกิจกรรมที่น่าสนใจของหน่วยงาน(ปฏิทินกิจกรรม)"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow06Doeb', [
		...
		$this->pageData["filename"] = "รายงาสรุปข้อมูลกิจกรรมที่น่าสนใจของหน่วยงาน(ปฏิทินกิจกรรม)" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงาสรุปข้อมูลกิจกรรมที่น่าสนใจของหน่วยงาน(ปฏิทินกิจกรรม)" . date('d-m-Y_H-i-s');
