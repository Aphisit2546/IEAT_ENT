...
use App\Models\ReportForTypeFire;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;

class ReportForTypeFireController extends BaseController
{
	protected $programCode = "REPORT_FOR_TYPE_FIRE";
	protected $model;
	protected $dropdown;
	protected $pageData;
	protected $pageName;
	...
	{
		$this->model = new ReportForTypeFire();
		...
		$this->pageData = [
			...
			"menuName" => "จัดทำข้อมูลบัญชีโรงงานที่มีความเสี่ยงอัคคีภัย",
