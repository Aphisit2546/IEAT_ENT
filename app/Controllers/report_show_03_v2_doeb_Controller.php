...
class report_show_03_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_03_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปโครงการที่มีการปรับแผน"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow03v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปโครงการที่มีการปรับแผน" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปโครงการที่มีการปรับแผน" . date('d-m-Y_H-i-s');
