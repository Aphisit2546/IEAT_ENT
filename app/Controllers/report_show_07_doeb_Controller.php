...
class report_show_07_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_07_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปผลการจัดทำแบบฟอร์มลงทะเบียนผ่านระบบ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow07Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปผลการจัดทำแบบฟอร์มลงทะเบียนผ่านระบบ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปผลการจัดทำแบบฟอร์มลงทะเบียนผ่านระบบ" . date('d-m-Y_H-i-s');
