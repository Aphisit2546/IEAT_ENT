...
class report_show_01_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_01_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปค่าใช้จ่ายตามแผนปฏิบัติราชการ 5 ปี"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow01Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปค่าใช้จ่ายตามแผนปฏิบัติราชการ5ปี" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปค่าใช้จ่ายตามแผนปฏิบัติราชการ5ปี" . date('d-m-Y_H-i-s');
