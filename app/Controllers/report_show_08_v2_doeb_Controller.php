...
class report_show_08_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_08_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานต้นทุนหน่วยปฏิบัติ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow08v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานต้นทุนหน่วยปฏิบัติ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานต้นทุนหน่วยปฏิบัติ" . date('d-m-Y_H-i-s');
