...
class report_show_10_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_10_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานการโอนเปลี่ยนแปลงงบประมาณและการจัดสรรงบประมาณเหลือจ่าย"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow10v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานการโอนเปลี่ยนแปลงงบประมาณและการจัดสรรงบประมาณเหลือจ่าย" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานการโอนเปลี่ยนแปลงงบประมาณและการจัดสรรงบประมาณเหลือจ่าย" . date('d-m-Y_H-i-s');
