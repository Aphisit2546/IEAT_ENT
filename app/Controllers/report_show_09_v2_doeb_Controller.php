...
class report_show_09_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_09_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานโครงการที่ต้องเฝ้าระวังเป็นพิเศษ"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow09v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานโครงการที่ต้องเฝ้าระวังเป็นพิเศษ" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานโครงการที่ต้องเฝ้าระวังเป็นพิเศษ" . date('d-m-Y_H-i-s');
