...
class report_show_manage_01_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_manage_01_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปผลการใช้จ่ายงบประมาณ เบิกจ่ายแทนกันของสำนักงาน พลังงานจังหวัดรายเดือน"
		];
	}
