...
class report_show_07_v2_doeb_Controller extends BaseController
{
	protected $programCode = "report_show_07_v2_doeb";
	...
	public function __construct()
	{
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปโครงการที่ล่าช้ากว่าเกณฑ์ดัชนีชี้วัด"
		];
	}
	...
	public function index()
	{
		...
		$res = $client->request('GET', Env("app.RestBaseURL") . '/api/ReportShow07v2Doeb', [
		...
		$this->pageData["filename"] = "รายงานสรุปโครงการที่ล่าช้ากว่าเกณฑ์ดัชนีชี้วัด" . date('d-m-Y_H-i-s');
		...
		if ($input['search_json'] != '' && $input['search_json'] != null) {
			...
			$filename = "รายงานสรุปโครงการที่ล่าช้ากว่าเกณฑ์ดัชนีชี้วัด" . date('d-m-Y_H-i-s');
