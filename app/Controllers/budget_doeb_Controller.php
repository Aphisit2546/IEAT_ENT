...
use App\Models\budget_doeb;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;


class budget_doeb_Controller extends BaseController
{
	protected $programCode = "budget_doeb";
	...
	public function index()
	{
		...
		foreach ($lstData as $lstData) {
			...
			$final_data[] = array(
				"budget_doeb_id" => $lstData['budget_doeb_id'],
	...
	public function update()
	{
		...
		$this->model->update($input['budget_doeb_id'], $postData);
	...
	public function delete($value)
	{
		// iclude helper form
		helper("form");
		$this->model->delete_budget_doeb($value);
		/*
