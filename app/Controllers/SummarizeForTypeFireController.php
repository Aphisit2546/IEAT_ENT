...
use App\Models\SummarizeForTypeFire;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;

class SummarizeForTypeFireController extends BaseController
{
	protected $programCode = "SUMMARIZE_FOR_TYPE_FIRE";
	protected $model;
	protected $dropdown;
	protected $pageData;
	protected $pageName;
	...
	{
		$this->model = new SummarizeForTypeFire();
		...
		$this->pageData = [
			...
			"menuName" => "รายงานสรุปผลการตรวจสอบรายงานประเมินความเสี่ยงอัคคีภัยจาก กรอ.",
