...
use App\Models\PublishForTypeSafety;
use App\Models\FUNCTION_REUSE\dropdown_reuse;
use Exception;

class PublishForTypeSafetyController extends BaseController
{
	protected $programCode = "PUBLISH_FOR_TYPE_SAFETY";
	protected $model;
	protected $dropdown;
	protected $pageData;
	protected $pageName;
	...
	{
		$this->model = new PublishForTypeSafety();
		...
		$this->pageData = [
			...
			"menuName" => "เผยแพร่บัญชีโรงงานตามประกาศ อก. เรื่องมาตรการคุ้มครองความปลอดภัยในการดำเนินงาน",
